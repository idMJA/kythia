...
module.exports = {
    execute: async (interaction, container) => {
        ...
        const selectMenu = new UserSelectMenuBuilder()
            ...
            .setPlaceholder(await t(interaction, 'tempvoice.untrust.menu.placeholder'))
            .setMinValues(1)
            .setMaxValues(10);
        ...
        const containerComponent = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(await t(interaction, 'tempvoice.untrust.menu.content')))
