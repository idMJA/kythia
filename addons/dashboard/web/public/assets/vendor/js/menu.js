/**
 * @namespace: addons/dashboard/web/public/assets/vendor/js/menu.js
 * @type: Module
                                    ...
                                    this._horizontal &&
                                        ...
                                        (this._evntBodyClick = function (e) {
                                            !t._inner.contains(e.target) &&
                                                t._el.querySelectorAll('.menu-inner > .menu-item.open').length &&
                                                t.closeAll();
                                        }),
                                            ...
                                            (this._evntElMouseOut = function (n) {
                                                ...
                                                if (
                                                    (o.closest('ul') &&
                                                        ...
                                                        (t._topParent = o),
                                                    o !== i &&
                                                        (o.parentNode.classList.contains('open') || !o.classList.contains('menu-toggle')) &&
                                                        r &&
                                                        r.parentNode &&
                                ...
                                if ('vertical' === t) {
                                    ...
                                    ((this._horizontal = !1),
                                        ...
                                        (_ = s.classList).add.apply(
                                            _,
                                            ['layout-menu', 'menu', 'menu-vertical'].concat([this._menuBgClass])
                                        ),
                                ...
                                if (
                                    (t.classList.contains('menu-item')
                                        ...
                                        : t.classList.contains(o) &&
                                          (i = t.parentNode.classList.contains('menu-item') ? t.parentNode : null),
                                    !i)
                                )
