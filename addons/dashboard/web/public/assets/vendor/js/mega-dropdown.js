/**
 * @namespace: addons/dashboard/web/public/assets/vendor/js/mega-dropdown.js
 * @type: Module
                                        ...
                                        'true' === e._el.getAttribute('aria-expanded') &&
                                            (e._focusTimeout = setTimeout(function () {
                                                'BODY' !== document.activeElement.tagName.toUpperCase() &&
                                                    t._findParent(document.activeElement, 'mega-dropdown') !== e._container &&
                                                    e.close(!0);
                                            }, 100)));
                                }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            (this._elClickEvnt && (this._el.removeEventListener('click', this._elClickEvnt), (this._elClickEvnt = null)),
                                this._bodyClickEvnt &&
                                    (document.body.removeEventListener('click', this._bodyClickEvnt, !0), (this._bodyClickEvnt = null)),
                                this._menuClickEvnt &&
                                    (this._menu.removeEventListener('click', this._menuClickEvnt, !0), (this._menuClickEvnt = null)),
                                this._focusoutEvnt &&
                                    (this._container.removeEventListener('focusout', this._focusoutEvnt, !0), (this._focusoutEvnt = null)),
                                this._enterEvnt &&
