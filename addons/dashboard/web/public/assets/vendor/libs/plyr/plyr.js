/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/plyr/plyr.js
 * @type: Module
                    ...
                    'object' == typeof navigator &&
                        (e.exports = (function () {
                                                ...
                                                value: function (t) {
                                                    ...
                                                    if (
                                                        (p.empty(t) || p.string(t)
                                                            ? (s = Array.from(
                                                                  document.querySelectorAll(p.string(t) ? t : 'input[type="range"]')
                                                              ))
                                                            : p.element(t)
                                                              ? (s = [t])
                                                              : p.nodeList(t)
                            ...
                            const y = (e) => (null != e ? e.constructor : null),
                                ...
                                C = (e) => Array.isArray(e),
                                A = (e) => b(e, NodeList),
                                S = (e) => v(e) || ((T(e) || C(e) || A(e)) && !e.length) || (w(e) && !Object.keys(e).length);
                            var E = {
                                nullOrUndefined: v,
                                object: w,
                            ...
                            function L(e = {}, ...t) {
                                ...
                                return E.object(i)
                                    ? (Object.keys(i).forEach((t) => {
                                          E.object(i[t])
                                              ? (Object.keys(e).includes(t) || Object.assign(e, { [t]: {} }), L(e[t], i[t]))
                            ...
                            function $(e, t) {
                                E.element(e) &&
                                    !E.empty(t) &&
                                    Object.entries(t)
                                        .filter(([, e]) => !E.nullOrUndefined(e))
                                        .forEach(([t, i]) => e.setAttribute(t, i));
                            }
                            function O(e, t, i) {
                                const s = document.createElement(e);
                                return (E.object(t) && $(s, t), E.string(i) && (s.innerText = i), s);
                            }
                            function _(e, t, i, s) {
                                E.element(t) && t.appendChild(O(e, i, s));
                            }
                            function j(e) {
                                E.nodeList(e) || E.array(e)
                                    ? Array.from(e).forEach(j)
                                    : E.element(e) && E.element(e.parentNode) && e.parentNode.removeChild(e);
                            }
                            function q(e) {
                                if (!E.element(e)) return;
                            ...
                            function H(e, t) {
                                ...
                                return (
                                    e.split(',').forEach((e) => {
                                        ...
                                        switch (t.charAt(0)) {
                                            case '.':
                                                E.string(s.class) ? (i.class = `${s.class} ${n}`) : (i.class = n);
                                                break;
                                            case '#':
                                                i.id = t.replace('#', '');
                                                break;
                            ...
                            function R(e, t) {
                                if (!E.element(e)) return;
                                let i = t;
                                (E.boolean(i) || (i = !e.hidden), (e.hidden = i));
                            }
                            function F(e, t, i) {
                                if (E.nodeList(e)) return Array.from(e).map((e) => F(e, t, i));
                                if (E.element(e)) {
                                    let s = 'toggle';
                            ...
                            function z(e = null, t = !1) {
                                E.element(e) && e.focus({ preventScroll: !0, focusVisible: t });
                            }
                            const K = {
                                    'audio/ogg': 'vorbis',
                                    'audio/wav': '1',
                                ...
                                Y = {
                                    ...
                                    pip: !(
                                        ...
                                        (!E.function(O('video').webkitSetPresentationMode) &&
                                            (!document.pictureInPictureEnabled || O('video').disablePictureInPicture))
                                    ),
                            ...
                            function X(e, t, i, s = !1, n = !0, a = !1) {
                                if (!e || !('addEventListener' in e) || E.empty(t) || !E.function(i)) return;
                                const l = t.split(' ');
                                let r = a;
                                (Q && (r = { passive: n, capture: a }),
                                    l.forEach((t) => {
                                        (this &&
                                            this.eventListeners &&
                                            s &&
                            ...
                            function Z(e, t = '', i, s = !0, n = !1) {
                                const a = (...l) => {
                                    (G(e, t, a, s, n), i.apply(this, l));
                                };
                                X.call(this, e, t, a, !0, s, n);
                            }
                            function ee(e, t = '', i = !1, s = {}) {
                                if (!E.element(e) || E.empty(t)) return;
                            ...
                            function ie() {
                                return new Promise((e) =>
                                    this.ready ? setTimeout(e, 0) : J.call(this, this.elements.container, 'ready', e)
                                ).then(() => {});
                            }
                            function se(e) {
                                E.promise(e) && e.then(null, () => {});
                            }
                            function ne(e) {
                                return E.array(e) ? e.filter((t, i) => e.indexOf(t) === i) : e;
                            }
                            function ae(e, t) {
                                return E.array(e) && e.length ? e.reduce((e, i) => (Math.abs(i - t) < Math.abs(e - t) ? i : e)) : null;
                            }
                            function le(e) {
                            ...
                            function oe(e) {
                                return (
                                    !!(E.array(e) || (E.string(e) && e.includes(':'))) &&
                                    (E.array(e) ? e : e.split(':')).map(Number).every(E.number)
                                );
                            }
                            function ce(e) {
                            ...
                            function ue(e) {
                                const t = (e) => (oe(e) ? e.split(':').map(Number) : null);
                                let i = t(e);
                                if (
                                    (null === i && (i = t(this.config.ratio)),
                                    null === i && !E.empty(this.embed) && E.array(this.embed.ratio) && ({ ratio: i } = this.embed),
                                    null === i && this.isHTML5)
                                ) {
                            ...
                            function de(e, t, i = 0.05) {
                                const s = e / t,
                                    n = ae(Object.keys(re), s);
                                return Math.abs(n - s) <= i ? re[n] : [e, t];
                            }
                            const me = {
                                getSources() {
                                    return this.isHTML5
                                        ? Array.from(this.media.querySelectorAll('source')).filter((e) => {
                                              ...
                                              return !!E.empty(t) || Y.mime.call(this, t);
                                          })
                                        : [];
                                },
                                getQualityOptions() {
                                ...
                                setup() {
                                    ...
                                    ((e.options.speed = e.config.speed.options),
                                        E.empty(this.config.ratio) || he.call(e),
                                        Object.defineProperty(e.media, 'quality', {
                                            ...
                                            set(t) {
                                                if (e.quality !== t) {
                                                    if (e.config.quality.forced && E.function(e.config.quality.onChange))
                                                        ...
                                                        ((e.media.src = i.getAttribute('src')),
                                                            ('none' !== a || l) &&
                                                                (e.once('loadedmetadata', () => {
                                                                    ((e.speed = r), (e.currentTime = s), n || se(e.play()));
                                                                }),
                                                                e.media.load()));
                                                    }
                            ...
                            function pe(e, ...t) {
                                return E.empty(e) ? e : e.toString().replace(/{(\d+)}/g, (e, i) => t[i].toString());
                            }
                            const ge = (e = '', t = '', i = '') =>
                            ...
                            const ve = { pip: 'PIP', airplay: 'AirPlay', html5: 'HTML5', vimeo: 'Vimeo', youtube: 'YouTube' },
                                we = {
                                    get(e = '', t = {}) {
                                        ...
                                        let i = N(t.i18n, e);
                                        if (E.empty(i)) return Object.keys(ve).includes(e) ? ve[e] : '';
                            ...
                            const Ae = (e) => Math.trunc((e / 60 / 60) % 60, 10),
                                Se = (e) => Math.trunc((e / 60) % 60, 10),
                                Ee = (e) => Math.trunc(e % 60, 10);
                            function Pe(e = 0, t = !1, i = !1) {
                                if (!E.number(e)) return Pe(void 0, t, i);
                            ...
                            const Me = {
                                ...
                                createIcon(e, t) {
                                    ...
                                    $(a, L(t, { 'aria-hidden': 'true', focusable: 'false' }));
                                    ...
                                    switch (
                                        ...
                                        Object.keys(i).includes('class')
                                            ? i.class.split(' ').some((e) => e === this.config.classNames.control) ||
                                              L(i, { class: `${i.class} ${this.config.classNames.control}` })
                                        ...
                                        case 'play-large':
                                            ...
                                            break;
                                        default:
                                            (E.empty(n.label) && (n.label = s), E.empty(n.icon) && (n.icon = e));
                                    }
                                    const a = O(n.element);
                                    return (
                                        n.toggle
                                        ...
                                        L(i, H(this.config.selectors.buttons[s], i)),
                                        $(a, i),
                                        'play' === s
                                            ? (E.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
                                ...
                                createTime(e, t) {
                                    const i = H(this.config.selectors.display[e], t),
                                        s = O(
                                            'div',
                                            L(i, {
                                ...
                                bindMenuItemShortcuts(e, t) {
                                    (J.call(
                                        ...
                                        (i) => {
                                            ...
                                            const s = U(e, '[role="menuitemradio"]');
                                            if (!s && [' ', 'ArrowRight'].includes(i.key)) Me.showMenuPanel.call(this, t, !0);
                                            else {
                                                let t;
                                                ' ' !== i.key &&
                                                    ('ArrowDown' === i.key || (s && 'ArrowRight' === i.key)
                                                        ? ((t = e.nextElementSibling), E.element(t) || (t = e.parentNode.firstElementChild))
                                                        : ((t = e.previousElementSibling),
                                                          E.element(t) || (t = e.parentNode.lastElementChild)),
                                                    z.call(this, t, !0));
                                            }
                                        },
                                        !1
                                ...
                                createMenuItem({ value: e, list: t, type: i, title: s, badge: n = null, checked: a = !1 }) {
                                    const l = H(this.config.selectors.inputs[i]),
                                        r = O(
                                            'button',
                                            L(l, {
                                                type: 'button',
                                            ...
                                            set(e) {
                                                (e &&
                                                    Array.from(r.parentNode.children)
                                                        .filter((e) => U(e, '[role="menuitemradio"]'))
                                        ...
                                        this.listeners.bind(
                                            ...
                                            (t) => {
                                                if (!E.keyboardEvent(t) || ' ' === t.key) {
                                                    ...
                                                    Me.showMenuPanel.call(this, 'home', E.keyboardEvent(t));
                                                }
                                            },
                                            i,
                                            !1
                                        ),
                                        Me.bindMenuItemShortcuts.call(this, r, i),
                                        t.appendChild(r));
                                },
                                formatTime(e = 0, t = !1) {
                                    return E.number(e) ? Pe(e, Ae(this.duration) > 0, t) : e;
                                },
                                updateTimeDisplay(e = null, t = 0, i = !1) {
                                    E.element(e) && E.number(t) && (e.innerText = Me.formatTime(t, i));
                                },
                                updateVolume() {
                                    this.supported.ui &&
                                        (E.element(this.elements.inputs.volume) &&
                                            Me.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
                                        E.element(this.elements.buttons.mute) &&
                                            (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume));
                                },
                                setRange(e, t = 0) {
                                    E.element(e) && ((e.value = t), Me.updateRangeFill.call(this, e));
                                },
                                updateProgress(e) {
                                    if (!this.supported.ui || !E.event(e)) return;
                                    let t = 0;
                                    const i = (e, t) => {
                                        const i = E.number(t) ? t : 0,
                                            s = E.element(e) ? e : this.elements.display.buffer;
                                        if (E.element(s)) {
                                            s.value = i;
                                            const e = s.getElementsByTagName('span')[0];
                                            E.element(e) && (e.childNodes[0].nodeValue = i);
                                        }
                                    };
                                    if (e)
                                        switch (e.type) {
                                ...
                                updateSeekTooltip(e) {
                                    ...
                                    if (E.event(e)) l = (100 / r.width) * (e.pageX - r.left);
                                    else {
                                        if (!V(s, n)) return;
                                    ...
                                    (c && s.insertAdjacentHTML('afterbegin', `${c.label}<br>`),
                                        (s.style.left = `${l}%`),
                                        E.event(e) && ['mouseenter', 'mouseleave'].includes(e.type) && a('mouseenter' === e.type));
                                },
                                timeUpdate(e) {
                                    const t = !E.element(this.elements.display.duration) && this.config.invertTime;
                                ...
                                durationUpdate() {
                                    ...
                                    if (this.duration >= 2 ** 32)
                                        return (R(this.elements.display.currentTime, !0), void R(this.elements.progress, !0));
                                    E.element(this.elements.inputs.seek) &&
                                        this.elements.inputs.seek.setAttribute('aria-valuemax', this.duration);
                                    const e = E.element(this.elements.display.duration);
                                    (!e &&
                                ...
                                updateSetting(e, t, i) {
                                    ...
                                    if ('captions' === e) n = this.currentTrack;
                                        ...
                                        if (
                                            ((n = E.empty(i) ? this[e] : i),
                                            E.empty(n) && (n = this.config[e].default),
                                            !E.empty(this.options[e]) && !this.options[e].includes(n))
                                        )
                                    ...
                                    if ((E.element(a) || (a = s && s.querySelector('[role="menu"]')), !E.element(a))) return;
                                    this.elements.settings.buttons[e].querySelector(`.${this.config.classNames.menu.value}`).innerHTML =
                                        Me.getLabel.call(this, e, n);
                                    const l = a && a.querySelector(`[value="${n}"]`);
                                    E.element(l) && (l.checked = !0);
                                },
                                getLabel(e, t) {
                                    switch (e) {
                                        case 'speed':
                                ...
                                setQualityMenu(e) {
                                    if (!E.element(this.elements.settings.panels.quality)) return;
                                    const t = 'quality',
                                        i = this.elements.settings.panels.quality.querySelector('[role="menu"]');
                                    E.array(e) && (this.options.quality = ne(e).filter((e) => this.config.quality.options.includes(e)));
                                    const s = !E.empty(this.options.quality) && this.options.quality.length > 1;
                                    if ((Me.toggleMenuButton.call(this, t, s), q(i), Me.checkMenu.call(this), !s)) return;
                                    const n = (e) => {
                                ...
                                setCaptionsMenu() {
                                    if (!E.element(this.elements.settings.panels.captions)) return;
                                    const e = 'captions',
                                        t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                                        i = Le.getTracks.call(this),
                                        s = Boolean(i.length);
                                    if ((Me.toggleMenuButton.call(this, e, s), q(t), Me.checkMenu.call(this), !s)) return;
                                    const n = i.map((e, i) => ({
                                        value: i,
                                        checked: this.captions.toggled && this.currentTrack === i,
                                        title: Le.getLabel.call(this, e),
                                ...
                                setSpeedMenu() {
                                    if (!E.element(this.elements.settings.panels.speed)) return;
                                    const e = 'speed',
                                        t = this.elements.settings.panels.speed.querySelector('[role="menu"]');
                                    this.options.speed = this.options.speed.filter((e) => e >= this.minimumSpeed && e <= this.maximumSpeed);
                                    const i = !E.empty(this.options.speed) && this.options.speed.length > 1;
                                ...
                                checkMenu() {
                                    const { buttons: e } = this.elements.settings,
                                        t = !E.empty(e) && Object.values(e).some((e) => !e.hidden);
                                    R(this.elements.settings.menu, !t);
                                },
                                focusFirstMenuItem(e, t = !1) {
                                    if (this.elements.settings.popup.hidden) return;
                                    let i = e;
                                    E.element(i) || (i = Object.values(this.elements.settings.panels).find((e) => !e.hidden));
                                ...
                                toggleMenu(e) {
                                    ...
                                    if (!E.element(t) || !E.element(i)) return;
                                    const { hidden: s } = t;
                                    let n = s;
                                    if (E.boolean(e)) n = e;
                                    else if (E.keyboardEvent(e) && 'Escape' === e.key) n = !1;
                                    else if (E.event(e)) {
                                        const s = E.function(e.composedPath) ? e.composedPath()[0] : e.target,
                                            a = t.contains(s);
                                    ...
                                    (i.setAttribute('aria-expanded', n),
                                        ...
                                        n && E.keyboardEvent(e)
                                            ...
                                            : n || s || z.call(this, i, E.keyboardEvent(e)));
                                },
                                getMenuSize(e) {
                                ...
                                showMenuPanel(e = '', t = !1) {
                                    ...
                                    (R(n, !0), R(i, !1), Me.focusFirstMenuItem.call(this, i, t));
                                },
                                setDownloadUrl() {
                                ...
                                create(e) {
                                    ...
                                    const c = O('div', H(this.config.selectors.controls.wrapper));
                                    this.elements.controls = c;
                                    const u = { class: 'plyr__controls__item' };
                                    return (
                                        ne(E.array(this.config.controls) ? this.config.controls : []).forEach((l) => {
                                            if (
                                                ...
                                                const t = O('div', { class: `${u.class} plyr__progress__container` }),
                                                    i = O('div', H(this.config.selectors.progress));
                                                if (
                                            ...
                                            if (
                                                ...
                                                if (
                                                    ((E.element(t) && c.contains(t)) ||
                                                        ((t = O('div', L({}, u, { class: `${u.class} plyr__volume`.trim() }))),
                                                        (this.elements.volume = t),
                                                        c.appendChild(t)),
                                                    'mute' === l && t.appendChild(i.call(this, 'mute')),
                                                    'volume' === l && !x.isIos && !x.isIPadOS)
                                                ) {
                                                    const i = { max: 1, step: 0.05, value: this.config.volume };
                                                    t.appendChild(n.call(this, 'volume', L(i, { id: `plyr-volume-${e.id}` })));
                                                }
                                            }
                                            if (
                                                ('captions' === l && c.appendChild(i.call(this, 'captions', u)),
                                                'settings' === l && !E.empty(this.config.settings))
                                            ) {
                                                const s = O('div', L({}, u, { class: `${u.class} plyr__menu`.trim(), hidden: '' }));
                                                s.appendChild(
                                                ...
                                                const n = O('div', {
                                                    ...
                                                    a = O('div'),
                                                    l = O('div', { id: `plyr-settings-${e.id}-home` }),
                                                    r = O('div', { role: 'menu' });
                                                (l.appendChild(r),
                                                    a.appendChild(l),
                                                    ...
                                                    this.config.settings.forEach((i) => {
                                                        const s = O(
                                                            'button',
                                                            L(H(this.config.selectors.buttons.settings), {
                                                                type: 'button',
                                                        ...
                                                        const n = O('span', null, we.get(i, this.config)),
                                                            l = O('span', { class: this.config.classNames.menu.value });
                                            ...
                                            if (
                                                ('pip' === l && Y.pip && c.appendChild(i.call(this, 'pip', u)),
                                                'airplay' === l && Y.airplay && c.appendChild(i.call(this, 'airplay', u)),
                                                'download' === l)
                                            ) {
                                                const e = L({}, u, { element: 'a', href: this.download, target: '_blank' });
                                                this.isHTML5 && (e.download = '');
                                                const { download: t } = this.config.urls;
                                                (!E.url(t) && this.isEmbed && L(e, { icon: `logo-${this.provider}`, label: this.provider }),
                                ...
                                inject() {
                                    ...
                                    let i,
                                        s = !0;
                                    if (
                                        (E.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)),
                                        ...
                                        E.element(i) || (i = this.elements.container),
                                        i[E.element(e) ? 'insertAdjacentElement' : 'insertAdjacentHTML']('afterbegin', e),
                                        E.element(this.elements.controls) || Me.findElements.call(this),
                                        ...
                                        Object.values(this.elements.buttons)
                                            .filter(Boolean)
                                            .forEach((t) => {
                                                E.array(t) || E.nodeList(t) ? Array.from(t).filter(Boolean).forEach(e) : e(t);
                                            });
                                    }
                                    if ((x.isEdge && M(i), this.config.tooltips.controls)) {
                                ...
                                setMarkers() {
                                    ...
                                    (i.forEach((e) => {
                                        ...
                                        s.appendChild(n),
                                        this.config.tooltips.seek ||
                                            ((a = O('span', { class: this.config.classNames.tooltip }, '')), s.appendChild(a)),
                            ...
                            const Le = {
                                    setup() {
                                        ...
                                        if (
                                            (E.element(this.elements.captions) ||
                                                ((this.elements.captions = O('div', H(this.config.selectors.captions))),
                                                this.elements.captions.setAttribute('dir', 'auto'),
                                                (e = this.elements.captions),
                                                (t = this.elements.wrapper),
                                                E.element(e) && E.element(t) && t.parentNode.insertBefore(e, t.nextSibling)),
                                            x.isIE && window.URL)
                                        ) {
                                        ...
                                        if (
                                            (E.boolean(n) || ({ active: n } = this.config.captions),
                                            Object.assign(this.captions, { toggled: !1, active: n, language: s, languages: i }),
                                            this.isHTML5)
                                        ) {
                                            const e = this.config.captions.update ? 'addtrack removetrack' : 'removetrack';
                                            J.call(this, this.media.textTracks, e, Le.update.bind(this));
                                        }
                                        setTimeout(Le.update.bind(this), 0);
                                    },
                                    update() {
                                        const e = Le.getTracks.call(this, !0),
                                            ...
                                            e
                                                ...
                                                .forEach((e) => {
                                                    (this.debug.log('Track added', e),
                                                        ...
                                                        J.call(this, e, 'cuechange', () => Le.updateCues.call(this)));
                                                }),
                                            ((a && this.language !== i) || !e.includes(n)) &&
                                                (Le.setLanguage.call(this, i), Le.toggle.call(this, t && a)),
                                            this.elements &&
                                                F(this.elements.container, this.config.classNames.captions.enabled, !E.empty(e)),
                                            E.array(this.config.controls) &&
                                                this.config.controls.includes('settings') &&
                                                this.config.settings.includes('captions') &&
                                                Me.setCaptionsMenu.call(this));
                                    ...
                                    toggle(e, t = !0) {
                                        ...
                                        const { toggled: i } = this.captions,
                                            ...
                                            n = E.nullOrUndefined(e) ? !i : e;
                                        if (n !== i) {
                                            if (
                                                (t || ((this.captions.active = n), this.storage.set({ captions: n })),
                                                !this.language && n && !t)
                                            ) {
                                                const e = Le.getTracks.call(this),
                                                    t = Le.findTrack.call(this, [this.captions.language, ...this.captions.languages], !0);
                                                return ((this.captions.language = t.language), void Le.set.call(this, e.indexOf(t)));
                                            }
                                    ...
                                    set(e, t = !0) {
                                        const i = Le.getTracks.call(this);
                                        if (-1 !== e)
                                            if (E.number(e))
                                                if (e in i) {
                                    ...
                                    setLanguage(e, t = !0) {
                                        if (!E.string(e)) return void this.debug.warn('Invalid language argument', e);
                                        const i = e.toLowerCase();
                                        this.captions.language = i;
                                        const s = Le.getTracks.call(this),
                                            n = Le.findTrack.call(this, [i]);
                                        Le.set.call(this, s.indexOf(n), t);
                                    },
                                    getTracks(e = !1) {
                                    ...
                                    getLabel(e) {
                                        let t = e;
                                        return (
                                            !E.track(t) && Y.textTracks && this.captions.toggled && (t = Le.getCurrentTrack.call(this)),
                                            E.track(t)
                                                ? E.empty(t.label)
                                                    ? E.empty(t.language)
                                    ...
                                    updateCues(e) {
                                        ...
                                        let t = e;
                                        if (!t) {
                                            const e = Le.getCurrentTrack.call(this);
                                        ...
                                        if (i !== this.elements.captions.innerHTML) {
                                            ...
                                            const e = O('span', H(this.config.selectors.caption));
                                            ((e.innerHTML = i),
                            ...
                            class Re {
                                    ...
                                    (e(this, 'onChange', () => {
                                        ...
                                        e(this, 'toggleFallback', (e = !1) => {
                                            if (
                                                ...
                                                const s = E.string(t.content) && t.content.includes(i);
                                                e
                                        ...
                                        e(this, 'enter', () => {
                                            this.supported &&
                                                (x.isIos && this.player.config.fullscreen.iosNative
                                                    ...
                                                    : !Re.nativeSupported || this.forceFallback
                                                      ? this.toggleFallback(!0)
                                                      : this.prefix
                                                        ? E.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]()
                                            ...
                                            if (this.supported)
                                                if (x.isIos && this.player.config.fullscreen.iosNative)
                                                    (this.player.isVimeo
                                                        ...
                                                        : this.target.webkitEnterFullscreen(),
                                                        se(this.player.play()));
                                                else if (!Re.nativeSupported || this.forceFallback) this.toggleFallback(!1);
                                                else if (this.prefix) {
                                        ...
                                        (this.player = t),
                                        (this.prefix = Re.prefix),
                                        (this.property = Re.property),
                                        ...
                                        J.call(this.player, this.player.elements.container, 'dblclick', (e) => {
                                            (E.element(this.player.elements.controls) &&
                                ...
                                get useNative() {
                                    return Re.nativeSupported && !this.forceFallback;
                                }
                                static get prefix() {
                                    ...
                                    return (
                                        ['webkit', 'moz', 'ms'].some(
                                            (t) =>
                                                !(
                                                    (!E.function(document[`${t}ExitFullscreen`]) &&
                                                        !E.function(document[`${t}CancelFullScreen`])) ||
                                                    ((e = t), 0)
                                                )
                                        ),
                                        e
                                ...
                                get supported() {
                                    return [
                                        ...
                                        this.player.isVideo,
                                        Re.nativeSupported || this.player.config.fullscreen.fallback,
                                ...
                                get active() {
                                    ...
                                    if (!Re.nativeSupported || this.forceFallback)
                                        return V(this.target, this.player.config.classNames.fullscreen.fallback);
                                    const e = this.prefix
                            ...
                            const Ve = {
                                ...
                                build() {
                                    ...
                                    (E.element(this.elements.controls) || (Me.inject.call(this), this.listeners.controls()),
                                        Ve.toggleNativeControls.call(this),
                                        this.isHTML5 && Le.setup.call(this),
                                        (this.volume = null),
                                        (this.muted = null),
                                        (this.loop = null),
                                        (this.quality = null),
                                ...
                                setTitle() {
                                    ...
                                    if (
                                        (E.string(this.config.title) && !E.empty(this.config.title) && (e += `, ${this.config.title}`),
                                        ...
                                        if (!E.element(e)) return;
                                        const t = E.empty(this.config.title) ? 'video' : this.config.title,
                                    ...
                                    return t && this.poster
                                        ...
                                        : (this.media.setAttribute('data-poster', e),
                                          ...
                                          ie
                                              ...
                                              .then(() => Fe(e))
                                              .catch((t) => {
                                                  throw (e === this.poster && Ve.togglePoster.call(this, !1), t);
                                              })
                                              .then(() => {
                                ...
                                checkPlaying(e) {
                                    (F(this.elements.container, this.config.classNames.playing, this.playing),
                                        ...
                                        (E.event(e) && 'timeupdate' === e.type) || Ve.toggleControls.call(this));
                                },
                                checkLoading(e) {
                                    ((this.loading = ['stalled', 'waiting'].includes(e.type)),
                                        ...
                                        (this.timers.loading = setTimeout(
                                            () => {
                                                (F(this.elements.container, this.config.classNames.loading, this.loading),
                                ...
                                migrateStyles() {
                                    (Object.values({ ...this.media.style })
                                        .filter((e) => !E.empty(e) && E.string(e) && e.startsWith('--plyr'))
                                        .forEach((e) => {
                                            (this.elements.container.style.setProperty(e, this.media.style.getPropertyValue(e)),
                                                this.media.style.removeProperty(e));
                                        }),
                                        E.empty(this.media.style) && this.media.removeAttribute('style'));
                                },
                            };
                            class Ue {
                                constructor(t) {
                                    (e(this, 'firstTouch', () => {
                                        ...
                                        e(this, 'container', () => {
                                                ...
                                                J.call(
                                                    ...
                                                    (t) => {
                                                        ...
                                                        (['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                                                            (Ve.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
                                                            clearTimeout(s.controls),
                                                            (s.controls = setTimeout(() => Ve.toggleControls.call(e, !1), a)));
                                                    }
                                                ));
                                            const n = () => {
                                            ...
                                            J.call(e, i.container, 'enterfullscreen exitfullscreen', (t) => {
                                                ...
                                                s === i.container &&
                                                    ((!e.isEmbed && E.empty(e.config.ratio)) ||
                                                        (n(), ('enterfullscreen' === t.type ? J : G).call(e, window, 'resize', a)));
                                            });
                                        }),
                                        e(this, 'media', () => {
                                            const { player: e } = this,
                                            ...
                                            if (
                                                ...
                                                J.call(e, e.media, 'durationchange loadeddata loadedmetadata', (t) =>
                                                    Me.durationUpdate.call(e, t)
                                                ),
                                                ...
                                                J.call(e, e.media, 'playing play pause ended emptied timeupdate', (t) =>
                                                    Ve.checkPlaying.call(e, t)
                                                ),
                                                J.call(e, e.media, 'waiting canplay seeked playing', (t) => Ve.checkLoading.call(e, t)),
                                        ...
                                        e(this, 'proxy', (e, t, i) => {
                                            ...
                                            let a = !0;
                                            (E.function(n) && (a = n.call(s, e)), !1 !== a && E.function(t) && t.call(s, e));
                                        }),
                                        e(this, 'bind', (e, t, i, s, n = !0) => {
                                            const { player: a } = this,
                                                l = a.config.listeners[s],
                                                r = E.function(l);
                                            J.call(a, e, t, (e) => this.proxy(e, i, s), n && !r);
                                        }),
                                        e(this, 'controls', () => {
                                            const { player: e } = this,
                                                { elements: t } = e,
                                            ...
                                            if (
                                                ...
                                                this.bind(t.inputs.seek, 'mousedown mouseup keydown keyup touchstart touchend', (t) => {
                                                    const i = t.currentTarget,
                                                        s = 'play-on-seeked';
                                                    if (E.keyboardEvent(t) && !['ArrowLeft', 'ArrowRight'].includes(t.key)) return;
                                            ...
                                            (this.bind(
                                                ...
                                                e.config.toggleInvert &&
                                                    !E.element(t.display.duration) &&
                                                    this.bind(t.display.currentTime, 'click', () => {
                                                        0 !== e.currentTime &&
                                                            ((e.config.invertTime = !e.config.invertTime), Me.timeUpdate.call(e));
                                                    }),
                                                this.bind(
                                                    t.inputs.volume,
                                                    i,
                                                ...
                                                this.bind(t.controls, 'focusin', () => {
                                                    ...
                                                    (F(t.controls, i.classNames.noTransition, !0),
                                                        Ve.toggleControls.call(e, !0),
                                                        setTimeout(() => {
                                                            F(t.controls, i.classNames.noTransition, !1);
                                                        }, 0));
                                                    const n = this.touch ? 3e3 : 4e3;
                                                    (clearTimeout(s.controls),
                                                        (s.controls = setTimeout(() => Ve.toggleControls.call(e, !1), n)));
                                                }),
                                                this.bind(
                                                    t.inputs.volume,
                                                    'wheel',
                            ...
                            const Ke = {
                                ...
                                ready() {
                                    ...
                                    var u;
                                    const h = O('iframe'),
                                        d = pe(e.config.urls.vimeo.iframe, c, o);
                                    if (
                                        ...
                                        E.empty(s) || h.setAttribute('referrerPolicy', s),
                                        i || !t.customControls)
                                    )
                                    ...
                                    (t.customControls ||
                                        ke(pe(e.config.urls.vimeo.api, d)).then((t) => {
                                            !E.empty(t) && t.thumbnail_url && Ve.setPoster.call(e, t.thumbnail_url).catch(() => {});
                                        }),
                                    ...
                                    (Object.defineProperty(e.media, 'loop', {
                                        get: () => b,
                                        set(t) {
                                            const i = E.boolean(t) ? t : e.config.loop.active;
                                        ...
                                        e.embed.getVideoTitle().then((t) => {
                                            ((e.config.title = t), Ve.setTitle.call(this));
                                        }),
                                        ...
                                        e.embed.getTextTracks().then((t) => {
                                            ((e.media.textTracks = t), Le.setup.call(e));
                                        }),
                                        e.embed.on('cuechange', ({ cues: t = [] }) => {
                                            ...
                                            Le.updateCues.call(e, i);
                                        }),
                                        e.embed.on('loaded', () => {
                                            (e.embed.getPaused().then((t) => {
                                                (ze.call(e, !t), t || ee.call(e, e.media, 'playing'));
                                            }),
                                                E.element(e.embed.element) &&
                                                    e.supported.ui &&
                                        ...
                                        t.customControls && setTimeout(() => Ve.build.call(e), 0));
                                },
                            };
                            function Ye(e) {
                                (e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
                            ...
                            const Xe = {
                                    setup() {
                                        if (
                                            ...
                                            ((window.onYouTubeIframeAPIReady = () => {
                                                (E.function(e) && e(), Xe.ready.call(this));
                                            }),
                                        ...
                                        ke(pe(this.config.urls.youtube.api, e))
                                            .then((e) => {
                                                if (E.object(e)) {
                                                    ...
                                                    ((this.config.title = t), Ve.setTitle.call(this), (this.embed.ratio = de(s, i)));
                                                }
                                                he.call(this);
                                            })
                                            .catch(() => {
                                    ...
                                    ready() {
                                        ...
                                        if (!E.empty(i) && i.startsWith('youtube-')) return;
                                        let s = e.media.getAttribute('src');
                                        E.empty(s) && (s = e.media.getAttribute(this.config.attributes.embed.id));
                                        const n =
                                            ((a = s),
                                            E.empty(a)
                                                ? null
                                        ...
                                        if (((e.media = D(l, e.media)), t.customControls)) {
                                            ...
                                            Fe(t('maxres'), 121)
                                                .catch(() => Fe(t('sd'), 121))
                                                .catch(() => Fe(t('hq')))
                                                .then((t) => Ve.setPoster.call(e, t.src))
                                                .then((t) => {
                                        ...
                                        e.embed = new window.YT.Player(e.media, {
                                            ...
                                            events: {
                                                ...
                                                onReady(i) {
                                                    if (E.function(e.media.play)) return;
                                                    const s = i.target;
                                                    ...
                                                    ((e.options.speed = r.filter((t) => e.config.speed.options.includes(t))),
                                                        ...
                                                        t.customControls && setTimeout(() => Ve.build.call(e), 50));
                                                },
                                                onStateChange(i) {
                                                    const s = i.target;
                                                    switch (
                                    ...
                                    setup() {
                                        this.media
                                            ? (F(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
                                              ...
                                              this.isEmbed &&
                                                  F(this.elements.container, this.config.classNames.type.replace('{0}', 'video'), !0),
                                              this.isVideo &&
                            ...
                            class Ge {
                                constructor(t) {
                                    (e(this, 'load', () => {
                                        ...
                                        e(this, 'trigger', (e, ...t) => {
                                            ...
                                            E.array(i) &&
                                                i.forEach((e) => {
                                                    E.function(e) && e.apply(this, t);
                                                });
                                        }),
                                        e(
                                            this,
                                            'on',
                                            (e, t) => (E.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)
                                        ),
                                ...
                                get tagUrl() {
                                    const { config: e } = this;
                                    return E.url(e.tagUrl)
                                        ? e.tagUrl
                                        : `https://go.aniview.com/api/adserver6/vast/?${Ne({ AV_PUBLISHERID: '58c25bb0073ef448b1087ad6', AV_CHANNELID: '5a0458dc28a06145e4519d21', AV_URL: window.location.hostname, cb: Date.now(), AV_WIDTH: 640, AV_HEIGHT: 480, AV_CDIM2: e.publisherId })}`;
                                }
                            }
                            ...
                            const et = (e) => {
                                    ...
                                    return (
                                        e.split(/\r\n\r\n|\n\n|\r\r/).forEach((e) => {
                                            const i = {};
                                            (e.split(/\r\n|\n|\r/).forEach((e) => {
                                                if (E.number(i.startTime)) {
                                                    if (!E.empty(e.trim()) && E.empty(i.text)) {
                                ...
                                constructor(t) {
                                    (e(this, 'load', () => {
                                        ...
                                        e(
                                            ...
                                            () =>
                                                new Promise((e) => {
                                                    ...
                                                    if (E.empty(t)) throw new Error('Missing previewThumbnails.src config attribute');
                                                    const i = () => {
                                                    ...
                                                    if (E.function(t))
                                                        ...
                                                        const e = (E.string(t) ? [t] : t).map((e) => this.getThumbnail(e));
                                        ...
                                        e(this, 'startScrubbing', (e) => {
                                            (E.nullOrUndefined(e.button) || !1 === e.button || 0 === e.button) &&
                                                ((this.mouseDown = !0),
                                                this.player.media.duration &&
                                        ...
                                        e(this, 'render', () => {
                                            ...
                                            ((this.elements.thumb.time = O('span', {}, '00:00')),
                                                ...
                                                E.element(this.player.elements.progress) &&
                            ...
                            class nt {
                                constructor(t, i) {
                                    if (
                                        ...
                                        e(this, 'pause', () => (this.playing && E.function(this.media.pause) ? this.media.pause() : null)),
                                        e(this, 'togglePlay', (e) => ((E.boolean(e) ? e : !this.playing) ? this.play() : this.pause())),
                                        e(this, 'stop', () => {
                                            this.isHTML5
                                        ...
                                        e(this, 'toggleControls', (e) => {
                                            if (this.supported.ui && !this.isAudio) {
                                                const t = V(this.elements.container, this.config.classNames.hideControls),
                                                    i = void 0 === e ? void 0 : !e,
                                        ...
                                        e(this, 'destroy', (e, t = !1) => {
                                                ...
                                                ((document.body.style.overflow = ''),
                                                    ...
                                                    t
                                                        ...
                                                        : (te.call(this),
                                                          ...
                                                          E.function(e) && e.call(this.elements.original),
                                                          (this.ready = !1),
                                                          setTimeout(() => {
                                            ...
                                            (this.stop(),
                                                ...
                                                this.isHTML5
                                                    ? (Ve.toggleNativeControls.call(this, !0), i())
                                                    : this.isYouTube
                                                      ? (clearInterval(this.timers.buffering),
                                                        clearInterval(this.timers.playing),
                                                        null !== this.embed && E.function(this.embed.destroy) && this.embed.destroy(),
                                                        i())
                                                      : this.isVimeo &&
                                                        (null !== this.embed && this.embed.unload().then(i), setTimeout(i, 200)));
                                        }),
                                        e(this, 'supports', (e) => Y.mime.call(this, e)),
                                        (this.timers = {}),
                                        (this.ready = !1),
                                        (this.loading = !1),
                                        (this.failed = !1),
                                        (this.touch = Y.touch),
                                        (this.media = t),
                                        E.string(this.media) && (this.media = document.querySelectorAll(this.media)),
                                    ...
                                    switch (n) {
                                        case 'div':
                                            if (((a = this.media.querySelector('iframe')), E.element(a))) {
                                                if (
                                                    ((l = xe(a.getAttribute('src'))),
                                            ...
                                            if (E.empty(this.provider) || !Object.values(_e).includes(this.provider))
                                    ...
                                    ((this.supported = Y.check(this.type, this.provider)),
                                        this.supported.api
                                            ? ((this.eventListeners = []),
                                              (this.listeners = new Ue(this)),
                                              (this.storage = new Te(this)),
                                              (this.media.plyr = this),
                                              E.element(this.elements.container) ||
                                                  ((this.elements.container = O('div')), I(this.media, this.elements.container)),
                                ...
                                set volume(e) {
                                    ...
                                    (E.string(t) && (t = Number(t)),
                                        ...
                                        E.number(t) || ({ volume: t } = this.config),
                                        t > 1 && (t = 1),
                                        t < 0 && (t = 0),
                                ...
                                set quality(e) {
                                    ...
                                    if (!i.length) return;
                                    let s = [!E.empty(e) && Number(e), this.storage.get('quality'), t.selected, t.default].find(E.number),
                                        n = !0;
                                    if (!i.includes(s)) {
                                        const e = ae(i, s);
                                ...
                                set loop(e) {
                                    const t = E.boolean(e) ? e : this.config.loop.active;
                                ...
                                set download(e) {
                                    E.url(e) && ((this.config.urls.download = e), Me.setDownloadUrl.call(this));
                                }
                                set poster(e) {
                                    this.isVideo
                                        ? Ve.setPoster.call(this, e, !1).catch(() => {})
                                ...
                                set autoplay(e) {
                                    this.config.autoplay = E.boolean(e) ? e : this.config.autoplay;
                                }
                                get autoplay() {
                                ...
                                set currentTrack(e) {
                                    (Le.set.call(this, e, !1), Le.setup.call(this));
                                }
                                get currentTrack() {
                                ...
                                set pip(e) {
                                    if (!Y.pip) return;
                                    const t = E.boolean(e) ? e : !this.pip;
                                    (E.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? $e : Oe),
                                ...
                                static setup(e, t = {}) {
                                    ...
                                    return (
                                        ...
                                        E.empty(i) ? null : i.map((e) => new nt(e, t))
                                    );
                                }
                            }
                            var at;
                            return ((nt.defaults = ((at = Ie), JSON.parse(JSON.stringify(at)))), nt);
                        })());
                },
            },
            t = {};
