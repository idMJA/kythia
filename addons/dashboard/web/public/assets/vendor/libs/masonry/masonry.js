                        ...
                        void 0 ===
                            (o =
                                ...
                                typeof (n = function () {
                                    ...
                                    function i() {}
                                    var e = 'undefined' == typeof console ? i : function (t) {},
                                        n = [
                                            'paddingLeft',
                                            'paddingRight',
                                            'paddingTop',
                                    ...
                                    function u() {
                                        if (!h) {
                                            ...
                                            e.appendChild(i);
                                            var n = s(i);
                                            ((a = 200 == Math.round(t(n.width))), (l.isBoxSizeOuter = a), e.removeChild(i));
                                        }
                                    }
                                    function l(i) {
                                        if (
                                            ...
                                            for (var l = (h.isBorderBox = 'border-box' == e.boxSizing), c = 0; c < o; c++) {
                                                var d = n[c],
                                                    f = e[d],
                                                    p = parseFloat(f);
                                                h[d] = isNaN(p) ? 0 : p;
                                ...
                                typeof (n = function (t, i) {
                                    ...
                                    return (
                                        ...
                                        (n._manageStamp = function (t) {
                                            ...
                                            for (
                                                var h = (this._getOption('originTop') ? n.top : n.bottom) + e.outerHeight, u = s;
                                                u <= a;
                                                u++
                                            )
                                ...
                                typeof (n = function (t, i) {
                                    ...
                                    ((u.constructor = h),
                                        ...
                                        (u._nonTransition = function (t) {
                                            for (var i in (this.css(t.to), t.isCleaning && this._removeStyles(t.to), t.onTransitionEnd))
                                    ...
                                    ((u.ontransitionend = function (t) {
                                        if (t.target === this.element) {
                                            ...
                                            (delete i.ingProperties[n],
                                                ...
                                                n in i.clean && ((this.element.style[t.propertyName] = ''), delete i.clean[n]),
                                ...
                                return (function (t, i, e, n, o) {
                                    ...
                                    (n.extend(c, i.prototype),
                                        ...
                                        (c._itemize = function (t) {
                                            for (
                                                var i = this._filterFindItemElements(t), e = this.constructor.Item, n = [], o = 0;
                                                o < i.length;
                                                o++
                                            ) {
                                            ...
                                            if (void 0 !== t) {
                                                ...
                                                (e.isBorderBox &&
                                                    (t += i
                                                        ...
                                                        : e.paddingBottom + e.paddingTop + e.borderTopWidth + e.borderBottomWidth),
                                                    (t = Math.max(t, 0)),
