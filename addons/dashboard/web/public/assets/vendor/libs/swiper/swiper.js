/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/swiper/swiper.js
 * @type: Module
...
!(function (e, t) {
    ...
    return (function () {
        ...
        function g(e) {
            return (
                e.querySelector('.swiper-slide-transform') || (e.shadowRoot && e.shadowRoot.querySelector('.swiper-slide-transform')) || e
            );
        }
        function v(e, t) {
            void 0 === t && (t = '');
                    ...
                    (I = (function (e) {
                        ...
                        return (
                            !p &&
                                ...
                                ((p = r.match(/(Version)\/([\d.]+)/)), p || (p = [0, 1, '13_0_0']), (f = !1)),
                ...
                z ||
                    (z = (function () {
                        ...
                        const i = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(e.navigator.userAgent),
                            r = a();
                        return { isSafari: s || r, needPerspectiveFix: s, need3dFix: r || (i && t.ios), isWebView: i };
                    })()),
                z
            );
        }
        ...
        var X = {
            ...
            updateSlides: function () {
                ...
                ('string' == typeof x && x.indexOf('%') >= 0
                    ...
                    s.centeredSlides &&
                        s.cssMode &&
                        (h(a, '--swiper-centered-offset-before', ''), h(a, '--swiper-centered-offset-after', '')));
                ...
                if (o && s.loop) {
                    ...
                    for (let a = 0; a < e.virtual.slidesBefore + e.virtual.slidesAfter; a += 1)
                        (1 === s.slidesPerGroup && u.push(u[u.length - 1] + t), m.push(m[m.length - 1] + t), (e.virtualSize += t));
                }
            ...
            translateTo: function (e, t, s, a, i) {
                ...
                if (((c = a && e > o ? o : a && e < d ? d : e), r.updateProgress(c), n.cssMode)) {
                    ...
                    if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
                        ...
                        if (!r.support.smoothScroll) return (f({ swiper: r, targetPosition: -c, side: e ? 'left' : 'top' }), !0);
            ...
            slideTo: function (e, t, s, a, i) {
                ...
                if (l.cssMode) {
                    ...
                    if (0 === t)
                        ...
                        if (!r.support.smoothScroll) return (f({ swiper: r, targetPosition: s, side: e ? 'left' : 'top' }), !0);
        ...
        function _(e) {
            ...
            let w = !0;
            (p.matches(i.focusableElements) && ((w = !1), 'SELECT' === p.nodeName && (i.isTouched = !1)),
                s.activeElement &&
                    s.activeElement.matches(i.focusableElements) &&
                    s.activeElement !== p &&
                    ('mouse' === a.pointerType || ('mouse' !== a.pointerType && !p.matches(i.focusableElements))) &&
        ...
        function j(e) {
            ...
            if (!s.allowTouchMove)
                return (
                    ...
                    void (a.isTouched && (Object.assign(n, { startX: u, startY: m, currentX: u, currentY: m }), (a.touchStartTime = c())))
                );
            ...
            if (
                ...
                t.activeElement && p.target === t.activeElement && p.target.matches(a.focusableElements))
            )
            ...
            if (
                ...
                a.isScrolling || ('touchmove' === p.type && a.preventTouchMoveFromPointerMove))
            )
            ...
            (i.oneWayMovement && ((g = Math.abs(g) * (l ? 1 : -1)), (v = Math.abs(v) * (l ? 1 : -1))),
                (n.diff = g),
                (g *= i.touchRatio),
                l && ((g = -g), (v = -v)));
                ...
                g > 0
                    ? (b &&
                          ...
                          a.currentTranslate >
                              (i.centeredSlides
                                  ? s.minTranslate() -
                                    ...
                                    ('auto' !== i.slidesPerView && s.slides.length - i.slidesPerView >= 2
                      ...
                      a.currentTranslate > s.minTranslate() &&
                          ((E = !1),
                          i.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** x)))
                    : g < 0 &&
                      (b &&
                          y &&
                          a.allowThresholdMove &&
                          ...
                          s.loopFix({
                              ...
                              activeSlideIndex:
                                  s.slides.length -
                                  ('auto' === i.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(i.slidesPerView, 10))),
                          }),
        ...
        function W(e) {
            ...
            for (let e = 0; e < o.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
                ...
                void 0 !== o[e + t]
                    ? (f || (h >= o[e] && h < o[e + t])) && ((g = e), (v = o[e + t] - o[e]))
                    : (f || h >= o[e]) && ((g = e), (v = o[o.length - 1] - o[o.length - 2]));
            }
            let w = null,
                b = null;
            r.rewind &&
            ...
            return function (s) {
                ...
                'object' == typeof i && null !== i
                    ? (!0 === e[a] && (e[a] = { enabled: !0 }),
                      ...
                      a in e && 'enabled' in i
                          ? ('object' != typeof e[a] || 'enabled' in e[a] || (e[a].enabled = !0), e[a] || (e[a] = { enabled: !1 }), m(t, s))
                          : m(t, s))
                    : m(t, s);
            };
        }
        ...
        class ne {
            constructor() {
                ...
                ((l.__swiper__ = !0),
                    (l.support = A()),
                    (l.device = $({ userAgent: t.userAgent })),
                    (l.browser = k()),
                    (l.eventsListeners = {}),
        ...
        const we = [
            function (e) {
                ...
                function d(e, t) {
                    ...
                    return (
                        a.renderSlide
                            ...
                            : (i = s.isElement ? b('swiper-slide') : b('div', s.params.slideClass)),
                ...
                function c(e, t) {
                    ...
                    const { addSlidesBefore: c, addSlidesAfter: p } = s.params.virtual,
                        { from: u, to: m, slides: h, slidesGrid: f, offset: g } = s.virtual;
            ...
            function (e) {
                ...
                function f(e) {
                    return (
                        ...
                        !(t.params.mousewheel.thresholdTime && c() - p < t.params.mousewheel.thresholdTime) &&
                        ((e.delta >= 6 && c() - p < 60) ||
                            (e.direction < 0
                ...
                function g(e) {
                    ...
                    if (
                        ...
                        const e = { time: c(), delta: Math.abs(m), direction: Math.sign(m) },
                            ...
                            if (
                                ...
                                n ||
                                    (n = d(() => {
                                        ...
                                        ((o = e), u.splice(0), t.slideToClosest(t.params.speed, !0, void 0, 0.5));
                                    }, 500));
                            }
                            if (
                                (a || i('scroll', s),
                        ...
                        const s = { time: c(), delta: Math.abs(m), direction: Math.sign(m), raw: e };
                        u.length >= 2 && u.shift();
            ...
            function (e) {
                ...
                function c() {
                    ...
                    if (
                        ((t.params.navigation = le(t, t.originalParams.navigation, t.params.navigation, {
                    ...
                    let s = r(e.nextEl),
                        a = r(e.prevEl);
                    (Object.assign(t.navigation, { nextEl: s, prevEl: a }), (s = C(s)), (a = C(a)));
                    const i = (s, a) => {
            ...
            function (e) {
                    ...
                    ('fraction' === e.type &&
                        ...
                        a.forEach((s) => {
                            ('custom' !== e.type && (s.innerHTML = r || ''),
                                'bullets' === e.type && t.pagination.bullets.push(...s.querySelectorAll(oe(e.bulletClass))));
                        }),
                        'custom' !== e.type && i('paginationRender', a[0]));
                }
                function m() {
                    t.params.pagination = le(t, t.originalParams.pagination, t.params.pagination, { el: 'swiper-pagination' });
                    const e = t.params.pagination;
                    if (!e.el) return;
                    let s;
                ...
                Object.assign(t.pagination, {
                    enable: () => {
                        ...
                        let { el: e } = t.pagination;
                        (e && ((e = C(e)), e.forEach((e) => e.classList.remove(t.params.pagination.paginationDisabledClass))),
                            m(),
                            u(),
                            p());
                    },
            ...
            function (e) {
                ...
                function P() {
                    ...
                    t.params.scrollbar = le(t, t.originalParams.scrollbar, t.params.scrollbar, { el: 'swiper-scrollbar' });
                    ...
                    (t.params.uniqueNavElements &&
                        ...
                        i &&
                            ((r = i.querySelector(oe(t.params.scrollbar.dragClass))),
                    ...
                    if (((n = !1), (o = !1), u.push(e), !(u.length < 2))) {
                        ...
                        if (m.imageEl) {
                            const [e, t] = (function () {
                                ...
                                return [
                                    (u[0].pageX + (u[1].pageX - u[0].pageX) / 2 - e.x - r.scrollX) / d,
                                    (u[0].pageY + (u[1].pageY - u[0].pageY) / 2 - e.y - r.scrollY) / d,
                                ];
                            })();
                    ...
                    ((s.scale = z || A),
                        ...
                        !e || (1 === d && z)
                            ...
                            : ((L = m.slideEl.offsetWidth),
                              ...
                              (c = l + L / 2 - i),
                              (p = o + I / 2 - n),
                              (g = m.imageEl.offsetWidth || m.imageEl.clientWidth),
                              (w = m.imageEl.offsetHeight || m.imageEl.clientHeight),
                              (b = g * s.scale),
                              (x = w * s.scale),
                              (T = Math.min(L / 2 - b / 2, 0)),
            ...
            function (e) {
                ...
                function v(e) {
                    ...
                    if (
                        ...
                        if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
                            ...
                            (C(t.navigation.nextEl).includes(a) &&
                ...
                const E = (e, t, s) => {
                        (c(e),
                            'BUTTON' !== e.tagName && (u(e, 'button'), e.addEventListener('keydown', v)),
                            h(e, s),
                            (function (e, t) {
                                (e = C(e)).forEach((e) => {
                    ...
                    I = () => {
                        ...
                        if (
                            ...
                            p && p.forEach((t) => E(t, i, e.prevSlideMessage)),
                            y())
                        ) {
                ...
                (a('beforeInit', () => {
                    ((l = b('span', t.params.a11y.notificationClass)),
                                    ...
                                    t.pagination.bullets.forEach((s) => {
                                        (t.params.pagination.clickable &&
                                            ...
                                            t.params.pagination.renderBullet ||
                                                (u(s, 'button'), h(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, x(s) + 1)))),
                                            s.matches(oe(t.params.pagination.bulletActiveClass))
                    ...
                    hashNavigation: {
                        ...
                        getSlideIndex(e, s) {
                            ...
                            return t.getSlideIndex(
                                v(t.slidesEl, `.${t.params.slideClass}[data-hash="${s}"], swiper-slide[data-hash="${s}"]`)[0]
                            );
                        },
                    },
                });
                ...
                const E = () => {
                    ...
                    C = () => {
                        (a.isEnd && d < 0 && !a.params.loop) ||
                            a.destroyed ||
                            !a.autoplay.running ||
                            ((b = new Date().getTime()), f ? ((f = !1), x(d)) : x(), (a.autoplay.paused = !1), l('autoplayResume'));
                    },
                    P = () => {
                        if (a.destroyed || !a.autoplay.running) return;
                        const e = r();
                ...
                (n('init', () => {
                    a.params.autoplay.enabled &&
                        (a.params.autoplay.pauseOnMouseEnter &&
                            (a.el.addEventListener('pointerenter', L), a.el.addEventListener('pointerleave', I)),
                    ...
                    n('destroy', () => {
                        (a.el &&
                            'string' != typeof a.el &&
                            (a.el.removeEventListener('pointerenter', L), a.el.removeEventListener('pointerleave', I)),
                        ...
                        freeMode: {
                            ...
                            onTouchMove: function () {
                                ...
                                (0 === e.velocities.length &&
                                    ...
                                    e.velocities.push({ position: s[t.isHorizontal() ? 'currentX' : 'currentY'], time: c() }));
                            },
                                ...
                                if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                                    ...
                                    if (r.freeMode.momentum) {
                                        ...
                                        if (p < t.maxTranslate())
                                            ...
                                            ((p =
                                                Math.abs(o[e] - p) < Math.abs(o[e - 1] - p) || 'next' === t.swipeDirection
                                                    ? o[e]
                                                    : o[e - 1]),
                                                (p = -p));
                                        }
            ...
            function (e) {
                ...
                const i = (e, t, s) => {
                    ...
                    (a ||
                        ((a = b('div', ('swiper-slide-shadow-cube swiper-slide-shadow-' + (s ? 'left' : 'top')).split(' '))), e.append(a)),
                        i ||
                            ((i = b('div', ('swiper-slide-shadow-cube swiper-slide-shadow-' + (s ? 'right' : 'bottom')).split(' '))),
                            e.append(i)),
                        ...
                        p.shadow &&
                            (u
                                ? ((h = t.wrapperEl.querySelector('.swiper-cube-shadow')),
                                  h || ((h = b('div', 'swiper-cube-shadow')), t.wrapperEl.append(h)),
                                  (h.style.height = `${r}px`))
                                : ((h = e.querySelector('.swiper-cube-shadow')), h || ((h = b('div', 'swiper-cube-shadow')), e.append(h))));
                        for (let e = 0; e < a.length; e += 1) {
                            const t = a[e];
                            let s = e;
            ...
            function (e) {
                ...
                const i = (e, s) => {
                    ...
                    (a || (a = ve('flip', e, t.isHorizontal() ? 'left' : 'top')),
                        i || (i = ve('flip', e, t.isHorizontal() ? 'right' : 'bottom')),
