/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/leaflet/leaflet.js
 * @type: Module
                    ...
                    !(function (t) {
                        ...
                        function Z(t) {
                            if ('undefined' != typeof L && L && L.Mixin) {
                                t = g(t) ? t : [t];
                                for (var i = 0; i < t.length; i++) (t[i], L.Mixin.Events);
                            }
                        }
                        ((S.extend = function (t) {
                            var i = function () {
                            ...
                            return (
                                ...
                                t.includes && (Z(t.includes), e.apply(null, [s].concat(t.includes))),
                                e(s, t),
                                delete s.statics,
                                delete s.includes,
                                s.options && ((s.options = o.options ? n(o.options) : {}), e(s.options, t.options)),
                                (s._initHooks = []),
                        ...
                        var E = {
                            ...
                            _on: function (t, i, e, n) {
                                if ('function' == typeof i && !1 === this._listens(t, i, e)) {
                                    e === this && (e = void 0);
                                    var o = { fn: i, ctx: e };
                                    (n && (o.once = !0),
                                ...
                                if (this._events && (n = this._events[t]))
                                    if (1 !== arguments.length) {
                                        if ('function' == typeof i) {
                                            ...
                                            if (!1 !== r) {
                                                var a = n[r];
                                                (this._firingCount && ((a.fn = u), (this._events[t] = n = n.slice())), n.splice(r, 1));
                                            }
                                        }
                                    } else {
                            ...
                            once: function (t, i, e) {
                                ...
                                else for (var o = 0, s = (t = d(t)).length; o < s; o++) this._on(t[o], i, e, !0);
                                return this;
                            },
                        ...
                        ((O.prototype = {
                            ...
                            (I.prototype = {
                                extend: function (t) {
                                    var i, e;
                                    if (!t) return this;
                                    if (t instanceof O || 'number' == typeof t[0] || 'x' in t) i = e = B(t);
                                ...
                                contains: function (t) {
                                    var i, e;
                                    return (
                                        (t = 'number' == typeof t[0] || t instanceof O ? B(t) : R(t)) instanceof I
                                            ? ((i = t.min), (e = t.max))
                                            : (i = e = t),
                                ...
                                equals: function (t) {
                                    return !!t && ((t = R(t)), this.min.equals(t.getTopLeft()) && this.max.equals(t.getBottomRight()));
                                },
                            }),
                            (N.prototype = {
                                extend: function (t) {
                                ...
                                contains: function (t) {
                                    t = 'number' == typeof t[0] || t instanceof j || 'lat' in t ? H(t) : D(t);
                                    var i,
                                        e,
                                        n = this._southWest,
                                        o = this._northEast;
                        ...
                        var F,
                            W = {
                                ...
                                wrapLatLng: function (t) {
                                    ...
                                    return new j(this.wrapLat ? h(t.lat, this.wrapLat, !0) : t.lat, i, t.alt);
                                },
                            ...
                            q = {
                                ...
                                project: function (t) {
                                    var i = Math.PI / 180,
                                        ...
                                        o = Math.sin(n * i);
                                    return new O(this.R * t.lng * i, (this.R * Math.log((1 + o) / (1 - o))) / 2);
                                },
                                unproject: function (t) {
                                    var i = 180 / Math.PI;
                                    return new j((2 * Math.atan(Math.exp(t.y / this.R)) - Math.PI / 2) * i, (t.x * i) / this.R);
                                },
                                bounds: ((F = V * Math.PI), new I([-F, -F], [F, F])),
                            };
                        function G(t, i, e, n) {
                        ...
                        G.prototype = {
                            ...
                            untransform: function (t, i) {
                                return ((i = i || 1), new O((t.x / i - this._b) / this._a, (t.y / i - this._d) / this._c));
                            },
                        };
                        var Y = e({}, U, {
                                code: 'EPSG:3857',
                        ...
                        var Q,
                            ...
                            Ot =
                                ...
                                'http://www.w3.org/2000/svg' === (Q.firstChild && Q.firstChild.namespaceURI)),
                            At =
                                !kt &&
                                (function () {
                                    try {
                        ...
                        var Nt = {
                            ...
                            Ft = Nt.msPointer ? 'MSPointerCancel' : 'pointercancel',
                            Wt = { touchstart: Dt, touchmove: jt, touchend: Ht, touchcancel: Ft },
                        ...
                        function Gt(t, i, e) {
                            return (
                                'touchstart' === i && $t(),
                                Ut[i] ? ((e = Ut[i].bind(this, e)), t.addEventListener(Wt[i], e, !1), e) : u
                            );
                        }
                        function Kt(t, i, e) {
                            Wt[i] && t.removeEventListener(Wt[i], e, !1);
                        }
                        function Yt(t) {
                            Vt[t.pointerId] = t;
                        }
                        ...
                        function $t() {
                            qt ||
                                ...
                                document.addEventListener(Ft, Jt, !0),
                                (qt = !0));
                        }
                        function Qt(t, i) {
                        ...
                        var si,
                            ...
                            hi,
                            ui,
                            li = zi(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']),
                        ...
                        function Ci(t, i, e) {
                            var n = i || new O(0, 0);
                            t.style[li] =
                                (Nt.ie3d ? 'translate(' + n.x + 'px,' + n.y + 'px)' : 'translate3d(' + n.x + 'px,' + n.y + 'px,0)') +
                                (e ? ' scale(' + e + ')' : '');
                        }
                        function Si(t, i) {
                            ((t._leaflet_pos = i), Nt.any3d ? Ci(t, i) : ((t.style.left = i.x + 'px'), (t.style.top = i.y + 'px')));
                        }
                        function Zi(t) {
                        ...
                        if ('onselectstart' in document)
                            ...
                            var Ei = zi(['userSelect', 'WebkitUserSelect', 'OUserSelect', 'MozUserSelect', 'msUserSelect']);
                            ((si = function () {
                                if (Ei) {
                        ...
                        function Ai(t) {
                            ...
                            t.style &&
                                (Bi(), (hi = t), (ui = t.style.outlineStyle), (t.style.outlineStyle = 'none'), Di(window, 'keydown', Bi));
                        }
                        function Bi() {
                            hi && ((hi.style.outlineStyle = ui), (hi = void 0), (ui = void 0), Hi(window, 'keydown', Bi));
                        }
                        function Ii(t) {
                            do {
                                t = t.parentNode;
                        ...
                        function Di(t, i, e, n) {
                            ...
                            else for (var s = 0, r = (i = d(i)).length; s < r; s++) Ui(t, i[s], e, n);
                            return this;
                        }
                        var ji = '_leaflet_events';
                        function Hi(t, i, e, n) {
                            if (1 === arguments.length) (Fi(t), delete t[ji]);
                            else if (i && 'object' == typeof i) for (var o in i) Vi(t, o, i[o], e);
                            else if (((i = d(i)), 2 === arguments.length))
                                Fi(t, function (t) {
                                    return -1 !== v(i, t);
                                });
                        ...
                        var Wi = { mouseenter: 'mouseover', mouseleave: 'mouseout', wheel: !('onwheel' in window) && 'mousewheel' };
                        function Ui(t, i, e, n) {
                            var o = i + r(e) + (n ? '_' + r(n) : '');
                                ...
                                : Nt.touch && 'dblclick' === i
                                  ...
                                  : 'addEventListener' in t
                                    ? 'touchstart' === i || 'touchmove' === i || 'wheel' === i || 'mousewheel' === i
                                        ? t.addEventListener(Wi[i] || i, s, !!Nt.passiveEvents && { passive: !1 })
                                        : 'mouseenter' === i || 'mouseleave' === i
                                          ? ((s = function (i) {
                                                ((i = i || window.event), ie(t, i) && a(i));
                                            }),
                                            t.addEventListener(Wi[i], s, !1))
                            ...
                            (!Nt.touchNative && Nt.pointer && 0 === i.indexOf('touch')
                                ...
                                : Nt.touch && 'dblclick' === i
                                  ...
                                  : 'removeEventListener' in t
                                    ? t.removeEventListener(Wi[i] || i, s, !1)
                        ...
                        function Ki(t) {
                            return (Di(t, 'mousedown touchstart dblclick contextmenu', qi), (t._leaflet_disable_click = !0), this);
                        }
                        function Yi(t) {
                        ...
                        function $i(t, i) {
                            ...
                            return new O((t.clientX - n.left) / e.x - i.clientLeft, (t.clientY - n.top) / e.y - i.clientTop);
                        }
                        var Qi =
                            Nt.linux && Nt.chrome
                            ...
                            oe = k.extend({
                                ...
                                initialize: function (t, i) {
                                    ((i = _(this, i)),
                                        ...
                                        i.center && void 0 !== i.zoom && this.setView(H(i.center), i.zoom, { reset: !0 }),
                                        this.callInitHooks(),
                                        (this._zoomAnimated = ci && Nt.any3d && !Nt.mobileOpera && this.options.zoomAnimation),
                                        this._zoomAnimated &&
                                            (this._createAnimProxy(), Di(this._proxy, di, this._catchTransitionEnd, this)),
                                ...
                                zoomIn: function (t, i) {
                                    return ((t = t || (Nt.any3d ? this.options.zoomDelta : 1)), this.setZoom(this._zoom + t, i));
                                },
                                ...
                                setZoomAround: function (t, i, e) {
                                    var n = this.getZoomScale(i),
                                        ...
                                        s = (t instanceof O ? t : this.latLngToContainerPoint(t)).subtract(o).multiplyBy(1 - 1 / n),
                                ...
                                flyTo: function (t, i, e) {
                                    if (!1 === (e = e || {}).animate || !Nt.any3d) return this.setView(t, i, e);
                                    this._stop();
                                ...
                                getSize: function () {
                                    return (
                                        (this._size && !this._sizeChanged) ||
                                            ((this._size = new O(this._container.clientWidth || 0, this._container.clientHeight || 0)),
                                            (this._sizeChanged = !1)),
                                        this._size.clone()
                                    );
                                },
                                ...
                                project: function (t, i) {
                                    return ((i = void 0 === i ? this._zoom : i), this.options.crs.latLngToPoint(H(t), i));
                                },
                                ...
                                _initPanes: function () {
                                    ...
                                    ((this._paneRenderers = {}),
                                        ...
                                        this.options.markerZoomAnimation ||
                                            (wi(t.markerPane, 'leaflet-zoom-hide'), wi(t.shadowPane, 'leaflet-zoom-hide')));
                                },
                                ...
                                _findEventTargets: function (t, i) {
                                    for (
                                        var e, n = [], o = 'mouseout' === i || 'mouseover' === i, s = t.target || t.srcElement, a = !1;
                                        s;

                                    ) {
                                        if ((e = this._targets[r(s)]) && ('click' === i || 'preclick' === i) && this._draggableMoved(e)) {
                                            a = !0;
                                            break;
                                        }
                                        if (e && e.listens(i, !0)) {
                                    ...
                                    if (s.length) {
                                        ...
                                        if ('keypress' !== t.type && 'keydown' !== t.type && 'keyup' !== t.type) {
                                            ...
                                            ((u.containerPoint = l
                                                ...
                                                (u.latlng = l ? h.getLatLng() : this.layerPointToLatLng(u.layerPoint)));
                                        }
                                        for (a = 0; a < s.length; a++)
                                            if (
                                                (s[a].fire(i, u, !0),
                                                u.originalEvent._stopped ||
                                                    (!1 === s[a].options.bubblingMouseEvents && -1 !== v(this._mouseEvents, i)))
                                            )
                                                return;
                                    }
                                },
                                ...
                                _getMapPanePos: function () {
                                    return Zi(this._mapPane) || new O(0, 0);
                                },
                                _moved: function () {
                                    var t = this._getMapPanePos();
                                    ...
                                    (this._panes.mapPane.appendChild(t),
                                        this.on(
                                            ...
                                            function (t) {
                                                ...
                                                (Ci(this._proxy, this.project(t.center, t.zoom), this.getZoomScale(t.zoom, 1)),
                        ...
                        var he = re.extend({
                                ...
                                addTo: function (t) {
                                    return (re.prototype.addTo.call(this, t), this._expandIfNotCollapsed());
                                },
                                onRemove: function () {
                                ...
                                _initLayout: function () {
                                    ...
                                    e &&
                                        ...
                                        Di(i, { mouseenter: this._expandSafely, mouseleave: this.collapse }, this));
                                ...
                                _addItem: function (t) {
                                    ...
                                    (t.overlay
                                        ? (((i = document.createElement('input')).type = 'checkbox'),
                                          ...
                                          (i.defaultChecked = n))
                                        : (i = this._createRadioElement('leaflet-base-layers_' + r(this), n)),
                                ...
                                _updateDisabled: function () {
                                    ...
                                    (bi(this._zoomInButton, i),
                                        ...
                                        (this._disabled || t._zoom === t.getMinZoom()) &&
                                            (wi(this._zoomOutButton, i), this._zoomOutButton.setAttribute('aria-disabled', 'true')),
                                        (this._disabled || t._zoom === t.getMaxZoom()) &&
                                            (wi(this._zoomInButton, i), this._zoomInButton.setAttribute('aria-disabled', 'true')));
                                },
                            });
                        (oe.mergeOptions({ zoomControl: !0 }),
                            oe.addInitHook(function () {
                                this.options.zoomControl && ((this.zoomControl = new le()), this.addControl(this.zoomControl));
                            }));
                        var ce = function (t) {
                                return new le(t);
                            },
                        ...
                        var ve = { Events: E },
                            ...
                            xe = k.extend({
                                ...
                                enable: function () {
                                    this._enabled || (Di(this._dragStartTarget, ye, this._onDown, this), (this._enabled = !0));
                                },
                                disable: function () {
                                    this._enabled &&
                                    ...
                                    if (this._enabled && ((this._moved = !1), !xi(this._element, 'leaflet-zoom-anim')))
                                        if (t.touches && 1 !== t.touches.length) xe._dragging === this && this.finishDrag();
                                            ...
                                            !(
                                                ...
                                                ((xe._dragging = this), this._preventOutline && Ai(this._element), ki(), si(), this._moving)
                                            )
                                        ) {
                                            this.fire('down');
                                ...
                                finishDrag: function (t) {
                                    (bi(document.body, 'leaflet-dragging'),
                                        this._lastTarget && (bi(this._lastTarget, 'leaflet-drag-target'), (this._lastTarget = null)),
                                    ...
                                    ((this._moving = !1),
                                        (xe._dragging = !1),
                                        i && this.fire('dragend', { noInertia: t, distance: this._newPos.distanceTo(this._startPos) }));
                                },
                            });
                        function we(t, i, e) {
                            var n,
                                ...
                                c,
                                d = [1, 4, 2, 8];
                            for (o = 0, u = t.length; o < u; o++) t[o]._code = Ae(t[o], i);
                            for (r = 0; r < 4; r++) {
                                for (l = d[r], n = [], o = 0, s = (u = t.length) - 1; o < u; s = o++)
                                    ((a = t[o]),
                                        (h = t[s]),
                                        a._code & l
                                            ? h._code & l || (((c = Oe(h, a, l, i, e))._code = Ae(c, i)), n.push(c))
                                            : (h._code & l && (((c = Oe(h, a, l, i, e))._code = Ae(c, i)), n.push(c)), n.push(a)));
                                t = n;
                            }
                            return t;
                        }
                        function be(t, i) {
                            ...
                            var c = H([0, 0]),
                                d = D(t);
                            d.getNorthWest().distanceTo(d.getSouthWest()) * d.getNorthEast().distanceTo(d.getNorthWest()) < 1700 &&
                                (c = Pe(t));
                            var _ = t.length,
                                p = [];
                            for (e = 0; e < _; e++) {
                        ...
                        var Le,
                            Te = { __proto__: null, clipPolygon: we, polygonCenter: be, centroid: Pe };
                        function Me(t, i) {
                            if (!i || !t.length) return t.slice();
                            var e = i * i;
                            return (t = Se((t = Ee(t, e)), e));
                        }
                        function ze(t, i, e) {
                        ...
                        function Ze(t, i, e, n, o) {
                            var s,
                                ...
                                a,
                                h = 0;
                            for (r = n + 1; r <= o - 1; r++) (a = Ie(t[r], t[n], t[o], !0)) > h && ((s = r), (h = a));
                            h > e && ((i[s] = 1), Ze(t, i, e, n, s), Ze(t, i, e, s, o));
                        }
                        function Ee(t, i) {
                            for (var e = [t[0]], n = 1, o = 0, s = t.length; n < s; n++) Be(t[n], t[o]) > i && (e.push(t[n]), (o = n));
                        ...
                        function ke(t, i, e, n, o) {
                            ...
                            for (Le = u; ; ) {
                                if (!(h | u)) return [t, i];
                                if (h & u) return !1;
                                ((a = Ae((r = Oe(t, i, (s = h || u), e, o)), e)), s === h ? ((t = r), (h = a)) : ((i = r), (u = a)));
                            }
                        }
                        ...
                        function De(t, i) {
                            ...
                            var l = H([0, 0]),
                                c = D(t);
                            c.getNorthWest().distanceTo(c.getSouthWest()) * c.getNorthEast().distanceTo(c.getNorthWest()) < 1700 &&
                                (l = Pe(t));
                            var d = t.length,
                                _ = [];
                            for (e = 0; e < d; e++) {
                                var p = H(t[e]);
                                _.push(i.project(H([p.lat - l.lat, p.lng - l.lng])));
                            }
                            ...
                            var m = i.unproject(B(u));
                            return H([m.lat + l.lat, m.lng + l.lng]);
                        }
                        var je = {
                                __proto__: null,
                                simplify: Me,
                            ...
                            Fe = {
                                ...
                                project: function (t) {
                                    ...
                                    return ((n = -e * Math.log(Math.max(a, 1e-10))), new O(t.lng * i * e, n));
                                },
                                unproject: function (t) {
                                    for (
                                        var i,
                            ...
                            We = { __proto__: null, LonLat: He, Mercator: Fe, SphericalMercator: q },
                            Ue = e({}, U, {
                                code: 'EPSG:3395',
                                projection: Fe,
                                transformation: (function () {
                                    var t = 0.5 / (Math.PI * Fe.R);
                                    return K(t, 0.5, -t, 0.5);
                                })(),
                            }),
                            Ve = e({}, U, { code: 'EPSG:4326', projection: He, transformation: K(1 / 180, 1, -1 / 180, 0.5) }),
                            qe = e({}, W, {
                                projection: He,
                        ...
                        var Ke = Ge.extend({
                            ...
                            $e = S.extend({
                                ...
                                _getIconUrl: function (t) {
                                    return (Nt.retina && this.options[t + 'RetinaUrl']) || this.options[t + 'Url'];
                                },
                            });
                        function Qe(t) {
                            return new $e(t);
                        ...
                        var tn = $e.extend({
                                ...
                                _getIconUrl: function (t) {
                                    return (
                                        'string' != typeof tn.imagePath && (tn.imagePath = this._detectIconPath()),
                                        (this.options.imagePath || tn.imagePath) + $e.prototype._getIconUrl.call(this, t)
                                    );
                                },
                            ...
                            en = ge.extend({
                                ...
                                removeHooks: function () {
                                    (this._draggable
                                        ...
                                        .disable(),
                                        this._marker._icon && bi(this._marker._icon, 'leaflet-marker-draggable'));
                                },
                                moved: function () {
                                ...
                                _adjustPan: function (t) {
                                    ...
                                    if (!h.contains(s)) {
                                        ...
                                        (e.panBy(u, { animate: !1 }),
                                            ...
                                            Si(i._icon, this._draggable._newPos),
                                            this._onDrag(t),
                            ...
                            nn = Ge.extend({
                                ...
                                _initIcon: function () {
                                    ...
                                    (e !== this._icon &&
                                        ...
                                        this.options.autoPanOnFocus && Di(e, 'focus', this._panOnFocus, this));
                                ...
                                _removeIcon: function () {
                                    (this.options.riseOnHover && this.off({ mouseover: this._bringToFront, mouseout: this._resetZIndex }),
                                        this.options.autoPanOnFocus && Hi(this._icon, 'focus', this._panOnFocus, this),
                                        fi(this._icon),
                                ...
                                _setPos: function (t) {
                                    (this._icon && Si(this._icon, t),
                                        this._shadow && Si(this._shadow, t),
                                ...
                                _initInteraction: function () {
                                    if (
                                        ...
                                        (wi(this._icon, 'leaflet-interactive'), this.addInteractiveTarget(this._icon), en)
                                    ) {
                        ...
                        var sn = Ge.extend({
                            ...
                            rn = sn.extend({
                                ...
                                initialize: function (t, i) {
                                    (_(this, i), (this._latlng = H(t)), (this._radius = this.options.radius));
                                },
                                setLatLng: function (t) {
                                    var i = this._latlng;
                                    return (
                        ...
                        var ln = sn.extend({
                            ...
                            closestLayerPoint: function (t) {
                                for (var i, e, n = 1 / 0, o = null, s = Ie, r = 0, a = this._parts.length; r < a; r++)
                            ...
                            addLatLng: function (t, i) {
                                return ((i = i || this._defaultShape()), (t = H(t)), i.push(t), this._bounds.extend(t), this.redraw());
                            },
                            ...
                            _convertLatLngs: function (t) {
                                for (var i = [], e = Re(t), n = 0, o = t.length; n < o; n++)
                                    e ? ((i[n] = H(t[n])), this._bounds.extend(i[n])) : (i[n] = this._convertLatLngs(t[n]));
                                return i;
                            },
                            _project: function () {
                                var t = new I();
                        ...
                        var dn = ln.extend({
                            ...
                            _convertLatLngs: function (t) {
                                var i = ln.prototype._convertLatLngs.call(this, t),
                                    e = i.length;
                                return (e >= 2 && i[0] instanceof j && i[0].equals(i[e - 1]) && i.pop(), i);
                            },
                            _setLatLngs: function (t) {
                                (ln.prototype._setLatLngs.call(this, t), Re(this._latlngs) && (this._latlngs = [this._latlngs]));
                            },
                            _defaultShape: function () {
                            ...
                            _containsPoint: function (t) {
                                ...
                                return u || ln.prototype._containsPoint.call(this, t, !0);
                            },
                        });
                        function _n(t, i) {
                            return new dn(t, i);
                        ...
                        function mn(t, i) {
                            var e,
                                ...
                                h = [],
                                u = i && i.pointToLayer,
                                l = (i && i.coordsToLatLng) || gn;
                            if (!a && !r) return null;
                            switch (r.type) {
                                case 'Point':
                                    return fn(u, t, (e = l(a)), i);
                                case 'MultiPoint':
                                    for (o = 0, s = a.length; o < s; o++) ((e = l(a[o])), h.push(fn(u, t, e, i)));
                                    return new Xe(h);
                                case 'LineString':
                                case 'MultiLineString':
                                    return ((n = vn(a, 'LineString' === r.type ? 0 : 1, l)), new ln(n, i));
                                case 'Polygon':
                                case 'MultiPolygon':
                                    return ((n = vn(a, 'Polygon' === r.type ? 1 : 2, l)), new dn(n, i));
                                case 'GeometryCollection':
                                    for (o = 0, s = r.geometries.length; o < s; o++) {
                                        var c = mn({ geometry: r.geometries[o], type: 'Feature', properties: t.properties }, i);
                                        c && h.push(c);
                                    }
                                    return new Xe(h);
                                case 'FeatureCollection':
                                    for (o = 0, s = r.features.length; o < s; o++) {
                                        var d = mn(r.features[o], i);
                                        d && h.push(d);
                                    }
                                    return new Xe(h);
                                default:
                        ...
                        function yn(t, i) {
                            return void 0 !== (t = H(t)).alt ? [l(t.lng, i), l(t.lat, i), l(t.alt, i)] : [l(t.lng, i), l(t.lat, i)];
                        }
                        function xn(t, i, e, n) {
                        ...
                        (nn.include(Pn),
                            ...
                            dn.include({
                                toGeoJSON: function (t) {
                                    ...
                                    return (i || (n = [n]), wn(this, { type: (e ? 'Multi' : '') + 'Polygon', coordinates: n }));
                                },
                            }),
                            Ke.include({
                        ...
                        var Tn = Ln,
                            Mn = Ge.extend({
                                ...
                                initialize: function (t, i, e) {
                                    ((this._url = t), (this._bounds = D(i)), _(this, e));
                                },
                                onAdd: function () {
                                    (this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
                                        this.options.interactive &&
                                            (wi(this._image, 'leaflet-interactive'), this.addInteractiveTarget(this._image)),
                        ...
                        var kn = Ge.extend({
                            ...
                            initialize: function (t, i) {
                                (t && (t instanceof j || g(t)) ? ((this._latlng = H(t)), _(this, i)) : (_(this, t), (this._source = i)),
                            ...
                            onAdd: function (t) {
                                ((this._zoomAnimated = t._zoomAnimated),
                                    ...
                                    this.bringToFront(),
                                    this.options.interactive &&
                                        (wi(this._container, 'leaflet-interactive'), this.addInteractiveTarget(this._container)));
                            },
                            onRemove: function (t) {
                                (t._fadeAnimated
                                    ? (Ti(this._container, 0), (this._removeTimeout = setTimeout(o(fi, void 0, this._container), 200)))
                                    : fi(this._container),
                                    this.options.interactive &&
                                        (bi(this._container, 'leaflet-interactive'), this.removeInteractiveTarget(this._container)));
                            },
                            getLatLng: function () {
                                return this._latlng;
                            },
                        ...
                        (oe.include({
                            ...
                            Ge.include({
                                _initOverlay: function (t, i, e, n) {
                                    var o = e;
                                    return (
                                        o instanceof t ? (_(o, n), (o._source = this)) : (o = i && !n ? i : new t(n, this)).setContent(e),
                                        o
                                    );
                                },
                            }));
                        ...
                        var Dn = Ge.extend({
                            ...
                            _initContainer: function () {
                                this._container ||
                                    ((this._container = mi('div', 'leaflet-layer ' + (this.options.className || ''))),
                                    this._updateZIndex(),
                            ...
                            _invalidateAll: function () {
                                for (var t in this._levels)
                                    (fi(this._levels[t].el), this._onRemoveLevel(Number(t)), delete this._levels[t]);
                            ...
                            _setZoomTransform: function (t, i, e) {
                                ...
                                Nt.any3d ? Ci(t.el, o, n) : Si(t.el, o);
                            },
                            _resetGrid: function () {
                                var t = this._map,
                                    i = t.options.crs,
                                ...
                                if (i) {
                                    ...
                                    if ((void 0 === t && (t = i.getCenter()), void 0 !== this._tileZoom)) {
                                        ...
                                        for (var u in this._tiles) {
                                            ...
                                            (l.z === this._tileZoom && h.contains(new O(l.x, l.y))) || (this._tiles[u].current = !1);
                                        }
                            ...
                            _tileReady: function (t, i, e) {
                                ...
                                (e = this._tiles[n]) &&
                                    ...
                                    this._map._fadeAnimated
                                        ? (Ti(e.el, 0), z(this._fadeFrame), (this._fadeFrame = M(this._updateOpacity, this)))
                                        : ((e.active = !0), this._pruneTiles()),
                                    i || (wi(e.el, 'leaflet-tile-loaded'), this.fire('tileload', { tile: e.el, coords: t })),
                                    this._noTilesToLoad() &&
                                        ((this._loading = !1),
                                        this.fire('load'),
                            ...
                            _wrapCoords: function (t) {
                                var i = new O(this._wrapX ? h(t.x, this._wrapX) : t.x, this._wrapY ? h(t.y, this._wrapY) : t.y);
                                return ((i.z = t.z), i);
                            },
                        ...
                        var Hn = Dn.extend({
                            ...
                            initialize: function (t, i) {
                                ((this._url = t),
                                    (i = _(this, i)).detectRetina && Nt.retina && i.maxZoom > 0
                            ...
                            getTileUrl: function (t) {
                                var i = { r: Nt.retina ? '@2x' : '', s: this._getSubdomain(t), x: t.x, y: t.y, z: this._getZoomForUrl() };
                            ...
                            _abortLoading: function () {
                                ...
                                for (t in this._tiles)
                                    if (
                                        ...
                                        (fi(i), delete this._tiles[t], this.fire('tileabort', { tile: i, coords: e }));
                                    }
                            },
                            _removeTile: function (t) {
                                var i = this._tiles[t];
                                if (i) return (i.el.setAttribute('src', y), Dn.prototype._removeTile.call(this, t));
                            },
                            _tileReady: function (t, i, e) {
                                if (this._map && (!e || e.getAttribute('src') !== y)) return Dn.prototype._tileReady.call(this, t, i, e);
                            },
                        });
                        function Fn(t, i) {
                            return new Hn(t, i);
                        ...
                        var Wn = Hn.extend({
                            ...
                            initialize: function (t, i) {
                                ...
                                var s = (i = _(this, i)).detectRetina && Nt.retina ? 2 : 1,
                                    r = this.getTileSize();
                            ...
                            getTileUrl: function (t) {
                                var i = this._tileCoordsToNwSe(t),
                                    ...
                                    o = n.min,
                                    s = n.max,
                                    r = (this._wmsVersion >= 1.3 && this._crs === Ve ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(
                                        ','
                                    ),
                        ...
                        var Vn = Ge.extend({
                                options: { padding: 0.1 },
                                initialize: function (t) {
                                    (_(this, t), r(this), (this._layers = this._layers || {}));
                                },
                                onAdd: function () {
                                    (this._container || (this._initContainer(), wi(this._container, 'leaflet-zoom-animated')),
                                        this.getPane().appendChild(this._container),
                                        this._update(),
                                ...
                                _updateTransform: function (t, i) {
                                    ...
                                    Nt.any3d ? Ci(this._container, s, e) : Si(this._container, s);
                                },
                                _reset: function () {
                            ...
                            qn = Vn.extend({
                                ...
                                _initContainer: function () {
                                    ...
                                    (Di(t, 'mousemove', this._onMouseMove, this),
                                        Di(t, 'click dblclick mousedown mouseup contextmenu', this._onClick, this),
                                ...
                                _handleMouseHover: function (t, i) {
                                    if (!this._mouseHoverThrottled) {
                                        for (var e, n, s = this._drawFirst; s; s = s.next)
                                            (e = s.layer).options.interactive && e._containsPoint(i) && (n = e);
                        ...
                        var Kn = (function () {
                            ...
                            Jn = Vn.extend({
                                ...
                                _removePath: function (t) {
                                    (fi(t._path), t.removeInteractiveTarget(t._path), delete this._layers[r(t)]);
                                },
                                _updatePath: function (t) {
                        ...
                        var io = ge.extend({
                            ...
                            _finish: function () {
                                (this._moved && (fi(this._box), bi(this._container, 'leaflet-crosshair')),
                                    ri(),
                                    Oi(),
                                    Hi(
                                        document,
                        ...
                        (oe.addInitHook('addHandler', 'boxZoom', io), oe.mergeOptions({ doubleClickZoom: !0 }));
                        var eo = ge.extend({
                            addHooks: function () {
                        ...
                        (oe.addInitHook('addHandler', 'dragging', no), oe.mergeOptions({ keyboard: !0, keyboardPanDelta: 80 }));
                        var oo = ge.extend({
                            keyCodes: {
                                left: [37],
                                right: [39],
                            ...
                            addHooks: function () {
                                ...
                                (t.tabIndex <= 0 && (t.tabIndex = '0'),
                                    Di(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
                                    ...
                                    if (e in this._panKeys) {
                                        if (!n._panAnim || !n._panAnim._inProgress)
                                            if (
                                                ...
                                                n.options.maxBounds && (i = n._limitOffset(B(i), n.options.maxBounds)),
                        ...
                        (oe.addInitHook('addHandler', 'keyboard', oo),
                            oe.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 }));
                        var so = ge.extend({
                            addHooks: function () {
                                (Di(this._map._container, 'wheel', this._onWheelScroll, this), (this._delta = 0));
                            },
                            removeHooks: function () {
                        ...
                        var ro = 600;
                        oe.mergeOptions({ tapHold: Nt.touchNative && Nt.safari && Nt.mobile, tapTolerance: 15 });
                        var ao = ge.extend({
                            addHooks: function () {
                                            ...
                                            o(function () {
                                                (this._cancel(),
                                                    this._isTapValid() &&
                                                        ...
                                                        Di(document, 'touchend touchcancel', this._cancelClickPrevent),
                            ...
                            _cancel: function () {
                                (clearTimeout(this._holdTimeout),
                                    Hi(document, 'touchend touchcancel contextmenu', this._cancel, this),
                        ...
                        (oe.addInitHook('addHandler', 'tapHold', ao), oe.mergeOptions({ touchZoom: Nt.touch, bounceAtZoomLimits: !0 }));
                        var ho = ge.extend({
                            addHooks: function () {
                            ...
                            _onTouchMove: function (t) {
                                if (t.touches && 2 === t.touches.length && this._zooming) {
                                    ...
                                    var a = o(i._move, i, this._center, this._zoom, { pinch: !0, round: !1 }, void 0);
