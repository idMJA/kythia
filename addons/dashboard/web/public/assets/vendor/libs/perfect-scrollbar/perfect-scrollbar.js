/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js
 * @type: Module
                ...
                5529: function (t) {
                    t.exports = (function () {
                        ...
                        function T(t) {
                            (t.event.bind(t.scrollbarY, 'mousedown', function (t) {
                                ...
                                t.event.bind(t.scrollbarYRail, 'mousedown', function (e) {
                                    var r =
                                        e.pageY - window.pageYOffset - t.scrollbarYRail.getBoundingClientRect().top > t.scrollbarYTop
                                            ? 1
                                            : -1;
                        ...
                        function S(t, e) {
                            ...
                            (t[o].addEventListener('mousedown', y), t[o].addEventListener('touchstart', y));
                        }
                        function H(t) {
                            var e = t.element,
                                r = function () {
                        ...
                        function M(e) {
                            ...
                            function n(t) {
                                var e = t.deltaX,
                                    r = -1 * t.deltaY;
                                return (
                                    (void 0 !== e && void 0 !== r) || ((e = (-1 * t.wheelDeltaX) / 6), (r = t.wheelDeltaY / 6)),
                        ...
                        function x(e) {
                            if (X.supportsTouch || X.supportsIePointer) {
                                var r = e.element,
                                    i = { startOffset: {}, startTime: 0, speed: {}, easingLoop: null };
                                X.supportsTouch
                                        ...
                                        e.isInitialized
                                            ...
                                            : i.speed.x || i.speed.y
                                              ? Math.abs(i.speed.x) < 0.01 && Math.abs(i.speed.y) < 0.01
                                                  ? clearInterval(i.easingLoop)
                                                  : (l(30 * i.speed.x, 30 * i.speed.y), (i.speed.x *= 0.8), (i.speed.y *= 0.8))
                                              : clearInterval(i.easingLoop);
                                    }, 10)));
                            }
                        }
                        var A = function () {
                            ...
                            k = function (i, n) {
                                var l = this;
                                if ((void 0 === n && (n = {}), 'string' == typeof i && (i = document.querySelector(i)), !i || !i.nodeName))
