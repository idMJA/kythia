/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/jquery-timepicker/jquery-timepicker.js
 * @type: Module
                ...
                7775: function (e, t, i) {
                    ...
                    ((e = i.nmd(e)),
                        (function () {
                            ...
                            var d = 86400,
                                p = { bubbles: !0, cancelable: !1, detail: null };
                            function h(e, t) {
                            ...
                            var g,
                                ...
                                y = { am: 'am', pm: 'pm', AM: 'AM', PM: 'PM', decimal: '.', mins: 'mins', hr: 'hr', hrs: 'hrs' },
                                b = (function () {
                                    function e(t) {
                                    ...
                                    return (
                                        ...
                                        (n = [
                                            ...
                                            },
                                            {
                                                ...
                                                value: function () {
                                                    var e,
                                                        t = m(document.getElementsByClassName('ui-timepicker-input'));
                                                    try {
                                                        for (t.s(); !(e = t.n()).done; ) {
                                        ...
                                        (i = [
                                                ...
                                                value: function (e, t) {
                                                    ...
                                                    if (this.selectedValue != e) {
                                                        ...
                                                        var r = new CustomEvent('changeTime', p),
                                                            s = new CustomEvent('change', Object.assign(p, { detail: 'timepicker' }));
                                                        return (
                                                            'select' == t
                                                                ? (this.targetEl.dispatchEvent(n),
                                                                  this.targetEl.dispatchEvent(r),
                                                                  this.targetEl.dispatchEvent(s))
                                                                : -1 == ['error', 'initial'].indexOf(t) && this.targetEl.dispatchEvent(r),
                                                            !0
                                                        );
                                                    }
                                            ...
                                            },
                                            {
                                                ...
                                                value: function () {
                                                    ...
                                                    return (
                                                        null !== i &&
                                                            ('string' != typeof i && (i = e._int2time(i)), e._setTimeValue(i, 'select')),
                                                        !0
                                                    );
                                                },
                                            },
                                            ...
                                            },
                                            {
                                                ...
                                                value: function (e) {
                                                    ...
                                                    e.match(/\W/) &&
                                                        (t = /^(([^0-9]*))?([0-9]?[0-9])(\W+([0-5][0-9]?))?(\W+([0-5][0-9]))?(([^0-9]*))$/);
                                                    var i = e.match(t);
                                                    if (!i) return null;
                                                    ...
                                                    (r || 2 != i[3].length || '0' != i[3][0] || (r = 'am'),
                                                        n > 24 && !s && ((n = 1 * i[3][0]), (s = this.parseMinuteString(i[3][1]))));
                                                    var o = n;
                                                    if (n <= 12 && r) {
                                            ...
                                            },
                                            {
                                                ...
                                                value: function (e) {
                                                    if (
                                                        ...
                                                        (e.durationTime = this.intStringDateOrFunc2func(e.durationTime)),
                                                        e.scrollDefault
                                                            ? (e.scrollDefault = this.intStringDateOrFunc2func(e.scrollDefault))
                                                    ...
                                                    return (
                                                        (e.disableTimeRanges = this._parseDisableTimeRanges(e.disableTimeRanges)),
                                            ...
                                            },
                                            {
                                                ...
                                                value: function (e) {
                                                    ...
                                                    for (
                                                        ...
                                                        e[t][0] <= e[t - 1][1] &&
                                                            ((e[t - 1] = [Math.min(e[t][0], e[t - 1][0]), Math.max(e[t][1], e[t - 1][1])]),
                                                            e.splice(t, 1));
                                                    return e;
                                                },
                                            },
                                                    ...
                                                    return (
                                                        r < 60
                                                            ...
                                                            : ((i = Math.floor(r / 60)),
                                                              ...
                                                              s.push(i),
                                                              s.push(1 == i ? this.settings.lang.hr : this.settings.lang.hrs),
                                                              30 != t && n && (s.push(n), s.push(this.settings.lang.mins))),
                                                        s.join(' ')
                                                    );
                                                },
                                            },
                                            {
                                                ...
                                                value: function (e) {
                                                    if (null !== (e = this.settings.roundingFunction(e, this.settings)))
                                            ...
                                            },
                                            {
                                                ...
                                                value: function (e) {
                                                    ...
                                                    for (var s, a, o = '', l = 0; l < this.settings.timeFormat.length; l++)
                                                        switch ((a = this.settings.timeFormat.charAt(l))) {
                                                            ...
                                                            case 'G':
                                                                ((s = r.getHours()),
                                                                    e === d && (s = this.settings.show2400 ? 24 : 0),
                                                                    (o += s));
                                                                break;
                                                            case 'h':
                                            ...
                                            },
                                            {
                                                ...
                                                value: function (e, t) {
                                                    if (null !== t.minTime && null !== t.maxTime && (e < t.minTime() || e > t.maxTime()))
                                                        return !0;
                                                    var i,
                                                        n = m(t.disableTimeRanges);
                                                    try {
                                                        for (n.s(); !(i = n.n()).done; ) {
                                                            var r = i.value;
                                            ...
                                            },
                                            {
                                                ...
                                                value: function (e, t) {
                                                    ...
                                                    return (
                                                        'object' == a(e)
                                                            ? ((i = e.label), (n = e.className), (r = e.value))
                                                            : 'string' == typeof e
                                                              ? ((i = e), (r = ''))
                                                              : $.error('Invalid noneOption value'),
                                                        t
                                                            ? ((s = document.createElement('option')).value = r)
                                                            : ((s = document.createElement('li')).dataset.time = String(r)),
                                                        (s.innerText = i),
                                                        s.classList.add(n),
                                                        s
                                                    );
                            ...
                            function T(e) {
                                ...
                                return (
                                    ...
                                    e.duration
                                        ? t.appendChild(document.createTextNode(e.label + ' (' + e.duration + ')'))
                            ...
                            function _(e) {
                                var t,
                                    i = [].concat(
                                        ...
                                        (function (e) {
                                            ...
                                            (s < r && (s += d), 86399 === s && 'string' == typeof n.timeFormat && n.show2400 && (s = d));
                                            for (var a = [], o = r, l = 0; o <= s; l++, o += 60 * n.step(l)) {
                                                var u = o,
                                                    c = e._int2time(u),
                                                    f = u % d < 43200 ? 'ui-timepicker-am' : 'ui-timepicker-pm',
                                                    p = { label: c, value: h(u, n), className: f };
                                                if ((null !== n.minTime() || null !== n.durationTime()) && n.showDuration) {
                                                    var g,
                                                        v = null !== (g = n.durationTime()) && void 0 !== g ? g : n.minTime();
                                                    v > o && (v -= d);
                                                    var y = e._int2duration(o - v, n.step());
                                                    p.duration = y;
                                                }
                                                var b,
                                                    k = m(n.disableTimeRanges);
                                                try {
                                                    for (k.s(); !(b = k.n()).done; ) {
                                                        var T = b.value;
                                                        if (u % d >= T[0] && u % d < T[1]) {
                                ...
                                if (
                                    ...
                                    var n,
                                        r = m(e.settings.className.split(' '));
                                    try {
                                        for (r.s(); !(n = r.n()).done; ) {
                                            var s = n.value;
                                            t.classList.add(s);
                            ...
                            (!(function () {
                                ...
                                (g = function (e) {
                                        ...
                                        init: function (n) {
                                            return this.each(function () {
                                                var s = e(this),
                                                    a = new b(this, n),
                                                    o = a.settings;
                                                if ((o.lang, (this.timepickerObj = a), s.addClass('ui-timepicker-input'), o.useSelect))
                                                    i(s);
                                                else {
                                                    ...
                                                    (s.on('change.timepicker', a._handleFormatValue),
                                                        ...
                                                        o.disableTextInput && s.on('keydown.timepicker', a._disableTextInputHandler),
                                            ...
                                            if ((t && t.preventDefault(), a.useSelect)) s.list.trigger('focus');
                                                ...
                                                if (!r.prop('readonly') && (i(r), (o = s.list), !b.isVisible(o))) {
                                                    (r.is('input') && (s.selectedValue = r.val()),
                                                        s._setSelected(),
                                                        b.hideAll(),
                                                        'number' == typeof a.listWidth && o.width(r.outerWidth() * a.listWidth),
                                                        o.show());
                                                    var l = {};
                                                    (a.orientation.match(/r/)
                                                        ? (l.left =
                                                              ...
                                                              r.outerWidth() -
                                                              o.outerWidth() +
                                                              parseInt(o.css('marginLeft').replace('px', ''), 10))
                                                        : a.orientation.match(/l/)
                                                          ? (l.left = r.offset().left + parseInt(o.css('marginLeft').replace('px', ''), 10))
                                                        ...
                                                        (a.orientation.match(/t/)
                                                            ...
                                                            : a.orientation.match(/b/)
                                                              ? 'b'
                                                              : r.offset().top + r.outerHeight(!0) + o.outerHeight() >
                                                            ...
                                                            ? (o.addClass('ui-timepicker-positioned-top'),
                                                              (l.top =
                                                                  r.offset().top -
                                                                  o.outerHeight() +
                                                                  parseInt(o.css('marginTop').replace('px', ''), 10)))
                                                    ...
                                                    if (!u.length) {
                                                        ...
                                                        null !== c
                                                            ? (u = e(s._findRow(c)))
                                                            : a.scrollDefault() && (u = e(s._findRow(a.scrollDefault())));
                                                    }
                                                    if (
                                                    ...
                                                    return (
                                                        a.stopScrollPropagation &&
                                                            e(document).on('wheel.ui-timepicker', '.ui-timepicker-wrapper', function (t) {
                                                                t.preventDefault();
                                                        ...
                                                        a.closeOnScroll && e(a.closeOnScroll).on('scroll.ui-timepicker', n),
                                            ...
                                            return 'string' == typeof t && void 0 === n
                                                ...
                                                : this.each(function () {
                                                      var r = e(this),
                                                          ...
                                                          o = s.settings,
                                                          l = s.list;
                                                      ('object' == a(t) ? (o = e.extend(o, t)) : 'string' == typeof t && (o[t] = n),
                                                          (o = s.parseSettings(o)),
                                                          (s.settings = o),
                                    ...
                                    function i(i) {
                                        ...
                                        if (
                                            ...
                                            (i.val() && r.val(n._roundAndFormatTime(n.anytime2int(i.val()))),
                                                r.on('focus', function () {
                                            ...
                                            var o = s.appendTo;
                                            ('string' == typeof o ? (o = e(o)) : 'function' == typeof o && (o = o(i)),
                                                o.append(a),
                                                n._setSelected(),
                                                r.on('mousedown click', 'li', function (s) {
                                                    (i.off('focus.timepicker'),
                                                        ...
                                                        n._selectValue() &&
                                                            ...
                                                            r.on('mouseup.timepicker click.timepicker', 'li', function (e) {
                                    ...
                                    function n(t) {
                                        if ('focus' != t.type || t.target != window) {
                                            ...
                                            i.closest('.ui-timepicker-input').length ||
                                                ...
                                                (b.hideAll(), e(document).off('.ui-timepicker'), e(window).off('.ui-timepicker'));
                                        }
                                    }
                                    function r(i) {
                                        var n = e(this),
                                        ...
                                        switch (i.keyCode) {
                                            case 13:
                                                return (
                                                    r._selectValue() && (r._formatValue({ type: 'change' }), r.hideMe()),
                                                    i.preventDefault(),
                                                    !1
                                                );
                                            case 38:
                                                ...
                                                return (
                                                    0 === (a = s.find('.ui-timepicker-selected')).length
                                                        ...
                                                        : a.is(':last-child') ||
                                                          ...
                                                          a.next().position().top + 2 * a.outerHeight() > s.outerHeight() &&
                                                              s.scrollTop(s.scrollTop() + a.outerHeight())),
                                                    !1
                                                );
                                            case 27:
                                        ...
                                        return this.length
                                            ? t[i]
                                                ? this.hasClass('ui-timepicker-input')
                                                    ...
                                                    : this
                                                : 'object' !== a(i) && i
                                                  ? void e.error('Method ' + i + ' does not exist on jQuery.timepicker')
                                ...
                                'object' === a(t) && t && 'object' === a(e) && e && e.exports === t
                                    ? g(i(1145))
                                    : ((r = [i(1145)]),
                                      void 0 === (s = 'function' == typeof (n = g) ? n.apply(t, r) : n) || (e.exports = s)));
                        })());
                },
                1145: function (t) {
                    'use strict';
