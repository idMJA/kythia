/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/@form-validation/popular.js
 * @type: Module
                    ...
                    i.exports = (function () {
                                ...
                                return (
                                    ...
                                    (e.prototype.validateElement = function (e, t) {
                                        ...
                                        return this.waterfall(o)
                                            ...
                                            .catch(function (r) {
                                                return (
                                                    n.emit('core.element.notvalidated', { element: t, elements: i, field: e }),
                                                    Promise.resolve(r)
                                                );
                                            });
                                    }),
                                    (e.prototype.executeValidator = function (e, t, n, i) {
                                        ...
                                        if (
                                            ((i.message = this.filter.execute('validator-message', i.message, [this.locale, e, a])),
                                    ...
                                    (e.prototype.updateFieldStatus = function (e, t, n) {
                                        ...
                                        if (
                                            (('radio' === o || 'checkbox' === o ? [r[0]] : r).forEach(function (r) {
                                        ...
                                        switch (n) {
                                            ...
                                            case 'Valid':
                                                (s.forEach(function (n) {
                                                    ...
                                                    this.emit('core.element.validated', { element: t, elements: o, field: e, valid: !0 }));
                                                break;
                                            case 'Invalid':
                                                (s.forEach(function (n) {
                                                    return r.emit('core.validator.validated', {
                                    ...
                                    (e.prototype.resetField = function (e, t) {
                                        if (t) {
                                            ...
                                            n.forEach(function (e) {
                                                'radio' === i || 'checkbox' === i
                                                    ? (e.removeAttribute('selected'), e.removeAttribute('checked'), (e.checked = !1))
                                    ...
                                    (e.prototype.normalizeResult = function (e, t, n) {
                                        ...
                                        return Object.assign({}, n, {
                                            message:
                                                n.message ||
                                                (i ? i.message : '') ||
                                                (this.localization && this.localization[t] && this.localization[t].default
                        ...
                        return (
                            ...
                            (r.formValidation = function (e, n) {
                                var i = Object.assign({}, { fields: {}, locale: 'en_US', plugins: {}, init: function (e) {} }, n),
                                    r = new t(e, i.fields);
                                return (
                            ...
                            t = (function (t) {
                                function n(e) {
                                    ...
                                    return (
                                        ...
                                        (n.opts = Object.assign({}, { html5Input: !1, pluginPrefix: 'data-fvp-', prefix: 'data-fv-' }, e)),
                                ...
                                return (
                                    ...
                                    (n.prototype.parseOptions = function () {
                                        ...
                                        return (
                                            [].slice.call(r.querySelectorAll('[name], ['.concat(t, 'field]'))).forEach(function (i) {
                                    ...
                                    (n.prototype.parsePlugins = function () {
                                        for (
                                            var e,
                                                ...
                                                i = new RegExp('^'.concat(this.opts.pluginPrefix, '([a-z0-9-]+)(___)*([a-z0-9-]+)*$')),
                                ...
                                return (
                                    ...
                                    (i.prototype.onElementIgnored = function (e) {
                                        ...
                                        if (this.messages.has(i)) {
                                            var r = this.messages.get(i);
                                            [].slice
                                                .call(r.querySelectorAll('[data-field="'.concat(e.field.replace(/"/g, '\\"'), '"]')))
                                                .forEach(function (e) {
                                                    r.removeChild(e);
                                                });
                                        }
                                ...
                                return (
                                    ...
                                    (o.prototype.install = function () {
                                        ...
                                        (i(
                                            ...
                                            (((e = {})[this.opts.formClass] = !0), (e['fv-plugins-framework'] = !0), e)
                                        ),
                                            this.core
                                                .on('core.element.ignored', this.elementIgnoredHandler)
                                                .on('core.element.validating', this.elementValidatingHandler)
                                    ...
                                    (o.prototype.uninstall = function () {
                                        ...
                                        (this.results.clear(),
                                            ...
                                            i(
                                                this.core.getFormElement(),
                                                (((e = {})[this.opts.formClass] = !1), (e['fv-plugins-framework'] = !1), e)
                                            ),
                                            this.core
                                                .off('core.element.ignored', this.elementIgnoredHandler)
                                                .off('core.element.validating', this.elementValidatingHandler)
                                    ...
                                    (o.prototype.prepareElementContainer = function (e, t) {
                                        var n,
                                            ...
                                            a = r(t, o);
                                        a !== t &&
                                            (i(a, (((n = {})[this.opts.rowClasses] = !0), (n['fv-plugins-icon-container'] = !0), n)),
                        ...
                        var e = a,
                            ...
                            i = (function (e) {
                                function i(t) {
                                    ...
                                    return (
                                        (n.messages = new Map()),
                                        (n.opts = Object.assign({}, { placement: 'top', trigger: 'click' }, t)),
                                        (n.iconPlacedHandler = n.onIconPlaced.bind(n)),
                                        (n.validatorValidatedHandler = n.onValidatorValidated.bind(n)),
                                        (n.elementValidatedHandler = n.onElementValidated.bind(n)),
                                ...
                                return (
                                    ...
                                    (i.prototype.install = function () {
                                        ...
                                        ((this.tip = document.createElement('div')),
                                            n(
                                                this.tip,
                                                (((e = { 'fv-plugins-tooltip': !0 })['fv-plugins-tooltip--'.concat(this.opts.placement)] =
                                                    !0),
                                                e)
                                            ),
                            ...
                            t = (function (t) {
                                function n(e) {
                                    ...
                                    return (
                                        ...
                                        (n.opts = Object.assign({}, { delay: 0, event: n.defaultEvent, threshold: 0 }, e)),
                                        (n.fieldAddedHandler = n.onFieldAdded.bind(n)),
                                        (n.fieldRemovedHandler = n.onFieldRemoved.bind(n)),
                                        n
                                    );
                                ...
                                return (
                                    ...
                                    (n.prototype.prepareHandler = function (e, t) {
                                        ...
                                        t.forEach(function (t) {
                                            ...
                                            if (n.opts.event && !1 === n.opts.event[e]) i = [];
                                                ...
                                                i = [
                                                    'radio' === r || 'checkbox' === r || 'file' === r || 'select' === o
                                                        ? 'change'
                                            ...
                                            i.forEach(function (i) {
                                                ...
                                                (n.handlers.push({ element: t, event: i, field: e, handler: r }), t.addEventListener(i, r));
                                            });
                                        });
                                    }),
                                    ...
                                    (n.prototype.exceedThreshold = function (e, t) {
                                        ...
                                        return (
                                            -1 !==
                                                ['button', 'checkbox', 'file', 'hidden', 'image', 'radio', 'reset', 'submit'].indexOf(i) ||
                            ...
                            (ce.between = function () {
                                ...
                                return {
                                    validate: function (i) {
                                        var r = i.value;
                                        if ('' === r) return { valid: !0 };
                                        var o = Object.assign({}, { inclusive: !0, message: '' }, n(i.options)),
                                            a = e(o.min),
                                            s = e(o.max);
                                        return o.inclusive
                                            ? {
                                                  message: t(i.l10n ? o.message || i.l10n.between.default : o.message, [
                                                      ''.concat(a),
                                                      ''.concat(s),
                                                  ]),
                                            ...
                                            : {
                                                  message: t(i.l10n ? o.message || i.l10n.between.notInclusive : o.message, [
                                                      ''.concat(a),
                                                      ''.concat(s),
                                                  ]),
                                                  valid: parseFloat(r) > a && parseFloat(r) < s,
                            ...
                            (He.date = function () {
                                return {
                                    validate: function (e) {
                                        ...
                                        var v =
                                            a.separator ||
                                            (-1 !== p.indexOf('/') ? '/' : -1 !== p.indexOf('-') ? '-' : -1 !== p.indexOf('.') ? '.' : '/');
                                        ...
                                        if (window.File && window.FileList && window.FileReader) {
                                            ...
                                            for (var d = {}, c = 0; c < s; c++) {
                                                if (
                                                    ...
                                                    return { meta: Object.assign({}, { error: 'INVALID_MIN_SIZE' }, d), valid: !1 };
                                                if (t.options.maxSize && a[c].size > parseInt(''.concat(t.options.maxSize), 10))
                                                    return { meta: Object.assign({}, { error: 'INVALID_MAX_SIZE' }, d), valid: !1 };
                                                if (r.length > 0 && -1 === r.indexOf(n.toLowerCase()))
                                                    return { meta: Object.assign({}, { error: 'INVALID_EXTENSION' }, d), valid: !1 };
                                                if (o.length > 0 && a[c].type && -1 === o.indexOf(a[c].type.toLowerCase()))
                                                    return { meta: Object.assign({}, { error: 'INVALID_TYPE' }, d), valid: !1 };
                                                if (t.options.validateFileName && !t.options.validateFileName(e(a[c].name)))
                                                    return { meta: Object.assign({}, { error: 'INVALID_NAME' }, d), valid: !1 };
                                            }
                                            if (t.options.maxTotalSize && l > parseInt(''.concat(t.options.maxTotalSize), 10))
                                                return {
                                                    meta: Object.assign({}, { error: 'INVALID_MAX_TOTAL_SIZE', totalSize: l }, d),
                                                    valid: !1,
                                                };
                                            if (t.options.minTotalSize && l < parseInt(''.concat(t.options.minTotalSize), 10))
                                                return {
                                                    meta: Object.assign({}, { error: 'INVALID_MIN_TOTAL_SIZE', totalSize: l }, d),
                                                    valid: !1,
                                                };
                                        } else {
                                            if (
                                                ...
                                                return { meta: { error: 'INVALID_EXTENSION', ext: n }, valid: !1 };
                                ...
                                return {
                                    validate: function (e) {
                                        ...
                                        return i.inclusive
                                            ...
                                            : {
                                                  message: t(
                                                      e.l10n ? i.message || e.l10n.greaterThan.notInclusive : i.message,
                                                      ''.concat(r)
                                                  ),
                                                  valid: parseFloat(e.value) > r,
                                              };
                        ...
                        return (
                            (rt.integer = function () {
                                return {
                                    validate: function (t) {
                                        if ('' === t.value) return { valid: !0 };
                                        var n = Object.assign({}, { decimalSeparator: '.', thousandsSeparator: '' }, e(t.options)),
                            ...
                            (Pt.remote = function () {
                                ...
                                return {
                                    validate: function (i) {
                                        ...
                                        return t(a, { crossDomain: r.crossDomain, headers: r.headers, method: r.method, params: o })
                                            .then(function (e) {
