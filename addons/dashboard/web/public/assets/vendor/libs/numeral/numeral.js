/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/numeral/numeral.js
 * @type: Module
...
!(function (e, r) {
    ...
    return (function () {
                ...
                2077: function (e, r, n) {
                    ...
                    ((i = function () {
                        var e,
                            ...
                            o = {},
                            a = {},
                            s = { currentLocale: 'en', zeroFormat: null, nullFormat: null, defaultFormat: '0,0', scalePercentBy100: !0 },
                            u = {
                        ...
                        return (
                            ((e = function (n) {
                                ...
                                if (e.isNumeral(n)) i = n.value();
                                    ...
                                    if (u.zeroFormat && n === u.zeroFormat) i = 0;
                                    else if ((u.nullFormat && n === u.nullFormat) || !n.replace(/[^0-9]+/g, '').length) i = null;
                                    else {
                                        for (t in o)
                                            if (
                                                (a =
                                                    'function' == typeof o[t].regexps.unformat
                                                        ? o[t].regexps.unformat()
                                                        : o[t].regexps.unformat) &&
                                                n.match(a)
                                            ) {
                                                l = o[t].unformat;
                            ...
                            (e._ = r =
                                {
                                    numberToFormat: function (r, n, i) {
                                        ...
                                        if (
                                            ...
                                            e._.includes(n, '(')
                                                ...
                                                : (e._.includes(n, '+') || e._.includes(n, '-')) &&
                                                  ((u = e._.includes(n, '+') ? n.indexOf('+') : r < 0 ? n.indexOf('-') : -1),
                                                  (n = n.replace(/[\+|\-]/g, ''))),
                                            e._.includes(n, 'a') &&
                                                ((t = !!(t = n.match(/a(k|m|b|t)?/)) && t[1]),
                                                e._.includes(n, ' a') && (y = ' '),
                                                (n = n.replace(new RegExp(y + 'a[kmbt]?'), '')),
                                                (l >= p && !t) || 't' === t
                                                    ? ((y += d.abbreviations.trillion), (r /= p))
                                                    : (l < p && l >= v && !t) || 'b' === t
                                                      ? ((y += d.abbreviations.billion), (r /= v))
                                                      : (l < v && l >= g && !t) || 'm' === t
                                                        ? ((y += d.abbreviations.million), (r /= g))
                                                        : ((l < g && l >= _ && !t) || 'k' === t) &&
                                                          ((y += d.abbreviations.thousand), (r /= _))),
                                            e._.includes(n, '[.]') && ((f = !0), (n = n.replace('[.]', '.'))),
                                            (o = r.toString().split('.')[0]),
                                            (s = n.split('.')[1]),
                                            (c = n.indexOf(',')),
                                            (h = (n.split('.')[0].split(',')[0].match(/0/g) || []).length),
                                            s
                                                ? (e._.includes(s, '[')
                                                      ? ((s = (s = s.replace(']', '')).split('[')),
                                                        (x = e._.toFixed(r, s[0].length + s[1].length, i, s[1].length)))
                                                      : (x = e._.toFixed(r, s.length, i)),
                                                  (o = x.split('.')[0]),
                                                  (x = e._.includes(x, '.') ? d.delimiters.decimal + x.split('.')[1] : ''),
                                                  f && 0 === Number(x.slice(1)) && (x = ''))
                                                : (o = e._.toFixed(r, 0, i)),
                                            y && !t && Number(o) >= 1e3 && y !== d.abbreviations.trillion)
                                        )
                                            switch (((o = String(Number(o) / 1e3)), y)) {
                                        ...
                                        if ((e._.includes(o, '-') && ((o = o.slice(1)), (F = !0)), o.length < h))
                                            for (var k = h - o.length; k > 0; k--) o = '0' + o;
                                        return (
                                            c > -1 && (o = o.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1' + d.delimiters.thousands)),
                                            0 === n.indexOf('.') && (o = ''),
                                            (m = o + x + (y || '')),
                                            b
                                                ? (m = (b && F ? '(' : '') + m + (b && F ? ')' : ''))
                                    ...
                                    stringToNumber: function (e) {
                                        ...
                                        if (u.zeroFormat && e === u.zeroFormat) n = 0;
                                            ...
                                            for (r in ((n = 1),
                                            '.' !== t.delimiters.decimal && (e = e.replace(/\./g, '').replace(t.delimiters.decimal, '.')),
                                            o))
                                                if (
                                                    ((i = new RegExp(
                                                        '[^a-zA-Z]' +
                                            ...
                                            ((n *=
                                                (e.split('-').length + Math.min(e.split('(').length - 1, e.split(')').length - 1)) % 2
                                                    ? 1
                                                    : -1),
                                                (e = e.replace(/[^0-9\.]+/g, '')),
                                                (n *= Number(e)));
                                    ...
                                    toFixed: function (e, r, n, i) {
                                        var t,
                                            ...
                                            u = r - (i || 0);
                                        return (
                                            (t = 2 === s.length ? Math.min(Math.max(s[1].length, u), r) : u),
                                            (o = Math.pow(10, t)),
                                            (a = (n(e + 'e+' + t) / o).toFixed(t)),
                                            i > r - t && ((l = new RegExp('\\.?0{1,' + (i - (r - t)) + '}$')), (a = a.replace(l, ''))),
                                            a
                                        );
                                    },
                                }),
                            ...
                            (e.validate = function (r, n) {
                                var i, t, l, o, a, s, u, c;
                                if (('string' != typeof r && ((r += ''), console.warn), (r = r.trim()).match(/^\d+$/))) return !0;
                                if ('' === r) return !1;
                                try {
                                    u = e.localeData(n);
                                } catch (r) {
                                ...
                                return (
                                    ...
                                    (t = '.' === u.delimiters.thousands ? '\\.' : u.delimiters.thousands),
                                    !(
                                        (null !== (c = r.match(/^[^\d]+/)) && ((r = r.substr(1)), c[0] !== l)) ||
                                        (null !== (c = r.match(/[^\d]+$/)) &&
                                            ((r = r.slice(0, -1)),
                                            c[0] !== a.thousand && c[0] !== a.million && c[0] !== a.billion && c[0] !== a.trillion)) ||
                                        ((s = new RegExp(t + '{2}')),
                                        r.match(/[^\d.,]/g) ||
                                            (o = r.split(i)).length > 2 ||
                                            (o.length < 2
                                                ? !o[0].match(/^\d+.*\d$/) || o[0].match(s)
                                                : 1 === o[0].length
                                                  ? !o[0].match(/^\d+$/) || o[0].match(s) || !o[1].match(/^\d+$/)
                                                  : !o[0].match(/^\d+.*\d$/) || o[0].match(s) || !o[1].match(/^\d+$/)))
                                    )
                                );
                            }),
                            (e.fn = c.prototype =
                                {
                                    ...
                                    format: function (r, n) {
                                        var i,
                                            ...
                                            a = this._value,
                                            s = r || u.defaultFormat;
                                        if (((n = n || Math.round), 0 === a && null !== u.zeroFormat)) t = u.zeroFormat;
                                        else if (null === a && null !== u.nullFormat) t = u.nullFormat;
                                        else {
                                            for (i in o)
                                                if (s.match(o[i].regexps.format)) {
                                                    l = o[i].format;
                                                    break;
                                                }
                                            t = (l = l || e._.numberToFormat)(a, s, n);
                                        }
                                        return t;
                                    },
                                    value: function () {
                                    ...
                                    add: function (e) {
                                        ...
                                        return ((this._value = r.reduce([this._value, e], i, 0) / n), this);
                                    },
                                    subtract: function (e) {
                                        var n = r.correctionFactor.call(null, this._value, e);
                                        function i(e, r, i, t) {
                                        ...
                                        return ((this._value = r.reduce([e], i, Math.round(this._value * n)) / n), this);
                                    },
                                    multiply: function (e) {
                                        function n(e, n, i, t) {
                                        ...
                                        return ((this._value = r.reduce([this._value, e], n, 1)), this);
                                    },
                                    divide: function (e) {
                                        function n(e, n, i, t) {
                                            var l = r.correctionFactor(e, n);
                                        ...
                                        return ((this._value = r.reduce([this._value, e], n)), this);
                                    },
                            ...
                            e.register('format', 'bps', {
                                ...
                                format: function (r, n, i) {
                                    var t,
                                        l = e._.includes(n, ' BPS') ? ' ' : '';
                                    return (
                                        (r *= 1e4),
                                        (n = n.replace(/\s?BPS/, '')),
                                        (t = e._.numberToFormat(r, n, i)),
                                        e._.includes(t, ')')
                                            ? ((t = t.split('')).splice(-1, 0, l + 'BPS'), (t = t.join('')))
                                            : (t = t + l + 'BPS'),
                                        t
                                    );
                                },
                            ...
                            (t =
                                '(' +
                                (t = (n = { base: 1e3, suffixes: ['B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'] }).suffixes
                                    .concat(
                            ...
                            e.register('format', 'currency', {
                                ...
                                format: function (r, n, i) {
                                    var t,
                                        ...
                                        a = { before: n.match(/^([\+|\-|\(|\s|\$]*)/)[0], after: n.match(/([\+|\-|\)|\s|\$]*)$/)[0] };
                                    for (
                                        n = n.replace(/\s?\$\s?/, ''),
                                            t = e._.numberToFormat(r, n, i),
                                            r >= 0
                                                ? ((a.before = a.before.replace(/[\-\(]/, '')), (a.after = a.after.replace(/[\-\)]/, '')))
                                                : r < 0 &&
                                        ...
                                        switch (a.after[l]) {
                                            case '$':
                                                t =
                                                    l === a.after.length - 1
                                                        ? t + o.currency.symbol
                                                        : e._.insert(t, o.currency.symbol, -(a.after.length - (1 + l)));
                                                break;
                                            case ' ':
                                                t =
                                                    l === a.after.length - 1
                                                        ? t + ' '
                                                        : e._.insert(t, ' ', -(a.after.length - (1 + l) + o.currency.symbol.length - 1));
                                        }
                                    return t;
                                },
                            }),
                            e.register('format', 'exponential', {
                                ...
                                unformat: function (r) {
                                    ...
                                    return ((t = e._.includes(r, 'e-') ? (t *= -1) : t), e._.reduce([i, Math.pow(10, t)], l, 1));
                                },
                            }),
                            ...
                            e.register('format', 'percentage', {
                                ...
                                format: function (r, n, i) {
                                    ...
                                    return (
                                        ...
                                        (t = e._.numberToFormat(r, n, i)),
                                        e._.includes(t, ')')
                                            ? ((t = t.split('')).splice(-1, 0, l + '%'), (t = t.join('')))
                                            : (t = t + l + '%'),
                                        t
                                    );
                                },
                            ...
                            e.register('format', 'time', {
                                ...
                                unformat: function (e) {
                                    ...
                                    return (
                                        3 === r.length
                                            ? ((n += 60 * Number(r[0]) * 60), (n += 60 * Number(r[1])), (n += Number(r[2])))
                                            : 2 === r.length && ((n += 60 * Number(r[0])), (n += Number(r[1]))),
                                        Number(n)
                                    );
                                },
                            }),
                        ...
                        void 0 === (t = 'function' == typeof i ? i.call(r, n, r, e) : i) || (e.exports = t));
                },
            },
            r = {};
        function n(i) {
        ...
        ((n.n = function (e) {
            ...
            (n.d = function (e, r) {
                for (var i in r) n.o(r, i) && !n.o(e, i) && Object.defineProperty(e, i, { enumerable: !0, get: r[i] });
            }),
            (n.o = function (e, r) {
