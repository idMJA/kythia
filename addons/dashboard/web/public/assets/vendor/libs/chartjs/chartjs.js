/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/chartjs/chartjs.js
 * @type: Module
...
!(function (t, e) {
    ...
    return (function () {
        ...
        const g = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
        function p(t, e, i) {
            ...
            S ||
                ((S = (function () {
                    ...
                    for (s = 0; s < e.length; s++) {
                        for (a = r = e[s], n = 0; n < i.length; n++) ((o = i[n]), (r = r.replace(o, w[o])));
                        ((o = parseInt(k[a], 16)), (t[r] = [(o >> 16) & 255, (o >> 8) & 255, 255 & o]));
                    }
                    return t;
                })()),
        ...
        const D = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
        const O = (t) => (t <= 0.0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055),
        ...
        function L(t) {
            ...
            return (
                Array.isArray(t)
                    ? t.length >= 3 && ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = o(t[3])))
        ...
        class R {
            ...
            rgbString() {
                return this._valid
                    ? (t = this._rgb) && (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${a(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`)
                    : void 0;
                var t;
            }
            hexString() {
            ...
            rotate(t) {
                return (
                    (function (t, e) {
                        var i = x(t);
                        ((i[0] = v(i[0] + e)), (i = y(i)), (t.r = i[0]), (t.g = i[1]), (t.b = i[2]));
                    })(this._rgb, t),
                    this
                );
            }
        ...
        function Y(t, e, i, s) {
            ...
            else if (B(t)) for (a = Object.keys(t), o = a.length, n = 0; n < o; n++) e.call(i, t[a[n]], a[n]);
        }
        function U(t, e) {
            let i, s, n, o;
        ...
        function J(t, e, i) {
            ...
            const s = e[t],
                n = i[t];
            B(s) && B(n) ? Z(s, n) : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = X(n));
        }
        ...
        function Bt(t, e, i) {
            ...
            if (t._sorted) {
                ...
                (d && (n = Dt(Math.min(At(r, h, l).lo, i ? s : At(e, h, a.getPixelForValue(l)).lo), 0, s - 1)),
                    (o = u
                        ? Dt(Math.max(At(r, a.axis, c, !0).hi + 1, i ? 0 : At(e, h, a.getPixelForValue(c), !0).hi + 1), n, s) - n
                        : s - n));
            }
        ...
        const Nt = (t) => 0 === t || 1 === t,
            ...
            $t = {
                ...
                easeInOutExpo: (t) =>
                    Nt(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
                ...
                easeInOutElastic(t) {
                    const e = 0.1125;
                    return Nt(t) ? t : t < 0.5 ? 0.5 * Ht(2 * t, e, 0.45) : 0.5 + 0.5 * jt(2 * t - 1, e, 0.45);
                },
                easeInBack(t) {
                    const e = 1.70158;
                    return t * t * ((e + 1) * t - e);
                ...
                easeInOutBounce: (t) => (t < 0.5 ? 0.5 * $t.easeInBounce(2 * t) : 0.5 * $t.easeOutBounce(2 * t - 1) + 0.5),
            };
        function Yt(t) {
        ...
        const Jt = {
            ...
            logarithmic(t, e, i) {
                ...
                return [1, 2, 3, 5, 10, 15].includes(s) || e > 0.8 * i.length ? Jt.numeric.call(this, t, e, i) : '';
            },
        };
            ...
            [
                function (t) {
                    (t.set('animation', {
                        ...
                        t.set('animations', { colors: { type: 'color', properties: Kt }, numbers: { type: 'number', properties: qt } }),
        ...
        function re(t, e, i, s) {
            ...
            for (h = 0; h < r; h++)
                if (((d = i[h]), null == d || V(d))) {
                    if (V(d)) for (l = 0, c = d.length; l < c; l++) ((u = d[l]), null == u || V(u) || (a = ae(t, n, o, a, u)));
                } else a = ae(t, n, o, a, d);
            t.restore();
            const f = o.length / 2;
            if (f > i.length) {
        ...
        function ye(t, e) {
            ...
            (t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * ot, ot, !0),
                ...
                t.arc(i + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, ct, 0, !0),
                t.lineTo(i + n, s + a.topRight),
                t.arc(i + n - a.topRight, s + a.topRight, a.topRight, 0, -ct, !0),
                t.lineTo(i + a.topLeft, s));
        }
        const ve = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
            Me = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
        function we(t, e) {
            const i = ('' + t).match(ve);
            ...
            return new Proxy(a, {
                ...
                get(i, s) {
                    return ze(i, s, () =>
                        (function (t, e, i, s) {
                            let n;
                            for (const o of e) if (((n = He(Re(o, t), i)), void 0 !== n)) return Ie(t, n) ? We(i, s, t, n) : n;
                        })(s, e, t, i)
                    );
                },
        ...
        function Ee(t, e = { scriptable: !0, indexable: !0 }) {
            ...
            return { allKeys: n, scriptable: i, indexable: s, isScriptable: st(i) ? i : () => i, isIndexable: st(s) ? s : () => s };
        }
        const Re = (t, e) => (t ? t + et(e) : e),
            Ie = (t, e) => B(e) && 'adapters' !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
        function ze(t, e, i) {
        ...
        const Ve = (t, e) => (!0 === t ? e : 'string' == typeof t ? tt(e, t) : void 0);
        function Be(t, e, i, s, n) {
            for (const o of e) {
                const e = Ve(i, o);
                if (e) {
        ...
        function $e(t, e, i, s) {
            const { iScale: n } = t,
                ...
                a = new Array(s);
            let r, h, l, c;
            for (r = 0, h = s; r < h; ++r) ((l = r + i), (c = e[l]), (a[r] = { r: n.parse(tt(c, o), l) }));
            return a;
        }
        ...
        function Ke(t, e = 'x') {
            ...
            for (a = 0; a < s; ++a)
                if (((r = h), (h = l), (l = Ue(t, a + 1)), h)) {
                    ...
                    o[a] = r ? (l ? (gt(n[a - 1]) !== gt(n[a]) ? 0 : (n[a - 1] + n[a]) / 2) : n[a - 1]) : n[a];
                }
            (!(function (t, e, i) {
                const s = t.length;
                let n,
                ...
                (function (t, e, i = 'x') {
                    ...
                    for (let l = 0; l < n; ++l) {
                        ...
                        const n = r[i],
                            c = r[s];
                        (a && ((o = (n - a[i]) / 3), (r[`cp1${i}`] = n - o), (r[`cp1${s}`] = c - o * e[l])),
                            h && ((o = (h[i] - n) / 3), (r[`cp2${i}`] = n + o), (r[`cp2${s}`] = c + o * e[l])));
                    }
                })(t, o, e));
        }
        function Ge(t, e, i) {
                ...
                (function (t, e) {
                    ...
                    for (i = 0, s = t.length; i < s; ++i)
                        ((a = o),
                            ...
                            o &&
                                ((n = t[i]),
                                a && ((n.cp1x = Ge(n.cp1x, e.left, e.right)), (n.cp1y = Ge(n.cp1y, e.top, e.bottom))),
                                r && ((n.cp2x = Ge(n.cp2x, e.left, e.right)), (n.cp2y = Ge(n.cp2y, e.top, e.bottom)))));
                })(t, i);
        }
        function Je() {
        ...
        function ti(t, e, i) {
            let s;
            return (
                'string' == typeof t ? ((s = parseInt(t, 10)), -1 !== t.indexOf('%') && (s = (s / 100) * e.parentNode[i])) : (s = t),
                s
            );
        }
        ...
        function ni(t, e) {
            ...
            return (
                ...
                { x: Math.round((((h - d) / f) * i.width) / s), y: Math.round((((l - u) / g) * i.height) / s) }
            );
        }
        ...
        function ai(t, e, i, s) {
            ...
            ((l = Math.max(0, l - o.width)),
                ...
                l && !c && (c = oi(l / 2)));
            return (
                (void 0 !== e || void 0 !== i) && s && h.height && c > h.height && ((c = h.height), (l = oi(Math.floor(c * s)))),
                { width: l, height: c }
            );
        }
        function ri(t, e, i) {
        ...
        const hi = (function () {
            ...
            try {
                ...
                Je() && (window.addEventListener('test', null, e), window.removeEventListener('test', null, e));
            } catch (t) {}
            return t;
        })();
        function li(t, e) {
                ...
                ((m = e[t % a]),
                    m.skip ||
                        ...
                        p !== b &&
                            ...
                            null !== _ && v() && (g.push(bi({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
                            (i = t),
                            (b = p))));
        ...
        class Oi {
            ...
            _createAnimations(t, e) {
                ...
                for (r = o.length - 1; r >= 0; --r) {
                    ...
                    d && d.duration ? ((n[h] = c = new Di(d, t, h, l)), s.push(c)) : (t[h] = l);
                }
                return s;
            }
            update(t, e) {
        ...
        function Ti(t, e, i, s = {}) {
            ...
            for (a = 0, r = n.length; a < r; ++a) {
                ...
                ((l = t.values[h]), W(l) && (o || 0 === e || gt(e) === gt(l)) && (e += l));
            }
            return c || s.all ? e : 0;
        }
        function Li(t, e) {
        ...
        class Wi {
                ...
                if (B(e)) {
                    ...
                    (e &&
                        ...
                        (s = e)._chartjs
                            ...
                            : (Object.defineProperty(s, '_chartjs', { configurable: !0, enumerable: !1, value: { listeners: [n] } }),
                              Lt.forEach((t) => {
            ...
            buildOrUpdateElements(t) {
                ...
                ((e._stacked = Li(e.vScale, e)),
                    ...
                    (s || n !== e._stacked) && (Ii(this, e._parsed), (e._stacked = Li(e.vScale, e))));
            }
            configure() {
            ...
            parseObjectData(t, e, i, s) {
                const { xScale: n, yScale: o } = t,
                    ...
                    h = new Array(s);
                let l, c, d, u;
                for (l = 0, c = s; l < c; ++l) ((d = l + i), (u = e[d]), (h[l] = { x: n.parse(tt(u, a), d), y: o.parse(tt(u, r), d) }));
                return h;
            }
            getParsed(t) {
            ...
            applyStack(t, e, i) {
                const s = this.chart,
                    n = this._cachedMeta,
                    o = e[t.axis];
                return Ti({ keys: Ai(s, !0), values: e._stacks[t.axis]._visualValues }, o, n.index, { mode: i });
            }
            ...
            getMinMax(t, e) {
                const i = this._cachedMeta,
                    ...
                    r = ((t, e, i) => t && !e.hidden && e._stacked && { keys: Ai(i, !0), values: null })(e, i, this.chart),
                ...
                for (d = 0; d < o && (f() || (this.updateRangeFromParsed(h, t, u, r), !n)); ++d);
                if (n)
                    for (d = o - 1; d >= 0; --d)
                        if (!f()) {
            ...
            _update(t) {
                ...
                (this.update(t || 'default'),
                    (e._clip = (function (t) {
                        let e, i, s, n;
                        return (
                            B(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (n = t.left)) : (e = i = s = n = t),
                ...
                if (t >= 0 && t < this._cachedMeta.data.length) {
                    ...
                    ((n =
                        ...
                        (this.$context = (function (t, e) {
                            return Ae(t, { active: !1, dataset: void 0, datasetIndex: e, index: e, mode: 'default', type: 'dataset' });
            ...
            _resolveElementOptions(t, e = 'default', i) {
                ...
                return (f.$shared && ((f.$shared = r), (n[o] = Object.freeze(Bi(f, r)))), f);
            }
        ...
        function Ni(t) {
            ...
            let s,
                ...
                r = e._length;
            const h = () => {
                32767 !== o && -32768 !== o && (it(a) && (r = Math.min(r, Math.abs(o - a) || r)), (a = o));
            };
        ...
        function ji(t, e, i, s) {
            const n = t.iScale,
                ...
                h = [];
            let l, c, d, u;
            for (l = i, c = i + s; l < c; ++l) ((u = e[l]), (d = {}), (d[n.axis] = r || n.parse(a[l], l)), h.push(Hi(u, d, o, l)));
            return h;
        }
        function $i(t) {
        ...
        function Yi(t, e, i, s) {
            ...
            ('middle' === n &&
                ...
                (i._top || 0) === s ? (n = l) : (i._bottom || 0) === s ? (n = c) : ((o[Ui(c, a, r, h)] = !0), (n = l))),
                (o[Ui(n, a, r, h)] = !0),
                (t.borderSkipped = o));
        }
        function Ui(t, e, i, s) {
            var n, o, a;
            return (s ? ((a = i), (t = Xi((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e))) : (t = Xi(t, e, i)), t);
        }
        function Xi(t, e, i) {
        ...
        class Ki extends Wi {
            ...
            update(t) {
                const e = this.chart,
                    ...
                    r = Math.min(
                        ((h = this.options.cutout), (l = a), 'string' == typeof h && h.endsWith('%') ? parseFloat(h) / 100 : +h / l),
                        1
                    );
                var h, l;
                    ...
                    { circumference: d, rotation: u } = this._getRotationExtents(),
                    {
                        ...
                        if (e < at) {
                            const r = t,
                                ...
                                d = Math.cos(h),
                                u = Math.sin(h),
                                f = (t, e, s) => (Pt(t, r, h, !0) ? 1 : Math.max(e, e * i, s, s * i)),
                                g = (t, e, s) => (Pt(t, r, h, !0) ? -1 : Math.min(e, e * i, s, s * i)),
                                p = f(0, l, d),
                                m = f(ct, c, u),
                                b = g(ot, l, d),
                                x = g(ot + ct, c, u);
        ...
        class Gi extends Wi {
            ...
            _computeAngle(t, e, i) {
                return this.chart.getDataVisibility(t) ? _t(this.resolveDataElementOptions(t, e).angle || i) : 0;
            }
        }
        var Zi = Object.freeze({
            ...
            BarController: class extends Wi {
                ...
                parseObjectData(t, e, i, s) {
                    ...
                    let d, u, f, g;
                    for (d = i, u = i + s; d < u; ++d)
                        ((g = e[d]), (f = {}), (f[n.axis] = n.parse(tt(g, h), d)), c.push(Hi(tt(g, l), f, o, d)));
                    return c;
                }
                updateRangeFromParsed(t, e, i, s) {
                ...
                getLabelAndValue(t) {
                    const e = this._cachedMeta,
                        ...
                        n = this.getParsed(t),
                        o = n._custom,
                        a = $i(o) ? '[' + o.start + ', ' + o.end + ']' : '' + s.getLabelForValue(n[s.axis]);
                ...
                updateElements(t, e, i, s) {
                    ...
                    for (let u = e; u < e + i; u++) {
                        const e = this.getParsed(u),
                            i = n || F(e[a.axis]) ? { base: r, head: r } : this._calculateBarValuePixels(u),
                            f = this._calculateBarIndexPixels(u, l),
                            g = (e._stacks || {})[a.axis],
                            p = {
                                horizontal: h,
                                base: i.base,
                                enableBorderRadius: !g || $i(e._custom) || o === g._top || o === g._bottom,
                                x: h ? i.head : f.center,
                                y: h ? f.center : i.head,
                        ...
                        (Yi(p, m, g, o), qi(p, m, l.ratio), this.updateElement(t[u], u, p, s));
                    }
                }
                _getStacks(t, e) {
                ...
                _calculateBarValuePixels(t) {
                    ...
                    (g !== u && ((f = g - u), (g = u)),
                        l && ((u = h.barStart), (g = h.barEnd - h.barStart), 0 !== u && gt(u) !== gt(h.barEnd) && (f = 0), (f += u)));
                    const p = F(n) || l ? f : n;
                    let m = e.getPixelForValue(p);
                    if (((c = this.chart.getDataVisibility(t) ? e.getPixelForValue(f + g) : m), (d = c - m), Math.abs(d) < o)) {
                        ((d =
                            (function (t, e, i) {
                                return 0 !== t ? gt(t) : (e.isHorizontal() ? 1 : -1) * (e.min >= i ? 1 : -1);
                            })(d, e, a) * o),
                            u === a && (m -= d / 2));
                        ...
                        ((m = Math.max(Math.min(m, f), h)),
                            (c = m + d),
                            i && !l && (r._stacks[e.axis]._visualValues[s] = e.getValueForPixel(c) - e.getValueForPixel(m)));
                    }
                            ...
                            h =
                                'flex' === s.barThickness
                                    ...
                                    : (function (t, e, i, s) {
                                          ...
                                          let o, a;
                                          return (
                                              F(n) ? ((o = e.min * i.categoryPercentage), (a = i.barPercentage)) : ((o = n * s), (a = 1)),
                                              { chunk: o / s, ratio: a, start: e.pixels[t] - o / 2 }
                                          );
                                      })(t, e, s, i),
                            l = this._getStackIndex(this.index, this._cachedMeta.stack, n ? t : void 0);
                        ((a = h.start + h.chunk * l + h.chunk / 2), (r = Math.min(o, h.chunk * h.ratio)));
                ...
                updateElements(t, e, i, s) {
                    ...
                    for (let d = e; d < e + i; d++) {
                        const e = t[d],
                            ...
                            u = {},
                            f = (u[l] = n ? o.getPixelForDecimal(0.5) : o.getPixelForValue(i[l])),
            ...
            LineController: class extends Wi {
                ...
                updateElements(t, e, i, s) {
                    const n = 'reset' === s,
                        { iScale: o, vScale: a, _stacked: r, _dataset: h } = this._cachedMeta,
                    ...
                    for (let i = 0; i < x; ++i) {
                        ...
                        ((x.skip = isNaN(M) || isNaN(w) || v),
                            ...
                            c && (x.options = l || this.resolveDataElementOptions(i, f.active ? 'active' : s)),
            ...
            ScatterController: class extends Wi {
                ...
                update(t) {
                    ...
                    if (((this._drawStart = n), (this._drawCount = o), Wt(e) && ((n = 0), (o = i.length)), this.options.showLine)) {
                ...
                updateElements(t, e, i, s) {
                    ...
                    for (let l = e; l < e + i; ++l) {
                        const e = t[l],
                            ...
                            v = (g[f] = n || _ ? a.getBasePixel() : a.getPixelForValue(r ? this.applyStack(a, i, r) : i[f], l));
                        ((g.skip = isNaN(y) || isNaN(v) || _),
                            (g.stop = l > 0 && Math.abs(i[u] - x[u]) > m),
                            p && ((g.parsed = i), (g.raw = h.data[l])),
                            d && (g.options = c || this.resolveDataElementOptions(l, e.active ? 'active' : s)),
        ...
        function ss(t, e, i, s, n) {
            ...
            return (
                is(
                    ...
                    e,
                    function (i, a, r) {
                        (n || ue(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) && o.push({ element: i, datasetIndex: a, index: r });
                    },
                    !0
                ),
                o
                    ...
                    : (function (t, e, i, s) {
                          ...
                          return (
                              is(t, i, e, function (t, i, o) {
                                  ...
                                  Pt(h, a, r) && n.push({ element: t, datasetIndex: i, index: o });
                              }),
                              n
                          );
                      })(t, e, i, n)
        ...
        function as(t, e, i, s, n) {
            ...
            return (
                is(t, i, e, (t, s, h) => {
                    t[a] && t[a](e[i], n) && (o.push({ element: t, datasetIndex: s, index: h }), (r = r || t.inRange(e.x, e.y, n)));
                }),
                s && !r ? [] : o
            );
        }
        ...
        function ps(t, e, i, s) {
            ...
            const r = Math.max(0, e.outerWidth - fs(a, t, 'left', 'right')),
                ...
                l = r !== t.w,
                c = h !== t.h;
            return ((t.w = r), (t.h = h), i.horizontal ? { same: l, other: c } : { same: c, other: l });
        }
        function ms(t, e) {
        ...
        function bs(t, e, i, s) {
            ...
            for (o = 0, a = t.length, l = 0; o < a; ++o) {
                ((r = t[o]), (h = r.box), h.update(r.width || e.w, r.height || e.h, ms(r.horizontal, e)));
            ...
            for (const r of t) {
                ...
                if (r.horizontal) {
                    ...
                    (it(h.start) && (a = h.start),
                        t.fullSize ? xs(t, n.left, a, i.outerWidth - n.right - n.left, o) : xs(t, e.left + h.placed, a, s, o),
                        (h.start = a),
                        (h.placed += s),
                        (a = t.bottom));
                } else {
                    ...
                    (it(h.start) && (o = h.start),
                        t.fullSize ? xs(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : xs(t, o, e.top + h.placed, a, s),
                        (h.start = o),
                        (h.placed += s),
                        (o = t.right));
                }
        ...
        function Cs(t, e, i) {
            const s = t.canvas,
                n = new MutationObserver((t) => {
                    let e = !1;
                    for (const i of t) ((e = e || Os(i.addedNodes, s)), (e = e && !Os(i.removedNodes, s)));
                    e && i();
                });
        ...
        function As(t, e, i) {
            const s = t.canvas,
                n = new MutationObserver((t) => {
                    let e = !1;
                    for (const i of t) ((e = e || Os(i.removedNodes, s)), (e = e && !Os(i.addedNodes, s)));
                    e && i();
                });
            return (n.observe(document, { childList: !0, subtree: !0 }), n);
        }
        ...
        class Fs extends vs {
            ...
            removeEventListener(t, e) {
                const i = t.$proxies || (t.$proxies = {}),
                    s = i[e];
                if (!s) return;
                ((({ attach: Is, detach: Is, resize: Is })[e] || Ds)(t, e, s), (i[e] = void 0));
            }
            getDevicePixelRatio() {
        ...
        function Bs(t, e) {
            ...
            if (a > 0) {
                ...
                for (Ws(e, l, c, F(s) ? 0 : r - s, r), t = 0, i = a - 1; t < i; t++) Ws(e, l, c, o[t], o[t + 1]);
        ...
        function Ws(t, e, i, s, n) {
            ...
            for (h = Math.max(o, 0); h < a; h++) h === l && (e.push(t[h]), c++, (l = Math.round(o + c * i)));
        }
        ...
        function $s(t, e, i) {
            ...
            if (
                !(
                    i &&
                    ((h = 1 === s ? Math.max(l - o, a - l) : 0 === e ? (t.getPixelForTick(1) - l) / 2 : (l - t.getPixelForTick(n - 1)) / 2),
                    (l += n < e ? h : -h),
                    l < o - r || l > a + r)
                )
            )
        ...
        function Xs(t, e, i) {
            let s = Ft(t);
            return (
                ((i && 'right' !== e) || (!i && 'right' === e)) && (s = ((t) => ('left' === t ? 'right' : 'right' === t ? 'left' : t))(s)),
                s
            );
        }
        class qs extends Vs {
            ...
            getMinMax(t) {
                ...
                return ((i = o && i > s ? s : i), (s = n && i > s ? i : s), { min: N(i, N(s, i)), max: N(s, N(i, s)) });
            }
            getPadding() {
                return {
            ...
            update(t, e, i) {
                ...
                (this._convertTicksToLabels(r ? js(this.ticks, a) : this.ticks),
                    ...
                    o.display &&
                        ...
                        ((this.ticks = Bs(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
            ...
            generateTickLabels(t) {
                ...
                let i, s, n;
                for (i = 0, s = t.length; i < s; i++) ((n = t[i]), (n.label = $(e.callback, [n.value, i, t], this)));
            }
            ...
            calculateLabelRotation() {
                ...
                ((o = t.offset ? this.maxWidth / i : u / (i - 1)),
                    c + 6 > o &&
                        ...
                        (a = this.maxHeight - Ys(t.grid) - e.padding - Us(t.title, this.chart.options.font)),
                        (r = Math.sqrt(c * c + d * d)),
                        (h = yt(
                            Math.min(
            ...
            fit() {
                ...
                if (o) {
                    ...
                    if (
                        (a ? ((t.width = this.maxWidth), (t.height = Ys(n) + o)) : ((t.height = this.maxHeight), (t.width = Ys(n) + o)),
            ...
            _computeLabelSizes(t, e, i) {
                ...
                for (h = 0; h < e; h += r) {
                    if (
                        ...
                        if (V(d))
                            for (l = 0, c = d.length; l < c; ++l) ((x = d[l]), F(x) || V(x) || ((m = ae(s, g.data, g.gc, m, x)), (b += p)));
            ...
            getPixelForDecimal(t) {
                ...
                return Dt(this._alignToPixels ? he(this.chart, e, 0) : e, -32768, 32767);
            }
            ...
            getContext(t) {
                ...
                return this.$context || (this.$context = Ae(this.chart.getContext(), { scale: this, type: 'scale' }));
            }
            _tickSize() {
            ...
            _getYAxisLabelAlignment(t) {
                ...
                return (
                    'left' === e
                        ? s
                            ? ((h = this.right + n),
                              'near' === i ? (r = 'left') : 'center' === i ? ((r = 'center'), (h += a / 2)) : ((r = 'right'), (h += a)))
                            : ((h = this.right - o),
                              'near' === i
                                  ? (r = 'right')
                                  : 'center' === i
                        ...
                        : 'right' === e
                          ? s
                              ? ((h = this.left + n),
                                'near' === i ? (r = 'right') : 'center' === i ? ((r = 'center'), (h -= a / 2)) : ((r = 'left'), (h -= a)))
                              : ((h = this.left + o),
                                'near' === i
                                    ? (r = 'left')
                                    : 'center' === i
            ...
            drawBorder() {
                ...
                let h, l, c, d;
                (this.isHorizontal()
                    ? ((h = he(t, this.left, o) - o / 2), (l = he(t, this.right, a) + a / 2), (c = d = r))
                    : ((c = he(t, this.top, o) - o / 2), (d = he(t, this.bottom, a) + a / 2), (h = l = r)),
                    e.save(),
                    (e.lineWidth = n.width),
            ...
            drawTitle() {
                ...
                'bottom' === e || 'center' === e || B(e)
                    ? ((r += o.bottom), V(i.text) && (r += n.lineHeight * (i.text.length - 1)))
                    : (r += o.top);
                const {
                    titleX: h,
                    titleY: l,
                    ...
                    if (t.isHorizontal()) {
                        ...
                        } else f = 'center' === i ? (l.bottom + l.top) / 2 + p - e : Ns(t, i, e);
                        d = r - o;
                    } else {
                        if (B(i)) {
                            const t = Object.keys(i)[0],
                        ...
                        } else u = 'center' === i ? (l.left + l.right) / 2 - m + e : Ns(t, i, e);
        ...
        class Ks {
            ...
            register(t) {
                ...
                return (
                    n in s ||
                        ((s[n] = t),
                        (function (t, e, i) {
                            const s = G(Object.create(null), [i ? oe.get(i) : {}, oe.get(e), t.defaults]);
                            (oe.set(e, s),
                                t.defaultRoutes &&
                                    (function (t, e) {
            ...
            unregister(t) {
                const e = this.items,
                    i = t.id,
                    s = this.scope;
                (i in e && delete e[i], s && i in oe[s] && (delete oe[s][i], this.override && delete te[i]));
            }
        }
        class Gs {
            constructor() {
                ...
                return !1 !== s || e
                    ? (function (t, { plugins: e, localIds: i }, s, n) {
                          ...
                          for (const r of e) {
                              const e = r.id,
                                  h = Qs(s[e], n);
                              null !== h && o.push({ plugin: r, options: tn(t.config, { plugin: r, local: i[e] }, h, a) });
                          }
                          return o;
                      })(t, n, s, e)
                    : [];
                ...
                t.data.datasets.forEach((i) => {
                    ...
                    Object.keys(r).forEach((t) => {
                        const e = (function (t, e) {
                            ...
                            n = i[e + 'AxisID'] || e;
                        ((o[n] = o[n] || Object.create(null)), Z(o[n], [{ axis: e }, s[n], r[t]]));
                    });
                }),
        ...
        class fn {
            ...
            datasetElementScopeKeys(t, e) {
                return dn(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, '']]);
            }
            pluginScopeKeys(t) {
                const e = t.id;
            ...
            getOptionScopes(t, e, i) {
                ...
                return (0 === h.length && h.push(Object.create(null)), cn.has(e) && o.set(e, h), h);
            }
            chartOptionScopes() {
        ...
        function gn(t, e, i) {
            ...
            let o = s.get(n);
            if (!o) {
                ((o = { resolver: Te(e, i), subPrefixes: i.filter((t) => !t.toLowerCase().includes('hover')) }), s.set(n, o));
            }
            return o;
        }
        const pn = (t) => B(t) && Object.getOwnPropertyNames(t).some((e) => st(t[e]));
        ...
        function vn(t) {
            return (
                Je() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
        ...
        class Pn {
            ...
            constructor(t, e) {
                ...
                ((this.platform = new (i.platform ||
                    (function (t) {
                        return !Je() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas) ? Ms : Fs;
                    })(s))()),
            ...
            _initialize() {
                return (
                    ...
                    this.options.responsive ? this.resize() : ri(this, this.options.devicePixelRatio),
                    this.bindEvents(),
            ...
            resize(t, e) {
                ki.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
            }
            _resize(t, e) {
                const i = this.options,
                    s = this.canvas,
                ...
                (e &&
                    ...
                    Y(n, (e) => {
                        const n = e.options,
                            ...
                            a = nn(o, n),
                            r = H(n.type, e.dtype);
                        ((void 0 !== n.position && bn(n.position, a) === bn(e.dposition)) || (n.position = e.dposition), (s[o] = !0));
                        let h = null;
                        if (o in i && i[o].type === r) h = i[o];
                        else {
                            ((h = new (Zs.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this })), (i[h.id] = h));
                        }
                        h.init(n, t);
                    }),
                    Y(s, (t, e) => {
            ...
            buildOrUpdateControllers() {
                ...
                for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                    ...
                    if (
                        ...
                        (Object.assign(e, { dataElementType: Zs.getElement(a), datasetElementType: s && Zs.getElement(s) }),
            ...
            _checkEventBindings() {
                const t = this.options,
                    ...
                    i = new Set(t.events);
                (nt(e, i) && !!this._responsiveListeners === t.responsive) || (this.unbindEvents(), this.bindEvents());
            }
            ...
            _updateDatasets(t) {
                if (!1 !== this.notifyPlugins('beforeDatasetsUpdate', { mode: t, cancelable: !0 })) {
                    ...
                    for (let e = 0, i = this.data.datasets.length; e < i; ++e) this._updateDataset(e, st(t) ? t({ datasetIndex: e }) : t);
            ...
            render() {
                !1 !== this.notifyPlugins('beforeRender', { cancelable: !0 }) &&
                    (ki.has(this) ? this.attached && !ki.running(this) && ki.start(this) : (this.draw(), _n({ chart: this })));
            }
            draw() {
                let t;
            ...
            _drawDataset(t) {
                const e = this.ctx,
                    ...
                    n = (function (t, e) {
                        ...
                        return i && s
                            ? { left: Sn(i, e, 'left'), right: Sn(i, e, 'right'), top: Sn(s, e, 'top'), bottom: Sn(s, e, 'bottom') }
                            : e;
                    })(t, this.chartArea),
            ...
            getContext() {
                return this.$context || (this.$context = Ae(null, { chart: this, type: 'chart' }));
            }
            ...
            _stop() {
                let t, e;
                for (this.stop(), ki.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t);
            }
            destroy() {
                ...
                (this._stop(),
                    ...
                    t && (this.unbindEvents(), le(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
                    delete Mn[this.id],
            ...
            _handleEvent(t, e, i) {
                ...
                i && ((this._lastEvent = null), $(n.onHover, [t, a, this], this), r && $(n.onClick, [t, a, this], this));
                const l = !U(a, s);
        ...
        function On(t, e, i, s) {
            const n = ke(t.options.borderRadius, ['outerStart', 'outerEnd', 'innerStart', 'innerEnd']);
            const o = (i - e) / 2,
                a = Math.min(o, (s * e) / 2),
                r = (t) => {
        ...
        function An(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(0.001, g * d - i / ot) / d) / 2,
                m = h + p + f,
                b = n - p - f,
                { outerStart: x, outerEnd: _, innerStart: y, innerEnd: v } = On(e, u, d, b - m),
                M = d - x,
                w = d - _,
                k = m + x / M,
                S = b - _ / w,
        ...
        function Tn(t, e, i, s, n) {
            const { fullCircles: o, startAngle: a, circumference: r, options: h } = e,
                { borderWidth: l, borderJoinStyle: c, borderDash: d, borderDashOffset: u } = h,
                f = 'inner' === h.borderAlign;
            if (!l) return;
            (t.setLineDash(d || []),
                (t.lineDashOffset = u),
                f ? ((t.lineWidth = 2 * l), (t.lineJoin = c || 'round')) : ((t.lineWidth = l), (t.lineJoin = c || 'bevel')));
            let g = e.endAngle;
            if (o) {
                An(t, e, i, s, g, n);
            ...
            (f &&
                (function (t, e, i) {
                    ...
                    (t.beginPath(),
                        t.arc(o, a, r, s - l, i + l),
                        h > n ? ((l = n / h), t.arc(o, a, h, i + l, s - l, !0)) : t.arc(o, a, n, i + ct, s - ct),
                        t.closePath(),
                        t.clip());
                })(t, e, g),
        ...
        function In(t, e, i, s) {
            const { points: n, options: o } = e,
                ...
                c = (function (t) {
                    return t.stepped ? pe : t.tension || 'monotone' === t.cubicInterpolationMode ? me : En;
                })(o);
            let d,
                u,
                f,
            ...
            for (d = 0; d <= l; ++d)
                ((u = n[(r + (p ? l - d : d)) % a]), u.skip || (g ? (t.moveTo(u.x, u.y), (g = !1)) : c(t, f, u, p, o.stepped), (f = u)));
        ...
        function Fn(t) {
            ...
            return !(t._decimated || t._loop || e.tension || 'monotone' === e.cubicInterpolationMode || e.stepped || i) ? zn : In;
        }
        ...
        function Bn(t, e, i, s) {
            Vn && !e.options.segment
                ? (function (t, e, i, s) {
                      let n = e._path;
                      (n || ((n = e._path = new Path2D()), e.path(n, i, s) && n.closePath()), Ln(t, e.options), t.stroke(n));
                  })(t, e, i, s)
                : (function (t, e, i, s) {
                      const { segments: n, options: o } = e,
                          a = Fn(e);
                      for (const r of n)
                          (Ln(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke());
                  })(t, e, i, s);
        }
        class Wn extends Vs {
            static id = 'line';
            ...
            interpolate(t, e) {
                ...
                const a = [],
                    r = (function (t) {
                        return t.stepped ? di : t.tension || 'monotone' === t.cubicInterpolationMode ? ui : ci;
                    })(i);
                let h, l;
            ...
            draw(t, e, i, s) {
                ...
                ((this.points || []).length && n.borderWidth && (t.save(), Bn(t, this, i, s), t.restore()),
        ...
        function Yn(t, e, i, s) {
            const n = null === e,
                o = null === i,
                a = t && !(n && o) && Hn(t, s);
            return a && (n || Ot(e, a.left, a.right)) && (o || Ot(i, a.top, a.bottom));
        }
        function Un(t, e) {
            ...
            BarElement: class extends Vs {
                ...
                draw(t) {
                    const {
                        ...
                        a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? ye : Un;
                    var r;
                    (t.save(),
                        (o.w === n.w && o.h === n.h) ||
                            (t.beginPath(), a(t, Xn(o, e, n)), t.clip(), a(t, Xn(n, -e, o)), (t.fillStyle = i), t.fill('evenodd')),
                        t.beginPath(),
                        a(t, Xn(n, e)),
                        (t.fillStyle = s),
                        t.fill(),
                ...
                t.data.datasets.forEach((e, n) => {
                    ...
                    let { start: c, count: d } = (function (t, e) {
                        ...
                        let s,
                            n = 0;
                        const { iScale: o } = t,
                            { min: a, max: r, minDefined: h, maxDefined: l } = o.getUserBounds();
                        return (
                            ...
                            u = (function (t, e, i, s) {
                                ...
                                for (n = e; n < e + i; ++n) {
                                    ...
                                    if (e === h) (r < u ? ((u = r), (l = n)) : r > f && ((f = r), (c = n)), (g = (p * g + o.x) / ++p));
                                        ...
                                        (n > 0 && i !== d && m.push(t[i]), m.push(o), (h = e), (p = 0), (u = f = r), (l = c = d = n));
                                    }
                                }
                                return m;
                            })(h, c, d, s);
        ...
        function oo(t, e, i, s) {
            ...
            let n = e[t],
                o = i[t];
            return ('angle' === t && ((n = St(n)), (o = St(o))), { property: t, start: n, end: o });
        }
        function ao(t, e, i) {
            for (; e > t; e--) {
                const t = i[e];
        ...
        function ho(t, e) {
            ...
            return (
                ...
                i.length ? new Wn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
            );
        }
        function lo(t) {
            return t && !1 !== t.fill;
                ...
                if (e.getPointPositionForValue)
                    return (function (t) {
                        ...
                        if (s.grid.circular) {
                            ...
                            return new po({ x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(a) });
                        }
                ...
                (function (t, e) {
                    ...
                    (t.save(),
                        'x' === h &&
                            ...
                            t.save(),
                            xo(t, s, a.bottom)));
                    (_o(t, { line: i, target: s, color: o, scale: r, property: h }), t.restore());
        ...
        var Mo = {
            ...
            afterDatasetsUpdate(t, e, i) {
                ...
                for (a = 0; a < s; ++a)
                    ((o = t.getDatasetMeta(a)),
                        ...
                        (o.$filler = h),
                        n.push(h));
                for (a = 0; a < s; ++a) ((h = n[a]), h && !1 !== h.fill && (h.fill = co(n, a, i.propagate)));
            },
            beforeDraw(t, e, i) {
                ...
                for (let e = n.length - 1; e >= 0; --e) {
                    const i = n[e].$filler;
                    i && (i.line.updateControlPoints(o, i.axis), s && i.fill && bo(t.ctx, i, o));
                }
            },
            ...
            beforeDatasetDraw(t, e, i) {
                ...
                lo(s) && 'beforeDatasetDraw' === i.drawTime && bo(t.ctx, s, t.chartArea);
            },
        ...
        class ko extends Vs {
            ...
            _fitRows(t, e, i, s) {
                ...
                return (
                    this.legendItems.forEach((t, f) => {
                        ...
                        ((0 === f || h[h.length - 1] + g + 2 * a > o) && ((c += l), (h[h.length - (f > 0 ? 0 : 1)] = 0), (u += l), d++),
            ...
            _fitCols(t, e, i, s) {
                ...
                return (
                    this.legendItems.forEach((t, o) => {
                        ...
                        (o > 0 && u + m + 2 * a > l && ((c += d + a), h.push({ width: d, height: u }), (f += d + a), g++, (d = u = 0)),
            ...
            adjustHitBoxes() {
                ...
                if (this.isHorizontal()) {
                    ...
                    for (const r of e)
                        (n !== r.row && ((n = r.row), (a = Vt(i, this.left + s, this.right - this.lineWidths[n]))),
                            (r.top += this.top + t + s),
                            (r.left = o.leftForLtr(o.x(a), r.width)),
                            (a += r.width + s));
                } else {
                    let n = 0,
                        a = Vt(i, this.top + t + s, this.bottom - this.columnSizes[n].height);
                    for (const r of e)
                        (r.col !== n && ((n = r.col), (a = Vt(i, this.top + t + s, this.bottom - this.columnSizes[n].height))),
                            (r.top = a),
                            (r.left += this.left + s),
            ...
            _draw() {
                ...
                ((u = m
                    ? { x: Vt(n, this.left + l, this.right - i[0]), y: this.top + l + b, line: 0 }
                    : { x: this.left + l, y: Vt(n, this.top + b + l, this.bottom - e[0].height), line: 0 }),
                ...
                (this.legendItems.forEach((_, y) => {
                    ...
                    (r.setWidth(this.width),
                        m
                            ? y > 0 &&
                              k + w + l > this.right &&
                              ((S = u.y += x), u.line++, (k = u.x = Vt(n, this.left + l, this.right - i[u.line])))
                            : y > 0 &&
                              S + x > this.bottom &&
                              ((k = u.x = k + e[u.line].width + l),
                              u.line++,
                              (S = u.y = Vt(n, this.top + b + l, this.bottom - e[u.line].height))));
                    if (
                        ((function (t, e, i) {
                            ...
                            if (
                                ...
                                const a = { radius: (g * Math.SQRT2) / 2, pointStyle: i.pointStyle, rotation: i.rotation, borderWidth: n },
                                    h = r.xPlus(t, f / 2);
                        ...
                        (k = ((t, e, i, s) => (t === (s ? 'left' : 'right') ? i : 'center' === t ? (e + i) / 2 : e))(
                            M,
                            k + f + d,
                            m ? k + w : this.right,
                            t.rtl
                        ...
                        (function (t, e, i) {
                            _e(s, i.text, t, e + p / 2, h, { strikethrough: i.hidden, textAlign: r.textAlign(i.textAlign) });
                        })(r.x(k), S, _),
                        m)
                    )
                        u.x += w + l;
            ...
            drawTitle() {
                ...
                let l,
                    c = this.left,
                    d = this.width;
                if (this.isHorizontal()) ((d = Math.max(...this.lineWidths)), (l = this.top + h), (c = Vt(t.align, c, this.right - d)));
                else {
                    const e = this.columnSizes.reduce((t, e) => Math.max(t, e.height), 0);
                    l = h + Vt(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight());
                }
                const u = Vt(a, c, c + d);
            ...
            _getLegendItemAt(t, e) {
                ...
                if (Ot(t, this.left, this.right) && Ot(e, this.top, this.bottom))
                    for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                        if (((s = n[i]), Ot(t, s.left, s.left + s.width) && Ot(e, s.top, s.top + s.height))) return this.legendItems[i];
                return null;
            }
            handleEvent(t) {
                ...
                if ('mousemove' === t.type || 'mouseout' === t.type) {
                    ...
                    (o && !a && $(e.onLeave, [t, o, this], this), (this._hoveredItem = i), i && !a && $(e.onHover, [t, i, this], this));
        ...
        function Io(t, e) {
            ...
            if (
                ...
                p += f * (e.displayColors ? Math.max(r, h.lineHeight) : h.lineHeight) + (b - f) * h.lineHeight + (b - 1) * e.bodySpacing;
            }
        ...
        function zo(t, e, i, s) {
            ...
            let l = 'center';
            return (
                'center' === s ? (l = n <= (r + h) / 2 ? 'left' : 'right') : n <= o / 2 ? (l = 'left') : n >= a - o / 2 && (l = 'right'),
                (function (t, e, i, s) {
                    const { x: n, width: o } = s,
        ...
        class $o extends Vs {
            ...
            update(t, e) {
                ...
                if (s.length) {
                    ...
                    ((this.xAlign = r.xAlign),
                        ...
                        (n = { opacity: 1, x: h.x, y: h.y, width: e.width, height: e.height, caretX: t.x, caretY: t.y }));
                ...
                return (
                    'center' === n
                        ? ((_ = u + g / 2),
                          ...
                          (b = p))
                        : ((m = 'left' === s ? d + Math.max(r, l) + o : 'right' === s ? d + f - Math.max(h, c) - o : this.caretX),
                          'top' === n
            ...
            _drawColorBox(t, e, i, s, n) {
                const o = this.labelColors[i],
                    ...
                    f = e.y + u;
                if (n.usePointStyle) {
                    const e = { radius: Math.min(h, r) / 2, pointStyle: a.pointStyle, rotation: a.rotation, borderWidth: 1 },
                    ...
                    ((t.lineWidth = B(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1),
                        (t.strokeStyle = o.borderColor),
            ...
            drawBody(t, e, i) {
                const { body: s } = this,
                    { bodySpacing: n, bodyAlign: o, displayColors: a, boxHeight: r, boxWidth: h, boxPadding: l } = i,
                    c = Oe(i.bodyFont);
                let d = c.lineHeight,
                    u = 0;
            ...
            drawBackground(t, e, i, s) {
                const { xAlign: n, yAlign: o } = this,
                    { x: a, y: r } = t,
                    { width: h, height: l } = i,
                    { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = Pe(s.cornerRadius);
            ...
            handleEvent(t, e, i = !0) {
                ...
                return (
                    r &&
                        ((this._active = o), (s.enabled || s.external) && ((this._eventPosition = { x: t.x, y: t.y }), this.update(!0, e))),
                    r
                );
            }
            _getActiveElements(t, e, i, s) {
        ...
        function Ko(t, e) {
            const i = [],
                { bounds: s, step: n, min: o, max: a, precision: r, count: h, maxTicks: l, maxDigits: c, includeBounds: d } = t,
                u = n || 1,
                f = l - 1,
                { min: g, max: p } = e,
                m = !F(o),
            ...
            ((w = Math.ceil(p / k) - Math.floor(g / k)),
                ...
                'ticks' === s ? ((v = Math.floor(g / k) * k), (M = Math.ceil(p / k) * k)) : ((v = g), (M = p)),
                m &&
                b &&
                n &&
                (function (t, e) {
                    ...
                    ? ((w = Math.round(Math.min((a - o) / k, l))), (k = (a - o) / w), (v = o), (M = a))
                    : x
                      ? ((v = m ? o : v), (M = b ? a : M), (w = h - 1), (k = (M - v) / w))
                      : ((w = (M - v) / k), (w = pt(w, Math.round(w), k / 1e3) ? Math.round(w) : Math.ceil(w))));
            const S = Math.max(vt(k), vt(v));
            ((y = Math.pow(10, F(r) ? S : r)), (v = Math.round(v * y) / y), (M = Math.round(M * y) / y));
            let P = 0;
            for (
                m &&
                (d && v !== o
                    ? (i.push({ value: o }), v < o && P++, pt(Math.round((v + P * k) * y) / y, o, Go(o, _, t)) && P++)
                    : v < o && P++);
                P < w;
                ++P
            ) {
        ...
        class Zo extends qs {
            ...
            parse(t, e) {
                return F(t) || (('number' == typeof t || t instanceof Number) && !isFinite(+t)) ? null : +t;
            }
            ...
            getTickLimit() {
                ...
                return (
                    s
                        ? ((e = Math.ceil(this.max / s) - Math.floor(this.min / s) + 1), e > 1e3 && (e = 1e3))
        ...
        class na extends qs {
            ...
            determineDataLimits() {
                ...
                ((this.min = W(t) ? Math.max(0, t) : null),
                    ...
                    this._zero &&
                        ...
                        !W(this._userMin) &&
                        (this.min = t === ta(this.min, 0) ? ta(this.min, -1) : ta(this.min, 0)),
            ...
            getLabelForValue(t) {
                return void 0 === t ? '0' : Zt(t, this.chart.options.locale, this.options.ticks.format);
            }
            configure() {
                const t = this.min;
            ...
            getPixelForValue(t) {
                return (
                    ...
                    null === t || isNaN(t)
                        ? NaN
                        : this.getPixelForDecimal(t === this.min ? 0 : (ft(t) - this._startValue) / this._valueRange)
                );
            }
            getValueForPixel(t) {
            ...
            (t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
                (t._pointLabelItems = (function (t, e, i) {
                    ...
                    for (let o = 0; o < n; o++) {
                        ...
                        const n = la(t, o, h);
                        (s.push(n), 'auto' === r && ((n.visible = ca(n, l)), n.visible && (l = n)));
                    }
                    return s;
                })(t, s, n)));
        }
        ...
        function la(t, e, i) {
            ...
            return { visible: !0, x: h.x, y: c, textAlign: d, left: u, top: c, right: u + r.w, bottom: c + r.h };
        }
        function ca(t, e) {
            if (!e) return !0;
            const { left: i, top: s, right: n, bottom: o } = t;
            return !(ue({ x: i, y: s }, e) || ue({ x: i, y: o }, e) || ue({ x: n, y: s }, e) || ue({ x: n, y: o }, e));
        }
        function da(t, e, i) {
            ...
            if (!F(r)) {
                ...
                Object.values(i).some((t) => 0 !== t)
                    ? (t.beginPath(), ye(t, { x: l, y: c, w: d, h: u, radius: i }), t.fill())
                    : t.fillRect(l, c, d, u);
            }
        }
        function ua(t, e, i, s) {
        ...
        class fa extends Zo {
            ...
            fit() {
                const t = this.options;
                t.display && t.pointLabels.display ? ra(this) : this.setCenterPoint(0, 0, 0, 0);
            }
            ...
            getIndexAngle(t) {
                return St(t * (at / (this._pointLabels.length || 1)) + _t(this.options.startAngle || 0));
            }
            ...
            drawLabels() {
                ...
                (t.save(),
                    ...
                    this.ticks.forEach((s, a) => {
                        ...
                        _e(t, s.label, 0, -n, h, { color: r.color, strokeColor: r.textStrokeColor, strokeWidth: r.textStrokeWidth });
                    }),
                    t.restore());
            }
            drawTitle() {}
        ...
        function ba(t, e) {
            ...
            return (
                ...
                null === a ? null : (n && (a = 'week' !== n || (!bt(o) && !0 !== o) ? i.startOf(a, n) : i.startOf(a, 'isoWeek', o)), +a)
            );
        }
        function xa(t, e, i, s) {
            const n = pa.length;
        ...
        class va extends qs {
                ...
                return (
                        ...
                        (i.autoSkip
                            ...
                            : (function (t, e, i, s, n) {
                                  for (let o = pa.length - 1; o >= pa.indexOf(i); o--) {
                                      const i = pa[o];
                                      if (ga[i].common && t._adapter.diff(n, s, i) >= e - 1) return i;
                                  }
                    ...
                    (this._majorUnit =
                        i.major.enabled && 'year' !== this._unit
                            ? (function (t) {
                                  for (let e = pa.indexOf(t) + 1, i = pa.length; e < i; ++e) if (ga[pa[e]].common) return pa[e];
                              })(this._unit)
                            : void 0),
                    this.initOffsets(s),
                    t.reverse && o.reverse(),
            ...
            initOffsets(t = []) {
                ...
                ((s = Dt(s, 0, o)), (n = Dt(n, 0, o)), (this._offsets = { start: s, end: n, factor: 1 / (s + 1 + n) }));
            }
            _generate() {
                ...
                let c,
                    d,
                    u = e;
                if ((h && (u = +t.startOf(u, 'isoWeek', r)), (u = +t.startOf(u, h ? 'day' : o)), t.diff(i, e, o) > 1e5 * a))
        ...
        function Ma(t, e, i) {
            let s,
                ...
                h = t.length - 1;
            i
                ? (e >= t[r].pos && e <= t[h].pos && ({ lo: r, hi: h } = At(t, 'pos', e)),
                  ({ pos: s, time: o } = t[r]),
                  ({ pos: n, time: a } = t[h]))
                : (e >= t[r].time && e <= t[h].time && ({ lo: r, hi: h } = At(t, 'time', e)),
                  ({ time: s, pos: o } = t[r]),
                  ({ time: n, pos: a } = t[h]));
            const l = n - s;
            ...
            CategoryScale: class extends qs {
                ...
                parse(t, e) {
                    ...
                    return ((t, e) => (null === t ? null : Dt(Math.round(t), 0, e)))(
                        (e = isFinite(e) && i[e] === t ? e : Xo(i, t, H(e, t), this._addedLabels)),
                        i.length - 1
                    );
                }
                determineDataLimits() {
