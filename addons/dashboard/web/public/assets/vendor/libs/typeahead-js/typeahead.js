/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/typeahead-js/typeahead.js
 * @type: Module
                                            ...
                                            set: function (t, e) {
                                                ...
                                                (this.size >= this.maxSize && (this.list.remove(i), delete this.hash[i.key], this.size--),
                                                    (n = this.hash[t])
                                                        ...
                                                        : ((n = new r(t, e)), this.list.add(n), (this.hash[t] = n), this.size++));
                                            },
                                            get: function (t) {
                                                var e = this.hash[t];
                                            ...
                                            _get: function (e, n) {
                                                ...
                                                function h() {
                                                    (t--,
                                                        delete i[s],
                                                        u.onDeckRequestArgs &&
                                                            (u._get.apply(u, u.onDeckRequestArgs), (u.onDeckRequestArgs = null)));
                                                }
                                                ((s = this._fingerprint(e)),
                                                    this.cancelled ||
                                                        ...
                                                        ((o = i[s])
                                                            ? o.done(a).fail(c)
                                                            : t < r
                                                              ? (t++, (i[s] = this._send(e).done(a).fail(c).always(h)))
                                            ...
                                            n.mixin(r.prototype, {
                                                ...
                                                add: function (e) {
                                                    ...
                                                    ((e = n.isArray(e) ? e : [e]),
                                                        n.each(e, function (e) {
                                                            var u, a;
                                                            ((r.datums[(u = r.identify(e))] = e),
                                                                (a = s(r.datumTokenizer(e))),
                                                                n.each(a, function (e) {
                                                                    var n, s, a;
                                                                    for (n = r.trie, s = e.split(''); (a = s.shift()); )
                                                                        (n = n[t][a] || (n[t][a] = o()))[i].push(u);
                                                                }));
                                                        }));
                                                },
                                                get: function (t) {
                                ...
                                (l = (function () {
                                    ...
                                    function t(t) {
                                        ((this.url = t.url),
                                            (this.prepare = t.prepare),
                                            (this.transform = t.transform),
                                            (this.transport = new a({ cache: t.cache, limiter: t.limiter, transport: t.transport })));
                                    }
                                    return (
                                        n.mixin(t.prototype, {
                                            _settings: function () {
                                ...
                                (f = (function () {
                                    ...
                                    return function (i) {
                                        ...
                                        return (
                                            ...
                                            !(i = n.mixin(s, i || {})).datumTokenizer && e.error('datumTokenizer is required'),
                                    ...
                                    function t(t) {
                                        ...
                                        return t
                                            ? ((r = {
                                              ...
                                              (t = n.isString(t) ? { url: t } : t),
                                              !(t = n.mixin(r, t)).url && e.error('prefetch requires url to be set'),
                                              (t.transform = t.filter || t.transform),
                                              (t.cacheKey = t.cacheKey || t.url),
                                              (t.thumbprint = i + t.thumbprint),
                                    ...
                                    function r(t) {
                                        ...
                                        if (t)
                                            return (
                                                ...
                                                (t = n.isString(t) ? { url: t } : t),
                                                !(t = n.mixin(i, t)).url && e.error('remote requires url to be set'),
                                                (t.transform = t.filter || t.transform),
                                                (t.prepare = s(t)),
                                                (t.limiter = o(t)),
                                                (t.transport = t.transport ? u(t.transport) : e.ajax),
                        ...
                        (r = function (t) {
                            return (
                                ...
                                (i = (function () {
                                    ...
                                    function e(e) {
                                        ...
                                        return (
                                            (u = n.mixin({}, t, e)),
                                            {
                                                css: (o = { css: s(), classes: u, html: i(u), selectors: r(u) }).css,
                                                html: o.html,
                                                classes: o.classes,
                                ...
                                (s = (function () {
                                    ...
                                    var t = /\s+/,
                                        e = a();
                                    return { onSync: r, onAsync: i, off: s, trigger: o };
                                    function n(e, n, i, r) {
                                        var s;
                                        if (!i) return this;
                                        for (
                                            n = n.split(t), i = r ? c(i, r) : i, this._callbacks = this._callbacks || {};
                                            (s = n.shift());
                                    ...
                                    function o(n) {
                                        var i, r, s, o, a;
                                        if (!this._callbacks) return this;
                                        for (n = n.split(t), s = [].slice.call(arguments, 1); (i = n.shift()) && (r = this._callbacks[i]); )
                                            ((o = u(r.sync, this, [i].concat(s))), (a = u(r.async, this, [i].concat(s))), o() && e(a));
                                        return this;
                                    }
                                    function u(t, e, n) {
                                        return i;
                                    ...
                                    return function (r) {
                                        ...
                                        function u(t, e) {
                                            for (var n, i = 3, r = 0; r < t.childNodes.length; r++)
                                                (n = t.childNodes[r]).nodeType === i ? (r += e(n) ? 1 : 0) : u(n, e);
                                        }
                                        (r = n.mixin({}, e, r)).node &&
                                            r.pattern &&
                                            ((r.pattern = n.isArray(r.pattern) ? r.pattern : [r.pattern]),
                                            (s = i(r.pattern, r.caseSensitive, r.wordsOnly)),
                                            u(r.node, o));
                                    };
                                    function i(t, e, i) {
                                    ...
                                    return (
                                        ...
                                        n.mixin(i.prototype, s, {
                                            ...
                                            _checkLanguageDirection: function () {
                                                ...
                                                this.dir !== t &&
                                                    ((this.dir = t), this.$hint.attr('dir', t), this.trigger('langDirChanged', t));
                                            },
                                            _setQuery: function (t, e) {
                                                var n, i;
                                                ((i = !!(n = o(t, this.query)) && this.query.length !== t.length),
                                                    (this.query = t),
                                                    e || n
                                            ...
                                            isCursorAtEnd: function () {
                                                ...
                                                return (
                                                    ...
                                                    n.isNumber(e)
                                                        ? e === t
                                                        : !document.selection ||
                                                          ((i = document.selection.createRange()).moveStart('character', -t),
                                                          t === i.text.length)
                                                );
                                            },
                                            destroy: function () {
                                ...
                                (a = (function () {
                                    ...
                                    function r(t, r) {
                                        (((t = t || {}).templates = t.templates || {}),
                                            ...
                                            (this.displayFn = u(t.display || t.displayKey)),
                                                    ...
                                                    n.each(r, function (n) {
                                                        ...
                                                        ((o = u._injectQuery(i, n)),
                                                            (r = e(u.templates.suggestion(o))
                                                                ...
                                                                .addClass(u.classes.suggestion + ' ' + u.classes.selectable)),
                                                            s.appendChild(r[0]));
                                                    }),
                                                    this.highlight && o({ className: this.classes.highlight, node: s, pattern: i }),
                                                    e(s)
                                                );
                                            },
                                            _getFooter: function (t, e) {
                                                return this.templates.footer
                                                    ? this.templates.footer({ query: t, suggestions: e, dataset: this.name })
                                                    : null;
                                            },
                                            _getHeader: function (t, e) {
                                                return this.templates.header
                                                    ? this.templates.header({ query: t, suggestions: e, dataset: this.name })
                                                    : null;
                                            },
                                ...
                                (c = (function () {
                                    ...
                                    function t(t, i) {
                                        ...
                                        ((t = t || {}).node || e.error('node is required'),
                                            ...
                                            (this.$node = e(t.node)),
                                            (this.query = null),
                                            (this.datasets = n.map(t.datasets, s)));
                                    }
                                    return (
                                        n.mixin(t.prototype, s, {
                                            ...
                                            selectableRelativeToCursor: function (t) {
                                                ...
                                                return (
                                                    ...
                                                    -1 ===
                                                    (i =
                                                        (i = (((i = (n ? e.index(n) : -1) + t) + 1) % (e.length + 1)) - 1) < -1
                                                            ? e.length - 1
                                                            : i)
                                                        ? null
                                                        : e.eq(i)
                                        ...
                                        n.mixin(t.prototype, {
                                            ...
                                            _onTabKeyed: function (t, e) {
                                                ...
                                                (n = this.menu.getActiveSelectable())
                                                    ...
                                                    : (n = this.menu.getTopSelectable()) && this.autocomplete(n) && e.preventDefault();
                                            },
                                            ...
                                            autocomplete: function (t) {
                                                ...
                                                return (
                                                    ...
                                                    !(
                                                        ...
                                                        (this.input.setQuery(n.val), this.eventBus.trigger('autocomplete', n.obj), 0)
                                                    )
                                                );
                                            },
                                ...
                                void (function () {
                                    ...
                                    ((t = e.fn.typeahead),
                                        (s = { www: 'tt-www', attrs: 'tt-attrs', typeahead: 'tt-typeahead' }),
                                        (o = {
                                            initialize: function (t, o) {
                                                ...
                                                function p() {
                                                    ...
                                                    (n.each(o, function (e) {
                                                        ...
                                                        (v || _) &&
                                                            (p.css(a.css.wrapper),
                                                            i.css(v ? a.css.input : a.css.inputWithNoHint),
                                                            i
                                                                .wrap(p)
                                                                .parent()
                                                                .prepend(v ? g : null)
                                                        ...
                                                        (A = _ ? h : c),
                                                        (b = new r({ el: i })),
                                                        (w = new u({ hint: g, input: i }, a)),
                                                        (S = new A({ node: y, datasets: o }, a)),
                                                        (x = new l({ input: w, menu: S, eventBus: b, minLength: t.minLength }, a)),
                                                        i.data(s.www, a),
