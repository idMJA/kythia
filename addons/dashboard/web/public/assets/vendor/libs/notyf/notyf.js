/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/notyf/notyf.js
 * @type: Module
...
!(function (t, i) {
    ...
    return (function () {
        ...
        var t = {
                d: function (i, e) {
                    for (var n in e) t.o(e, n) && !t.o(i, n) && Object.defineProperty(i, n, { enumerable: !0, get: e[n] });
                },
                o: function (t, i) {
        ...
        var s,
            r = (function () {
                ...
                return (
                    ...
                    (t.prototype.splice = function (t, i) {
        ...
        var a = {
            ...
            c = (function () {
                ...
                return (
                    (t.prototype.on = function (t, i) {
                        var e;
                        this.events = n(n({}, this.events), (((e = {})[t] = i), e));
                    }),
                    ...
                    (t.prototype.removeNotification = function (t) {
                        ...
                        o &&
                            ((i = o.node).classList.add('notyf__toast--disappear'),
                            i.addEventListener(
                                this.animationEndEventName,
                                (e = function (t) {
                                    t.target === i && (i.removeEventListener(n.animationEndEventName, e), n.container.removeChild(i));
                                })
                            ));
                    }),
                    ...
                    (t.prototype._buildNotificationCard = function (t) {
                        ...
                        var o = this._createHTMLElement({ tagName: 'div', className: 'notyf__toast' }),
                            r = this._createHTMLElement({ tagName: 'div', className: 'notyf__ripple' }),
                            a = this._createHTMLElement({ tagName: 'div', className: 'notyf__wrapper' }),
                            c = this._createHTMLElement({ tagName: 'div', className: 'notyf__message' });
                        c.innerHTML = e.message || '';
                        var p = e.background || e.backgroundColor;
                        if (n) {
                            var f = this._createHTMLElement({ tagName: 'div', className: 'notyf__icon' });
                            if (
                                (('string' == typeof n || n instanceof String) && (f.innerHTML = new String(n).valueOf()),
                                'object' == typeof n)
                            ) {
                                var u = n.tagName,
                                    d = void 0 === u ? 'i' : u,
                                    ...
                                    m = n.color,
                                    v = void 0 === m ? p : m,
                                    y = this._createHTMLElement({ tagName: d, className: l, text: h });
                                (v && (y.style.color = v), f.appendChild(y));
                            }
                            a.appendChild(f);
                        }
                        if (
                            (a.appendChild(c),
                            o.appendChild(a),
                            p && (e.ripple ? ((r.style.background = p), o.appendChild(r)) : (o.style.background = p)),
                            e.dismissible)
                        ) {
                            var _ = this._createHTMLElement({ tagName: 'div', className: 'notyf__dismiss' }),
                                g = this._createHTMLElement({ tagName: 'button', className: 'notyf__dismiss-btn' });
                            (_.appendChild(g),
                                a.appendChild(_),
                                o.classList.add('notyf__toast--dismissible'),
                                g.addEventListener('click', function (e) {
                                    var n, o;
                                    (null === (o = (n = i.events)[s.Dismiss]) || void 0 === o || o.call(n, { target: t, event: e }),
                                        e.stopPropagation());
                                }));
                        }
                        o.addEventListener('click', function (e) {
                            var n, o;
                            return null === (o = (n = i.events)[s.Click]) || void 0 === o ? void 0 : o.call(n, { target: t, event: e });
                        });
                        var N = 'top' === this.getYPosition(e) ? 'upper' : 'lower';
                        return (o.classList.add('notyf__toast--' + N), o);
                    }),
            ...
            p = (function () {
                function t(t) {
                    var i = this;
                    ((this.dismiss = this._removeNotification), (this.notifications = new r()), (this.view = new c()));
                    var e = this.registerTypes(t);
                    ((this.options = n(n({}, a), t)),
                        ...
                        this.view.on(s.Dismiss, function (t) {
                            var e = t.target,
                                n = t.event;
                            (i._removeNotification(e), e.triggerEvent(s.Dismiss, n));
                        }),
                        this.view.on(s.Click, function (t) {
                            var i = t.target,
                                e = t.event;
                            return i.triggerEvent(s.Click, e);
                        }));
                }
                return (
                    ...
                    (t.prototype.assignProps = function (t, i) {
                        var e = this;
                    ...
                    (t.prototype.normalizeOptions = function (t, i) {
                        var e = { type: t };
                        return ('string' == typeof i ? (e.message = i) : 'object' == typeof i && (e = n(n({}, e), i)), e);
                    }),
