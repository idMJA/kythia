/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/bootstrap-select/bootstrap-select.js
 * @type: Module
                    ...
                    !(function (e) {
                        ...
                        ((p = null),
                            ...
                            String.prototype.startsWith ||
                                ...
                                Object.defineProperty
                                    ? Object.defineProperty(String.prototype, 'startsWith', { value: h, configurable: !0, writable: !0 })
                        ...
                        e.fn.triggerNative = function (e) {
                            var t,
                                i = this[0];
                            i.dispatchEvent &&
                                (k ? (t = new Event(e, { bubbles: !0 })) : (t = document.createEvent('Event')).initEvent(e, !0, !1),
                                i.dispatchEvent(t));
                        };
                        var x = {
                                À: 'A',
                        ...
                        var Q = new RegExp(B + '|' + R),
                            ...
                            Z = {
                                ...
                                text: function (e, t) {
                                    ...
                                    if (!0 === t) for (; n.childNodes.length > 0; ) K.fragment.appendChild(n.childNodes[0]);
                        ...
                        function X(e, t) {
                            e.length ||
                                ((K.noResults.innerHTML = this.options.noneResultsText.replace('{0}', '"' + L(t) + '"')),
                        ...
                        var te = function (t, i) {
                            ...
                            (b.useDefault || ((e.valHooks.select.set = b._set), (b.useDefault = !0)),
                                ...
                                (this.options = i),
                                (this.selectpicker = {
                                    main: { data: [], optionQueue: K.fragment.cloneNode(!1), hasMore: !1 },
                        ...
                        function ie(i) {
                            ...
                            if (V.major >= '4') {
                                var l = [];
                                (te.DEFAULTS.style === G.BUTTONCLASS && l.push({ name: 'style', className: 'BUTTONCLASS' }),
                                    te.DEFAULTS.iconBase === G.ICONBASE && l.push({ name: 'iconBase', className: 'ICONBASE' }),
                                    te.DEFAULTS.tickIcon === G.TICKICON && l.push({ name: 'tickIcon', className: 'TICKICON' }),
                            ...
                            var a = this.each(function () {
                                ...
                                if (i.is('select')) {
                                    ...
                                    if ((r.title && (r.placeholder = r.title), l)) {
                                        if (r) for (var a in r) Object.prototype.hasOwnProperty.call(r, a) && (l.options[a] = r[a]);
                                    } else {
                                        var d = i.data();
                                        for (var h in d)
                                        ...
                                        ((p.template = e.extend(
                                            ...
                                            e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.template : {},
                                            d.template,
                                            r.template
                                        )),
                                            (p.source = e.extend(
                                                {},
                                                te.DEFAULTS.source,
                                                e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.source : {},
                                                r.source
                                            )),
                            ...
                            (te.prototype = {
                                ...
                                init: function () {
                                    ...
                                    (_++,
                                        ...
                                        n && null === s.form && (n.id || (n.id = 'form-' + this.selectId), s.setAttribute('form', n.id)),
                                ...
                                createDropdown: function () {
                                    ...
                                    return (
                                        ...
                                        (o =
                                            ...
                                            d +
                                            '</span>' +
                                            (V.major >= '4' ? '' : '<span class="bs-caret">' + this.options.template.caret + '</span>') +
                                            '</button><div class="' +
                                            G.MENU +
                                            ' ' +
                                            (V.major >= '4' ? '' : G.SHOW) +
                                ...
                                createView: function (t, i, s) {
                                    ...
                                    function h(e, i) {
                                        ...
                                        for (var k = 0; k < o; k++) {
                                            ...
                                            void 0 === c &&
                                                e - 1 <= n.selectpicker.current.data[I - 1].position - n.sizeInfo.menuInnerHeight &&
                                                (c = k);
                                        }
                                        if (
                                            (void 0 === c && (c = 0),
                                            ...
                                            void 0 !== n.activeElement &&
                                                (i &&
                                                    (n.activeElement !== n.selectedElement && n.defocusItem(n.activeElement),
                                            ...
                                            if (
                                                ...
                                                for (var A = C.length; k < A; k++) {
                                                    ...
                                                    (n.options.sanitize &&
                                                        (T = D.lastChild) &&
                                                        (z = n.selectpicker.current.data[k + n.selectpicker.view.position0]) &&
                                                        z.content &&
                                                        !z.sanitized &&
                                                ...
                                                if (
                                                    (n.options.sanitize && O.length && a(O, n.options.whiteList, n.options.sanitizeFn),
                                                    !0 === w
                                                        ? ((y =
                                                              0 === n.selectpicker.view.position0
                                                                  ? 0
                                                                  : n.selectpicker.current.data[n.selectpicker.view.position0 - 1]
                                                                        .position),
                                                          (x =
                                                              n.selectpicker.view.position1 > v - 1
                                                                  ? 0
                                                                  : n.selectpicker.current.data[v - 1].position -
                                                                    n.selectpicker.current.data[n.selectpicker.view.position1 - 1]
                                                                        .position),
                                                          (E.firstChild.style.marginTop = y + 'px'),
                                                          (E.firstChild.style.marginBottom = x + 'px'))
                                                        : ((E.firstChild.style.marginTop = 0), (E.firstChild.style.marginBottom = 0)),
                                            ...
                                            if (
                                                ((!t && n.options.source.data) || (t && n.options.source.search)) &&
                                        ...
                                        if (((n.prevActiveElement = n.activeElement), n.options.liveSearch)) {
                                            if (t && i) {
                                                ...
                                                (n.selectpicker.view.canHighlight[P] ||
                                                    (P = 1 + n.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                                ...
                                focusItem: function (e, t, i) {
                                    if (e) {
                                        t =
                                            t ||
                                            this.selectpicker.current.data[this.selectpicker.current.elements.indexOf(this.activeElement)];
                                        var s = e.firstChild;
                                        s &&
                                ...
                                buildData: function (t, i) {
                                    ...
                                    function p(i, o) {
                                        if ((((o = o || {}).divider = n(i, 'divider')), !0 === o.divider)) h({ optID: o.optID });
                                        else {
                                            var a = l.length + r,
                                                c = n(i, 'style'),
                                                d = c ? L(c) : '',
                                            ...
                                            (o.optID && (p = 'opt ' + p),
                                                ...
                                                !1 !== t &&
                                                    (s.selectpicker.optionValuesDataMap[o.value]
                                                        ? (o = e.extend(s.selectpicker.optionValuesDataMap[o.value], o))
                                                        : (s.selectpicker.optionValuesDataMap[o.value] = o)),
                                                l.push(o));
                                        }
                                    }
                                    function u(e, i) {
                                    ...
                                    function l(e, t) {
                                        ...
                                        switch (t.type) {
                                            case 'divider':
                                                ...
                                                break;
                                            case 'option':
                                                (s = Z.li(Z.a(Z.text.call(i, t), t.optionClass, t.inlineStyle), '', t.optID)).firstChild &&
                                        ...
                                        (t.element ? (t.element.innerHTML = s.innerHTML) : (t.element = s),
                                            ...
                                            t.icon && (n += 1),
                                            n > o && ((o = n), (i.selectpicker.view.widestOption = e[e.length - 1])));
                                    }
                                    (!i.options.showTick && !i.multiple) ||
                                        K.checkMark.parentNode ||
                                        ((K.checkMark.className = this.options.iconBase + ' ' + i.options.tickIcon + ' check-mark'),
                                ...
                                render: function (e) {
                                    ...
                                    if (
                                        ...
                                        ((t = this.multiple && -1 !== this.options.selectedTextFormat.indexOf('count') && r > 0) &&
                                            (t =
                                                ((i = this.options.selectedTextFormat.split('>')).length > 1 && r > i[1]) ||
                                                (1 === i.length && r >= 2)),
                                        !1 === t)
                                    ) {
                                        if (!o) {
                                        ...
                                        u = Z.text.call(this, { text: y.replace('{0}', r.toString()).replace('{1}', I.toString()) }, !0);
                                    }
                                    if (
                                        (u.childNodes.length ||
                                            (u = Z.text.call(
                                ...
                                liHeight: function (t) {
                                    if (t || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
                                        var i,
                                            ...
                                            h =
                                                this.options.header && this.$menu.find('.' + G.POPOVERHEADER).length > 0
                                        ...
                                        if (
                                            ...
                                            this.selectpicker.view.widestOption &&
                                                l.appendChild(this.selectpicker.view.widestOption.cloneNode(!0)),
                                            l.appendChild(i),
                                            l.appendChild(r),
                                            l.appendChild(a),
                                            h && n.appendChild(h),
                                ...
                                getSelectPosition: function () {
                                    ...
                                    i.options.container && o.length && !o.is('body')
                                        ? (((t = o.offset()).top += parseInt(o.css('borderTopWidth'))),
                                    ...
                                    ((this.sizeInfo.selectOffsetTop = n.top - t.top - s.scrollTop()),
                                        (this.sizeInfo.selectOffsetBot =
                                            s.height() - this.sizeInfo.selectOffsetTop - this.sizeInfo.selectHeight - t.top - l[2]),
                                        (this.sizeInfo.selectOffsetLeft = n.left - t.left - s.scrollLeft()),
                                        (this.sizeInfo.selectOffsetRight =
                                            s.width() - this.sizeInfo.selectOffsetLeft - this.sizeInfo.selectWidth - t.left - l[1]),
                                ...
                                setMenuSize: function (e) {
                                    ...
                                    (this.$menu.css({ 'max-height': o + 'px', overflow: 'hidden', 'min-height': s + 'px' }),
                                        this.$menuInner.css({ 'max-height': t + 'px', overflow: 'hidden auto', 'min-height': l + 'px' }),
                                    ...
                                    var t,
                                        ...
                                        l = function (l) {
                                            var r = {},
                                                a =
                                                    n.options.display ||
                                                    (!!e.fn.dropdown.Constructor.Default && e.fn.dropdown.Constructor.Default.display);
                                            (n.$bsContainer
                                                .addClass(l.attr('class').replace(/form-control|fit-width/gi, ''))
                                ...
                                setSelected: function (e, t) {
                                    ...
                                    n &&
                                        ...
                                        l
                                            ? (this.focusItem(n, e), (this.selectpicker.view.currentActive = n), (this.activeElement = n))
                                            : this.defocusItem(n),
                                        s &&
                                ...
                                clickListener: function () {
                                    ...
                                    (i.data('spaceSelect', !1),
                                        ...
                                        this.$newElement.on('show.bs.dropdown', function () {
                                            t.dropdown ||
                                                '4' !== V.major ||
                                                ((t.dropdown = t.$button.data('bs.dropdown')), (t.dropdown._menu = t.$menu[0]));
                                        }),
                                                    ...
                                                    (i !== s && i.parentElement !== s) ||
                                                        ...
                                                        (function () {
                                                            ...
                                                            t.$newElement.hasClass(G.SHOW) &&
                                                                (t.options.liveSearch && t.$searchbox.trigger('focus'), t.createView(!1));
                                                        })()));
                                            }
                                        ...
                                        this.$menuInner.on('click', 'li a', function (i, s) {
                                            var n = e(this),
                                                ...
                                                u = !0;
                                            if (
                                                (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(),
                                                i.preventDefault(),
                                                ...
                                                if (
                                                    ...
                                                    s || ((t.prevActiveElement = t.activeElement), (t.activeElement = void 0)),
                                                    t.multiple && 1 !== E)
                                                ) {
                                                            ...
                                                            if (E && 1 === E) ((o.selectedIndex = -1), t.setOptionStatus(!0));
                                                                ...
                                                                var z =
                                                                        'string' == typeof t.options.maxOptionsText
                                                                            ? [t.options.maxOptionsText, t.options.maxOptionsText]
                                                ...
                                                (t.options.source.data && t.$element[0].appendChild(t.selectpicker.main.optionQueue),
                                                    ...
                                                    u &&
                                                        ...
                                                        ((w = [f.index, m.prop('selected'), c]), t.$element.triggerNative('change')));
                                            }
                                        }),
                                        this.$menu.on(
                                            'click',
                                        ...
                                        this.$button
                                            ...
                                            .on('blur' + F, function (e) {
                                                void 0 !== t.selectpicker.view.tabindex &&
                                                    e.originalEvent &&
                                                    e.originalEvent.isTrusted &&
                                                    (t.$element[0].setAttribute('tabindex', t.selectpicker.view.tabindex),
                                    ...
                                    (this.$button.on('click.bs.dropdown.data-api', function () {
                                        ...
                                        this.$searchbox.on('input propertychange', function () {
                                            ...
                                            if (((e.selectpicker.search.elements = []), (e.selectpicker.search.data = []), t))
                                                if (((e.selectpicker.search.previousValue = t), e.options.source.search))
                                                    e.fetchData(
                                                        function (i) {
                                                            (e.render(),
                                                    ...
                                                    for (var a = 0; a < e.selectpicker.main.data.length; a++) {
                                                        ...
                                                        (n[a] || (n[a] = I(c, s, l, r)),
                                                            n[a] &&
                                                                ...
                                                                (c.headerIndex > 0 &&
                                                                    ((n[c.headerIndex - 1] = !0), o.push(c.headerIndex - 1)),
                                                                (n[c.headerIndex] = !0),
                                                    ...
                                                    for (var d = o.length; a < d; a++) {
                                                        ...
                                                        ('divider' !== c.type ||
                                                            ('divider' === c.type && u && 'divider' !== u.type && d - 1 !== a)) &&
                                                            (e.selectpicker.search.data.push(c), i.push(e.selectpicker.main.elements[h]));
                                                    }
                                    ...
                                    if (this.multiple) {
                                        ...
                                        for (var o = 0, l = this.selectpicker.current.data, r = l.length; o < r; o++) {
                                            ...
                                            c &&
                                                !a.disabled &&
                                                'divider' !== a.type &&
                                                (a.selected && i++, (c.selected = e), (a.selected = e), !0 === e && s++);
                                        }
                                        (t.classList.remove('bs-select-hidden'),
                                            i !== s &&
                                                (this.setOptionStatus(), (w = [null, null, n]), this.$element.triggerNative('change')));
                                    }
                                },
                                selectAll: function () {
                                    ...
                                    if (!(t.which >= 112 && t.which <= 123))
                                        if (
                                            ...
                                            if (
                                                (t.which === H &&
                                                    s &&
                                                    (t.preventDefault(), c.$button.trigger('click.bs.dropdown.data-api').trigger('focus')),
                                                u)
                                            ) {
                                                if (!d.length) return;
                                                (-1 !==
                                                    ...
                                                    t.which === B
                                                        ? (-1 !== i && i--,
                                                          ...
                                                          c.selectpicker.view.canHighlight[i + m] ||
                                                              (-1 ===
                                                                  (i =
                                                                      c.selectpicker.view.canHighlight.slice(0, i + m).lastIndexOf(!0) -
                                                                      m) &&
                                                                  (i = d.length - 1)))
                                                        : (t.which === R || p) &&
                                                          ...
                                                          c.selectpicker.view.canHighlight[i + m] ||
                                                              (i = i + 1 + c.selectpicker.view.canHighlight.slice(i + m + 1).indexOf(!0))),
                                                    t.preventDefault());
                                                var v = m + i;
                                                (t.which === B
                                                    ? 0 === m && i === d.length - 1
                                                        ...
                                                        : (o = c.selectpicker.current.data[v]) && (h = (l = o.position - o.height) < f)
                                                    : (t.which === R || p) &&
                                                      (i === c.selectpicker.view.firstHighlightIndex
                                                          ? ((c.$menuInner[0].scrollTop = 0), (v = c.selectpicker.view.firstHighlightIndex))
                                                          : (o = c.selectpicker.current.data[v]) &&
                                                            (h = (l = o.position - c.sizeInfo.menuInnerHeight) > f)),
                                                ...
                                                if (w.length) {
                                                    ...
                                                    (d.removeClass('active').find('a').removeClass('active'),
                                                        1 === b.length &&
                                                            (-1 === (x = w.indexOf(c.activeElement)) || x === w.length - 1 ? (x = 0) : x++),
                                                        (g = w[x]),
                                            ...
                                            s &&
                                                ...
                                                (c.options.liveSearch && t.which === P) ||
                                                    ...
                                                    r.trigger('focus'),
                                                    c.options.liveSearch || (t.preventDefault(), e(document).data('spaceSelect', !0))));
                                        }
                                },
                                mobile: function () {
                        ...
                        function ne() {
                            return V.major < 5
                                ? e.fn.dropdown
                                    ? (
                                          e.fn.dropdown.Constructor._dataApiKeydownHandler || e.fn.dropdown.Constructor.prototype.keydown
