/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js
 * @type: Module
                                    ...
                                    (function (t, e) {
                                        var a = function (a, i, s) {
                                            ...
                                            if (void 0 === i.startDate && void 0 === i.endDate && e(this.element).is(':text')) {
                                                ...
                                                ((o = l = null),
                                                    2 == d.length
                                                        ? ((o = t(d[0], this.locale.format)), (l = t(d[1], this.locale.format)))
                                                        : this.singleDatePicker &&
                                                          '' !== c &&
                                                          ((o = t(c, this.locale.format)), (l = t(c, this.locale.format))),
                                            ...
                                            if ('object' == typeof i.ranges) {
                                                for (h in i.ranges) {
                                                    ...
                                                    if (
                                                        ...
                                                        (((m = document.createElement('textarea')).innerHTML = h),
                                                            (n = m.value),
                                                            (this.ranges[n] = [o, l]));
                                                }
                                                var f = '<ul>';
                                            ...
                                            (a.prototype = {
                                                ...
                                                renderCalendar: function (a) {
                                                    ...
                                                    for (b = 0; b < 6; b++) {
                                                        for (
                                                            ...
                                                            !1 !== j &&
                                                                ('string' == typeof j ? W.push(j) : Array.prototype.push.apply(W, j));
                                                            var H = '',
                                                                R = !1;
                                                            for (D = 0; D < W.length; D++)
                                                                ((H += W[D] + ' '), 'disabled' == W[D] && (R = !0));
                                                            (R || (H += 'available'),
                                                                (Y +=
                                                                    '<td class="' +
                                                                    H.replace(/^\s+|\s+$/g, '') +
                                                    ...
                                                    if ('right' != t || this.endDate) {
                                                        ...
                                                        if (
                                                            ...
                                                            if (
                                                                '' != n.html() &&
                                                                (a.hour(
                                                                    isNaN(a.hour()) ? n.find('.hourselect option:selected').val() : a.hour()
                                                                ),
                                                                a.minute(
                                                                    isNaN(a.minute())
                                                        ...
                                                        for (
                                                            ...
                                                            var c = h;
                                                            this.timePicker24Hour ||
                                                                (c = a.hour() >= 12 ? (12 == h ? 12 : h + 12) : 12 == h ? 0 : h);
                                                ...
                                                move: function () {
                                                    ...
                                                    if ((this.container.toggleClass('drop-up', 'up' == i), 'left' == this.opens)) {
                                                        ...
                                                        (o = this.element.offset().left - a.left + this.element.outerWidth() / 2 - n / 2) <
                                                        0
                                                            ? this.container.css({ top: t, right: 'auto', left: 9 })
                                                            : o + n > e(window).width()
                                                                ...
                                                                if (!e(a).hasClass('week')) {
                                                                    var i = e(a).attr('data-title'),
                                                                        ...
                                                                        c = e(a).parents('.drp-calendar').hasClass('left')
                                                                            ? r.calendar[s][h]
                                                                            : o.calendar[s][h];
                                                                    (c.isAfter(l) && c.isBefore(n)) || c.isSame(n, 'day')
                                                        ...
                                                        if (this.endDate || n.isBefore(this.startDate, 'day')) {
                                                            ...
                                                            if (this.timePicker)
                                                                ((r = parseInt(this.container.find('.right .hourselect').val(), 10)),
                                                                    this.timePicker24Hour ||
                                                                        ('PM' === (h = this.container.find('.right .ampmselect').val()) &&
                                                                            r < 12 &&
                                                                            (r += 12),
                                                                        'AM' === h && 12 === r && (r = 0)),
