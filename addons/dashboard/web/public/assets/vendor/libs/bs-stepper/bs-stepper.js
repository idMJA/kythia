                    ...
                    e.exports = (function () {
                        ...
                        function r() {
                            if (
                                (window.Element.prototype.matches ||
                                    (t = window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector),
                        ...
                        var o = 1e3,
                            ...
                            p = function (e, t, n, s) {
                                ...
                                (i.setAttribute('aria-selected', 'true'), e.classList.contains(c.LINEAR) && i.removeAttribute('disabled'));
                            },
                            d = function (e, t, n, s, r) {
                                var o = e[l],
                                    u = n.indexOf(t),
                                    p = i('shown.bs-stepper', { cancelable: !0, detail: { from: o._currentIndex, to: u, indexStep: u } });
                                function d() {
                                    (t.classList.add(c.BLOCK), t.removeEventListener(a, d), e.dispatchEvent(p), r());
                                }
                                if (t.classList.contains(c.FADE)) {
                                    t.classList.remove(c.NONE);
                                    var h = f(t);
                                    (t.addEventListener(a, d), s.length && s[0].classList.add(c.NONE), t.classList.add(c.ACTIVE), v(t, h));
                                } else (t.classList.add(c.ACTIVE), t.classList.add(c.BLOCK), e.dispatchEvent(p), r());
                            },
                            f = function (e) {
                                if (!e) return 0;
                                var t = window.getComputedStyle(e).transitionDuration;
                                return parseFloat(t) ? ((t = t.split(',')[0]), parseFloat(t) * o) : 0;
                            },
                            v = function (e, t) {
                                var n = !1,
                                    i = t + 5;
                        ...
                        return (function () {
                            function t(t, n) {
                                ...
                                (void 0 === n && (n = {}),
                                    ...
                                    Object.defineProperty(this._element, l, { value: this, writable: !0 }),
                                ...
                                (n.destroy = function () {
                                    ...
                                    (this._steps.forEach(function (t) {
                                        ...
                                        e.options.linear
                                            ...
                                            : n.removeEventListener('click', e._clickStepNonLinearListener);
                                    }),
            ...
            (function () {
                ...
                document.querySelectorAll('.bs-stepper').forEach(function (e) {
                    e.addEventListener('show.bs-stepper', function (t) {
                        for (
                            var n = t.detail.indexStep, s = e.querySelectorAll('.line').length, i = e.querySelectorAll('.step'), r = 0;
                            r < n;
                            r++
                        ) {
