/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/bloodhound/bloodhound.js
 * @type: Module
                    ...
                    ((o = this),
                        ...
                        (i = function (t) {
                            return (o.Bloodhound =
                                            ...
                                            return (
                                                ...
                                                function () {
                                                    ...
                                                    return (
                                                        ...
                                                        (n = arguments),
                                                        a <= 0
                                                            ? (clearTimeout(i), (i = null), (s = c), (o = t.apply(r, n)))
                                                            : i || (i = setTimeout(u, a)),
                                                        o
                                                    );
                                                }
                                ...
                                (i = (function () {
                                    'use strict';
                                    return { nonword: e, whitespace: t, obj: { nonword: n(e), whitespace: n(t) } };
                                    function t(t) {
                                            ...
                                            set: function (t, e) {
                                                ...
                                                (this.size >= this.maxSize && (this.list.remove(n), delete this.hash[n.key], this.size--),
                                                    (r = this.hash[t])
                                                        ...
                                                        : ((r = new i(t, e)), this.list.add(r), (this.hash[t] = r), this.size++));
                                            },
                                            get: function (t) {
                                                var e = this.hash[t];
                                                ...
                                                ((o = this._fingerprint(e)),
                                                    this.cancelled ||
                                                        ...
                                                        ((s = n[o])
                                                            ? s.done(c).fail(a)
                                                            : t < i
                                                              ? (t++, (n[o] = this._send(e).done(c).fail(a).always(h)))
                                    ...
                                    (function () {
                                                    ...
                                                    ((e = r.isArray(e) ? e : [e]),
                                                        r.each(e, function (e) {
                                                            ...
                                                            ((i.datums[(u = i.identify(e))] = e),
                                                                ...
                                                                r.each(c, function (e) {
                                                                    var r, o, c;
                                                                    for (r = i.trie, o = e.split(''); (c = o.shift()); )
                                                ...
                                                search: function (e) {
                                                    ...
                                                    return (
                                                        ...
                                                        r.each(i, function (e) {
                                                            ...
                                                            for (r = a.trie, i = e.split(''); r && (o = i.shift()); ) r = r[t][o];
                                        ...
                                        function c(t, e) {
                                            ...
                                            for (var o = t.length, s = e.length; r < o && n < s; )
                                                t[r] < e[n] ? r++ : (t[r] > e[n] || (i.push(t[r]), r++), n++);
                                            return i;
                                        }
                                    })()),
                                (h = (function () {
                                    ...
                                    return (
                                        ...
                                        r.mixin(e.prototype, {
                                            ...
                                            fromNetwork: function (t) {
                                                ...
                                                t && ((e = this.prepare(this._settings())), this.transport(e).fail(n).done(i));
                                            },
                                            clear: function () {
                                ...
                                (l = (function () {
                                    ...
                                    function t(t) {
                                        ((this.url = t.url),
                                            (this.prepare = t.prepare),
                                            (this.transform = t.transform),
                                            (this.transport = new c({ cache: t.cache, limiter: t.limiter, transport: t.transport })));
                                    }
                                    return (
                                        r.mixin(t.prototype, {
                                            _settings: function () {
                                ...
                                (f = (function () {
                                    ...
                                    function o(t) {
                                        var e, r, n;
                                        return ((e = t.prepare), (r = t.replace), (n = t.wildcard), e || (e = r ? i : t.wildcard ? o : s));
                                        function i(t, e) {
