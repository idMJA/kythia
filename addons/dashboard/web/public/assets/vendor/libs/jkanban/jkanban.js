/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/jkanban/jkanban.js
 * @type: Module
                                            ...
                                            (arguments[0] &&
                                                ...
                                                (this.addBoards = function (t, n) {
                                                    ...
                                                    for (var f in t) {
                                                        ...
                                                        if ((g.classList.add('kanban-drag'), '' !== p.bodyClass && void 0 !== p.bodyClass))
                                                ...
                                                (this.removeElement = function (t) {
                                                    return (
                                                        'string' == typeof t && (t = e.element.querySelector('[data-eid="' + t + '"]')),
                                                        null !== t &&
                                                            ('function' == typeof t.remove ? t.remove() : t.parentNode.removeChild(t)),
                                                        e
                                                    );
                                                }),
                                                (this.removeBoard = function (t) {
                                                    ...
                                                    ('string' == typeof t && (n = e.element.querySelector('[data-id="' + t + '"]')),
                                                        null !== n &&
                                                            ('function' == typeof n.remove ? n.remove() : n.parentNode.removeChild(n)));
                                        ...
                                        (function () {
                                            ...
                                            function d(e, t, o, r) {
                                                n.navigator.pointerEnabled
                                                    ? i[t](
                                                          e,
                                                          { mouseup: 'pointerup', mousedown: 'pointerdown', mousemove: 'pointermove' }[o],
                                                          r
                                                      )
                                                    : n.navigator.msPointerEnabled
                                                      ...
                                                      : (i[t](
                                                            e,
                                                            { mouseup: 'touchend', mousedown: 'touchstart', mousemove: 'touchmove' }[o],
                                                            r
                                                        ),
                                                        i[t](e, o, r));
                                            }
                                            ...
                                            t.exports = function (e, t) {
                                                    ...
                                                    if (N)
                                                        if (0 !== s(e)) {
                                                            if (
                                                                !(
                                                                    void 0 !== e.clientX &&
                                                                    Math.abs(e.clientX - O) <= (I.slideFactorX || 0) &&
                                                                    void 0 !== e.clientY &&
                                                                    Math.abs(e.clientY - S) <= (I.slideFactorY || 0)
                                                                )
                                                            ) {
                                                ...
                                                function Y(e) {
                                                    if (!((A.dragging && n) || P(e))) {
                                                        ...
                                                        var o = h(e);
                                                        if (o)
                                                            if (!I.invalid(e, t)) if (I.moves(e, o, t, b(e))) return { item: e, source: o };
                                                    }
                                                }
                                                function F(e) {
                                                    var t, n;
                                                    ((t = e.item),
                                                        (n = e.source),
                                                        ('boolean' == typeof I.copy ? I.copy : I.copy(t, n)) &&
                                                            ((L = e.item.cloneNode(!0)), A.emit('cloned', L, e.item, 'copy')),
                                                        (y = e.source),
                                                        (T = e.item),
                                                        (x = k = b(e.item)),
                                                        (A.dragging = !0),
                                                ...
                                                function Q(e) {
                                                    if (n) {
                                                        ...
                                                        if (d !== y || !L || I.copySortSource) {
                                                            ...
                                                            ((null === f && s) || (f !== a && f !== b(a))) &&
                                                                ((k = f), d.insertBefore(a, f), A.emit('shadow', a, d, y));
                                                        ...
                                                        r =
                                                            t !== e
                                                                ...
                                                                : (function () {
                                                                      ...
                                                                      for (t = 0; t < c; t++) {
                                                                          if (
                                                                              ((a = (r = e.children[t]).getBoundingClientRect()),
