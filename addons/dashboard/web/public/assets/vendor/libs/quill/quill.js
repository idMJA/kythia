/**
 * @namespace: addons/dashboard/web/public/assets/vendor/libs/quill/quill.js
 * @type: Module
    ...
    return (function () {
        var t = {
                6729: function (t) {
                    ...
                    (Object.create && ((r.prototype = Object.create(null)), new r().__proto__ || (n = !1)),
                        (l.prototype.eventNames = function () {
                            ...
                            for (r in (t = this._events)) e.call(t, r) && s.push(n ? r.slice(1) : r);
                        ...
                        (l.prototype.removeListener = function (t, e, r, s) {
                            ...
                            if (l.fn) l.fn !== e || (s && !l.once) || (r && l.context !== r) || o(this, i);
                            else {
                                for (var a = 0, c = [], u = l.length; a < u; a++)
                                    (l[a].fn !== e || (s && !l[a].once) || (r && l[a].context !== r)) && c.push(l[a]);
                ...
                7529: function (t) {
                            ...
                            var v = (function (t, e, n) {
                                ...
                                if (0 === r.length && (null === s || 0 === s.length)) {
                                    ...
                                    if ((null === u || u === h) && !(h < 0 || h > o)) {
                                        ...
                                        if ((g = e.slice(h)) === c) {
                                            var f = Math.min(l, h);
                                            if ((v = a.slice(0, f)) === (x = d.slice(0, f))) return b(v, a.slice(f), d.slice(f), c);
                                        }
                                    }
                                    if (null === u || u === l) {
                                        var p = l,
                                        ...
                                        if (d === a) {
                                            ...
                                            if ((y = c.slice(c.length - m)) === (N = g.slice(g.length - m)))
                                                return b(a, c.slice(0, c.length - m), g.slice(0, g.length - m), y);
                                        }
                                    }
                                }
                                if (r.length > 0 && s && 0 === s.length) {
                                    ...
                                    if (!(o < (f = v.length) + (m = y.length))) {
                                        var x = e.slice(0, f),
                                            N = e.slice(o - m);
                                        if (v === x && y === N) return b(v, t.slice(f, i - m), e.slice(f, o - m), y);
                                    }
                                }
                                return null;
                            })(t, f, p);
                        ...
                        var N = t.substring(t.length - y),
                            E = (function (t, i) {
                                ...
                                var h = (function (t, e) {
                                    ...
                                    function i(t, e, n) {
                                        for (
                                            var r, i, l, a, c = t.substring(n, n + Math.floor(t.length / 4)), u = -1, h = '';
                                            -1 !== (u = e.indexOf(c, u + 1));
                                ...
                                return (function (t, n) {
                                    for (
                                        ...
                                        ((c[h] = -1), (u[h] = -1));
                                    ((c[l + 1] = 0), (u[l + 1] = 0));
                                    for (var d = s - i, f = d % 2 != 0, p = 0, g = 0, m = 0, b = 0, v = 0; v < o; v++) {
                                        for (var y = -v + p; y <= v - g; y += 2) {
                                            for (
                                                var x = l + y,
                                                    N = (k = y === -v || (y !== v && c[x - 1] < c[x + 1]) ? c[x + 1] : c[x - 1] + 1) - y;
                                        ...
                                        for (var E = -v + m; E <= v - b; E += 2) {
                                            for (
                                                var w,
                                                    A = l + E,
                                                    q = (w = E === -v || (E !== v && u[A - 1] < u[A + 1]) ? u[A + 1] : u[A - 1] + 1) - E;
                                                w < s && q < i && t.charAt(s - w - 1) === n.charAt(i - q - 1);
                            ...
                            })((t = t.substring(0, t.length - y)), (f = f.substring(0, f.length - y)));
                        return (
                            x && E.unshift([0, x]),
                            N && E.push([0, N]),
                            d(E, m),
                            g &&
                                (function (t) {
                                    ...
                                    for (; p < t.length; )
                                        (0 == t[p][0]
                                            ? ((r[s++] = p), (g = b), (m = v), (b = 0), (v = 0), (f = t[p][1]))
                                            : (1 == t[p][0] ? (b += t[p][1].length) : (v += t[p][1].length),
                                              f &&
                                    ...
                                    ((function (t) {
                                        function e(t, e) {
                                            ...
                                            var n = t.charAt(t.length - 1),
                                                ...
                                                g = f && t.match(u),
                                                m = p && e.match(h);
                                            return g || m ? 5 : f || p ? 4 : s && !o && d ? 3 : o || d ? 2 : s || i ? 1 : 0;
                                        }
                                        var n = 1;
                                        for (; n < t.length - 1; ) {
                                            if (0 == t[n - 1][0] && 0 == t[n + 1][0]) {
                                                ...
                                                for (var p = r, g = s, m = i, b = e(r, s) + e(s, i); s.charAt(0) === i.charAt(0); ) {
                    ...
                    function s(t, e) {
                        ...
                        for (var n = 0, r = Math.min(t.length, e.length), s = r, i = 0; n < s; )
                            (t.substring(i, s) == e.substring(i, s) ? (i = n = s) : (r = s), (s = Math.floor((r - n) / 2 + n)));
                    ...
                    function i(t, e) {
                        ...
                        for (var i = 0, o = 1; ; ) {
                            var l = t.substring(s - o),
                                a = e.indexOf(l);
                            if (-1 == a) return i;
                            ((o += a), (0 != a && t.substring(s - o) != e.substring(0, o)) || ((i = o), o++));
                        }
                    }
                    function o(t, e) {
                        if (!t || !e || t.slice(-1) !== e.slice(-1)) return 0;
                        for (var n = 0, r = Math.min(t.length, e.length), s = r, i = 0; n < s; )
                            (t.substring(t.length - s, t.length - i) == e.substring(e.length - s, e.length - i) ? (i = n = s) : (r = s),
                                ...
                                switch (t[i][0]) {
                                    ...
                                    case 0:
                                        ...
                                        if (n) {
                                            if (h >= 0 && m(t[h][1])) {
                                                var f = t[h][1].slice(-1);
                                                if (((t[h][1] = t[h][1].slice(0, -1)), (c = f + c), (u = f + u), !t[h][1])) {
                                                    (t.splice(h, 1), i--);
                                                    var p = h - 1;
                                                    (t[p] && 1 === t[p][0] && (a++, (u = t[p][1] + u), p--),
                                                        t[p] && t[p][0] === e && (l++, (c = t[p][1] + c), p--),
                                                        (h = p));
                                                }
                                            }
                                            if (g(t[i][1])) {
                                        ...
                                        (0 !== i && 0 === t[i - 1][0] ? ((t[i - 1][1] += t[i][1]), t.splice(i, 1)) : i++,
                                            (a = 0),
                                            (l = 0),
                                            (c = ''),
                                            (u = ''));
                ...
                3465: function (t, e, n) {
                    ...
                    var W,
                        ...
                        Q = (W = /[^.]+$/.exec((Y && Y.keys && Y.keys.IE_PROTO) || '')) ? 'Symbol(src)_1.' + W : '',
                        J = G.toString,
                        tt = X.hasOwnProperty,
                        et = X.toString,
                        nt = RegExp(
                    ...
                    function St(t, e) {
                        var n =
                            ...
                            r = n.length,
                            s = !!r;
                        for (var o in t) (!e && !tt.call(t, o)) || (s && ('length' == o || zt(o, r))) || n.push(o);
                        return n;
                    }
                    function Tt(t, e, n) {
                        var r = t[e];
                        (tt.call(t, e) && $t(r, n) && (void 0 !== n || e in t)) || (t[e] = n);
                    }
                    function jt(t, e) {
                    ...
                    function Ct(t, e, n, r, s, f, v) {
                        ...
                        if (j) {
                            ...
                            if (R == d || R == i || (I && !f)) {
                                ...
                                if (
                                    ((T = (function (t) {
                                        return 'function' != typeof t.constructor || Ft(t) ? {} : ((e = ot(t)), Gt(e) ? lt(e) : {});
                                        var e;
                                    })(I ? {} : t)),
                                    !e)
                                )
                    ...
                    function Rt(t) {
                        return !(!Gt(t) || ((e = t), Q && Q in e)) && (Zt(t) || H(t) ? nt : T).test(Ht(t));
                        var e;
                    }
                    function It(t) {
                    ...
                    function zt(t, e) {
                        return !!(e = null == e ? s : e) && ('number' == typeof t || j.test(t)) && t > -1 && t % 1 == 0 && t < e;
                    }
                    function Ft(t) {
                ...
                2307: function (t, e, n) {
                    ...
                    ((A['[object Float32Array]'] =
                        ...
                        A['[object Uint32Array]'] =
                            !0),
                        (A[i] = A[o] = A[x] = A[l] = A[N] = A[a] = A[c] = A[u] = A[h] = A[d] = A[f] = A[g] = A[m] = A[b] = A[y] = !1));
                    ...
                    var B,
                        ...
                        $ = z.toString,
                        V = F.hasOwnProperty,
                        K = (B = /[^.]+$/.exec((H && H.keys && H.keys.IE_PROTO) || '')) ? 'Symbol(src)_1.' + B : '',
                        W = F.toString,
                        Z = RegExp(
                            '^' +
                                $.call(V)
                                              ...
                                              p || Vt(t)
                                                  ...
                                                  : (function (t, e, n, r, s, i, o) {
                                                        switch (n) {
                                                            ...
                                                            case m:
                                                                var f = 1 & r;
                                                                if ((u || (u = M), t.size != e.size && !f)) return !1;
                                                                var p = o.get(t);
                                                                if (p) return p == e;
                                                                ((r |= 2), o.set(t, e));
                                      ...
                                      return (
                                          ...
                                          (function (t, e, n, r, s, i) {
                                              ...
                                              for (; ++h < a; ) {
                                                  var m = t[(d = l[h])],
                                                      b = e[d];
                                                  if (r) var v = o ? r(b, m, d, e, t, i) : r(m, b, d, t, e, i);
                                                  if (!(void 0 === v ? m === b || s(m, b, n, r, i) : v)) {
                                                      p = !1;
                                                      break;
                                                  }
                                                  g || (g = 'constructor' == d);
                    ...
                    function Lt(t) {
                        if (((n = (e = t) && e.constructor), (r = ('function' == typeof n && n.prototype) || F), e !== r)) return rt(t);
                        var e,
                            n,
                            r,
                            s = [];
                        for (var i in Object(t)) V.call(t, i) && 'constructor' != i && s.push(i);
                        return s;
                    }
                    function Ot(t, e, n, r, s, i) {
                        ...
                        for (i.set(t, e), i.set(e, t); ++u < l; ) {
                            ...
                            if (d) {
                                if (
                                    !R(e, function (t, e) {
                                        if (((o = e), !d.has(o) && (f === t || s(f, t, n, r, i)))) return d.push(e);
                                        var o;
                                    })
                                ) {
                                    h = !1;
                    ...
                    ((bt.prototype.clear = function () {
                        ...
                        (yt.prototype.clear = function () {
                            ((this.size = 0), (this.__data__ = { hash: new bt(), map: new (it || vt)(), string: new bt() }));
                        }),
                    ...
                    var Ct = et
                        ...
                        Rt = At;
                    function It(t, e) {
                        return !!(e = null == e ? s : e) && ('number' == typeof t || w.test(t)) && t > -1 && t % 1 == 0 && t < e;
                    }
                    function Mt(t) {
                        if (null != t) {
                            try {
                ...
                1210: function (t, e, n) {
                    ...
                    (!(function (t) {
                        ((t.compose = function (t = {}, e = {}, n = !1) {
                            ...
                            let s = r(e);
                            n || (s = Object.keys(s).reduce((t, e) => (null != s[e] && (t[e] = s[e]), t), {}));
                            for (const n in t) void 0 !== t[n] && void 0 === e[n] && (s[n] = t[n]);
                            ...
                            (t.diff = function (t = {}, e = {}) {
                                ...
                                const n = Object.keys(t)
                                    ...
                                    .reduce((n, r) => (s(t[r], e[r]) || (n[r] = void 0 === e[r] ? null : e[r]), n), {});
                ...
                7098: function (t, e, n) {
                    ...
                    class h {
                        ...
                        slice(t = 0, e = 1 / 0) {
                            ...
                            for (; s < e && r.hasNext(); ) {
                                let i;
                                (s < t ? (i = r.next(t - s)) : ((i = r.next(e - s)), n.push(i)), (s += l.default.length(i)));
                            }
                            return new h(n);
                        }
                        compose(t) {
                            ...
                            for (; e.hasNext() || n.hasNext(); )
                                if ('insert' === n.peekType()) l.push(n.next());
                                    ...
                                    if (s.retain) {
                                        const a = {};
                                        if ('number' == typeof r.retain) a.retain = 'number' == typeof s.retain ? t : s.retain;
                                        ...
                                        const c = o.default.compose(r.attributes, s.attributes, 'number' == typeof r.retain);
                                        if ((c && (a.attributes = c), l.push(a), !n.hasNext() && i(l.ops[l.ops.length - 1], a))) {
                                    ...
                                    for (; e > 0; ) {
                                        ...
                                        switch (t[0]) {
                                            case r.INSERT:
                                                ...
                                                break;
                                            case r.DELETE:
                                                ((n = Math.min(e, u.peekLength())), u.next(n), s.delete(n));
                                                break;
                                            case r.EQUAL:
                                                ...
                                                const t = u.next(n),
                                                    l = d.next(n);
                                                i(t.insert, l.insert)
                                                    ? s.retain(n, o.default.diff(t.attributes, l.attributes))
                                                    : s.push(l).delete(n);
                                        }
                                        e -= n;
                                    }
                        ...
                        eachLine(t, e = '\n') {
                            ...
                            for (; n.hasNext(); ) {
                                ...
                                const i = n.peek(),
                                    ...
                                    a = 'string' == typeof i.insert ? i.insert.indexOf(e, o) - o : -1;
                                    ...
                                    if (r.insert) e.delete(l.default.length(r));
                                        ...
                                        if ('object' == typeof r.retain && null !== r.retain) {
                                            const s = t.slice(n, n + 1),
                                                ...
                                                f = h.getHandler(l);
                                            return (e.retain({ [l]: f.invert(c, d) }, o.default.invert(r.attributes, i.attributes)), n + 1);
                                        }
                                    }
                                    return n;
                                }, 0),
                        ...
                        transform(t, e = !1) {
                            ...
                            for (; r.hasNext() || s.hasNext(); )
                                if ('insert' !== r.peekType() || (!e && 'insert' === s.peekType()))
                                    if ('insert' === s.peekType()) i.push(s.next());
                                        ...
                                        if (l.delete) i.push(l);
                                            ...
                                            if ('object' == typeof r && null !== r && 'object' == typeof s && null !== s) {
                                            ...
                                            i.retain(a, o.default.transform(n.attributes, l.attributes, e));
                                        }
                                    }
                        ...
                        transformPosition(t, e = !1) {
                            ...
                            for (; n.hasNext() && r <= t; ) {
                                const s = n.peekLength(),
                                    i = n.peekType();
                                (n.next(),
                                    'delete' !== i ? ('insert' === i && (r < t || !e) && (t += s), (r += s)) : (t -= Math.min(s, t - r)));
                            }
                            return t;
                        }
                    }
                    ...
                    e.default = class {
                        ...
                        next(t) {
                            ...
                            if (e) {
                                ...
                                if (
                                    (t >= s - n ? ((t = s - n), (this.index += 1), (this.offset = 0)) : (this.offset += t),
        ...
        return (
            (function () {
                ...
                ((h.prototype.clear = e), (h.prototype.delete = l), (h.prototype.get = a), (h.prototype.has = c), (h.prototype.set = u));
                var d = h;
                var f = function () {
                ...
                var O = function (t) {
                    return null == t ? (void 0 === t ? '[object Undefined]' : '[object Null]') : L && L in Object(t) ? q(t) : _(t);
                };
                var S = function (t) {
                    var e = typeof t;
                    return null != t && ('object' == e || 'function' == e);
                ...
                var T,
                    ...
                    R = (T = /[^.]+$/.exec((C && C.keys && C.keys.IE_PROTO) || '')) ? 'Symbol(src)_1.' + T : '';
                var I = function (t) {
                        return !!R && R in t;
                    },
                ...
                var rt = nt;
                var st = function () {
                    ((this.size = 0), (this.__data__ = { hash: new rt(), map: new (W || d)(), string: new rt() }));
                };
                var it = function (t) {
                    var e = typeof t;
                ...
                var vt = function (t, e, n) {
                    ((void 0 !== n && !s(t[e], n)) || (void 0 === n && !(e in t))) && bt(t, e, n);
                };
                var yt = (function (t) {
                    ...
                    Nt = xt && 'object' == typeof module && module && !module.nodeType && module,
                ...
                var Wt = function () {
                    ...
                    Gt = Zt && 'object' == typeof module && module && !module.nodeType && module,
                ...
                var oe = function (t) {
                    ...
                    le = 'object' == typeof exports && exports && !exports.nodeType && exports,
                    ae = le && 'object' == typeof module && module && !module.nodeType && module,
                ...
                var Ae = function (t) {
                    ...
                    var e = Rt(t),
                        n = [];
                    for (var r in t) ('constructor' != r || (!e && we.call(t, r))) && n.push(r);
                    return n;
                };
                var qe = function (t) {
                                        ...
                                        : Kt(l)
                                          ...
                                          : f
                                            ...
                                            : p
                                              ...
                                              : (u = [])
                                    : re(a) || Ft(a)
                                      ? ((u = l), Ft(l) ? (u = ke(l)) : (S(l) && !j(l)) || (u = It(a)))
                                      : (h = !1));
                        }
                ...
                var je = function (t, e, n) {
                    return (
                        ...
                        function () {
                            for (var r = arguments, s = -1, i = Te(r.length - e, 0), o = Array(i); ++s < i; ) o[s] = r[e + s];
                            s = -1;
                ...
                var Ce = function (t) {
                    ...
                    Re = mt
                        ? function (t, e) {
                              return mt(t, 'toString', { configurable: !0, enumerable: !1, value: Ce(e), writable: !0 });
                          }
                        : Oe,
                    Ie = Date.now;
                var Me = function (t) {
                ...
                var Ue = function (t, e, n) {
                    if (!S(n)) return !1;
                    var r = typeof e;
                    return !!('number' == r ? Vt(n) && ye(e, n.length) : 'string' == r && e in n) && s(n[e], t);
                };
                var Pe = (function (t) {
                ...
                class Fe {
                    constructor(t, e, n = {}) {
                        ...
                        ((this.scope = null != n.scope ? (n.scope & ze.LEVEL) | r : ze.ATTRIBUTE),
                ...
                const $e = class t {
                    ...
                    create(e, n, r) {
                        ...
                        const i = s,
                            o = n instanceof Node || n.nodeType === Node.TEXT_NODE ? n : i.create(r),
                            l = new i(e, o, r);
                    ...
                    query(t, e = ze.ANY) {
                        ...
                        return (
                            ...
                            null == n ? null : 'scope' in n && e & ze.LEVEL & n.scope && e & ze.TYPE & n.scope ? n : null
                        );
                    }
                    register(...t) {
                        return t.map((t) => {
                            ...
                            if (e && 'abstract' === t.blotName) throw new He('Cannot register abstract class');
                ...
                const We = class extends Fe {
                    ...
                    value(t) {
                        const e = (Ke(t, this.keyName)[0] || '').slice(this.keyName.length + 1);
                ...
                const Ge = class extends Fe {
                    ...
                    remove(t) {
                        ((t.style[Ze(this.keyName)] = ''), t.getAttribute('style') || t.removeAttribute('style'));
                    }
                    value(t) {
                ...
                const Xe = class {
                    ...
                    Ye = class {
                        ...
                        static create(t) {
                            ...
                            return (
                                Array.isArray(this.tagName)
                                    ? ('string' == typeof t
                                          ? ((n = t.toUpperCase()), parseInt(n, 10).toString() === n && (n = parseInt(n, 10)))
                                          : 'number' == typeof t && (n = t),
                                      (e =
                                          'number' == typeof n
                        ...
                        detach() {
                            (null != this.parent && this.parent.removeChild(this), Ve.blots.delete(this.domNode));
                        }
                        deleteAt(t, e) {
                ...
                class en {
                    ...
                    find(t, e = !1) {
                        ...
                        for (; r; ) {
                            const s = r.length();
                            if (t < s || (e && t === s && (null == r.next || 0 !== r.next.length()))) return [r, t];
                            ((t -= s), (r = n()));
                        }
                        return [null, 0];
                    }
                    ...
                    forEachAt(t, e, n) {
                        ...
                        for (; l && i < t + e; ) {
                            const r = l.length();
                            (t > i ? n(l, t - i, Math.min(e, i + r - t)) : n(l, 0, Math.min(r, t + e - i)), (i += r), (l = o()));
                        }
                    }
                    map(t) {
                ...
                const rn = class t extends Qe {
                    ...
                    descendants(e, n = 0, r = Number.MAX_VALUE) {
                        ...
                        return (
                            this.children.forEachAt(n, r, (n, r, o) => {
                                (((null == e.blotName && e(n)) || (null != e.blotName && n instanceof e)) && s.push(n),
                    ...
                    path(e, n = !1) {
                        const [r, s] = this.children.find(e, n),
                            i = [[this, e]];
                        return r instanceof t ? i.concat(r.path(s, n)) : (null != r && i.push([r, s]), i);
                    }
                    removeChild(t) {
                    ...
                    format(e, n) {
                        if (e !== this.statics.blotName || n) {
                            ...
                            t instanceof Fe
                                ...
                                : n && (e !== this.statics.blotName || this.formats()[e] !== n) && this.replaceWith(e, n);
                        } else
                ...
                ((on.allowedChildren = [on, tn]), (on.blotName = 'inline'), (on.scope = ze.INLINE_BLOT), (on.tagName = 'SPAN'));
                const ln = on,
                    an = class t extends sn {
                        ...
                        formatAt(t, e, n, r) {
                            null != this.scroll.query(n, ze.BLOCK) ? this.format(n, r) : super.formatAt(t, e, n, r);
                        }
                        insertAt(t, e, n) {
                            if (null == n || null != this.scroll.query(e, ze.INLINE)) super.insertAt(t, e, n);
                            else {
                ...
                ((an.blotName = 'block'), (an.scope = ze.BLOCK_BLOT), (an.tagName = 'P'), (an.allowedChildren = [ln, an, tn]));
                const cn = an,
                    un = class extends sn {
                        checkMerge() {
                ...
                const dn = class extends tn {
                    ...
                    fn = { attributes: !0, characterData: !0, characterDataOldValue: !0, childList: !0, subtree: !0 },
                    pn = class extends sn {
                        constructor(t, e) {
                            (super(null, e),
                                (this.registry = t),
                        ...
                        optimize(t = [], e = {}) {
                            ...
                            const s = (t, e = !0) => {
                                    null == t ||
                                        t === this ||
                                        (null != t.domNode.parentNode && (n.has(t.domNode) || n.set(t.domNode, []), e && s(t.parent)));
                                },
                                i = (t) => {
                                    n.has(t.domNode) && (t instanceof sn && t.children.forEach(i), n.delete(t.domNode), t.optimize(e));
                                };
                            let o = t;
                ...
                var yr = function t(e, n, r, s, i, o) {
                    ...
                    if (h) {
                        ...
                        if (d == br || d == gr || (f && !i)) {
                            if (((l = c || f ? {} : It(e)), !a)) return c ? Rn(e, qn(l, e)) : Tn(e, An(l, e));
                        } else {
                            if (!vr[d]) return i ? e : {};
                            l = ar(e, d, a);
                        }
                ...
                var _r = function (t, e, n, r, s, i) {
                    ...
                    for (i.set(t, e), i.set(e, t); ++h < l; ) {
                        ...
                        if (f) {
                            if (
                                !qr(e, function (t, e) {
                                    if (!kr(f, e) && (p === t || s(p, t, n, r, i))) return f.push(e);
                                })
                            ) {
                                d = !1;
                                break;
                ...
                var Rr = function (t, e, n, r, s, i) {
                        ...
                        if (f && !p) {
                            ...
                            v == y ||
                                !('constructor' in t) ||
                                !('constructor' in e) ||
                                ('function' == typeof v && v instanceof v && 'function' == typeof y && y instanceof y) ||
                                (f = !1);
                        }
                ...
                var Ur = function (t, e, n, r, s, i) {
                    ...
                    if (d && !u) return (i || (i = new gt()), o || de(t) ? _r(t, e, n, r, s, i) : jr(t, e, a, n, r, s, i));
                    if (!(1 & n)) {
                ...
                var Pr = function t(e, n, r, s, i) {
                    return e === n || (null == e || null == n || (!Mt(e) && !Mt(n)) ? e != e && n != n : Ur(e, n, r, s, t, i));
                };
                var zr = function (t, e) {
                    return Pr(t, e);
                };
                ...
                class Wr extends ln {
                    ...
                    formatAt(t, e, n, r) {
                        if (Wr.compare(this.statics.blotName, n) < 0 && this.scroll.query(n, ze.BLOT)) {
                            const s = this.isolate(t, e);
                            r && s.wrap(n, r);
                    ...
                    optimize(t) {
                        if (
                            (super.optimize(t),
                            this.parent instanceof Wr && Wr.compare(this.statics.blotName, this.parent.statics.blotName) > 0)
                        ) {
                ...
                class Gr extends cn {
                    cache = {};
                    delta() {
                        return (null == this.cache.delta && (this.cache.delta = Yr(this)), this.cache.delta);
                    }
                    deleteAt(t, e) {
                    ...
                    insertAt(t, e, n) {
                        ...
                        s.length > 0 &&
                            ...
                            (this.cache = {}));
                        let i = this;
                        r.reduce((t, e) => ((i = i.split(t, !0)), i.insertAt(0, e), e.length), t + s.length);
                    }
                    insertBefore(t, e) {
                        const { head: n } = this.children;
                        (super.insertBefore(t, e), n instanceof Hr && n.remove(), (this.cache = {}));
                    }
                    length() {
                ...
                ((Gr.blotName = 'block'), (Gr.tagName = 'P'), (Gr.defaultChild = Hr), (Gr.allowedChildren = [Hr, Zr, dn, $r]));
                class Xr extends dn {
                    attach() {
                        (super.attach(), (this.attributes = new Xe(this.domNode)));
                    }
                    delta() {
                        return new vn().insert(this.value(), { ...this.formats(), ...this.attributes.values() });
                    }
                    format(t, e) {
                ...
                function Yr(t) {
                    ...
                    return t
                        .descendants(tn)
                        .reduce((t, n) => (0 === n.length() ? t : t.insert(n.value(), Qr(n, {}, e))), new vn())
                        .insert('\n', Qr(t));
                }
                function Qr(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                class Jr extends dn {
                    ...
                    format(t, e) {
                        ...
                        let n = this,
                            r = 0;
                        for (; null != n && n.statics.scope !== ze.BLOCK_BLOT; ) ((r += n.offset(n.parent)), (n = n.parent));
                        null != n &&
                    ...
                    restore() {
                        ...
                        let l;
                        if (((i.data = Jr.CONTENTS), e)) ((l = e), (o || r) && (e.insertAt(e.length(), o + s), r && r.remove()));
                        ...
                        if ((this.remove(), t)) {
                            const s = (t, s) =>
                                    e && t === e.domNode ? s : t === i ? n + s - 1 : r && t === r.domNode ? n + o.length + s : null,
                                a = s(t.start.node, t.start.offset),
                                c = s(t.end.node, t.end.offset);
                            if (null !== a && null !== c) return { startNode: l.domNode, startOffset: a, endNode: l.domNode, endOffset: c };
                        }
                        return null;
                    }
                    update(t, e) {
                ...
                var fs = class {
                    constructor(t, e) {
                        ((this.emitter = e),
                            ...
                            this.emitter.listenDOM('selectionchange', document, () => {
                                this.mouseDown || this.composing || setTimeout(this.update.bind(this, cs.sources.USER), 1);
                            }),
                            ...
                            this.emitter.on(cs.events.SCROLL_OPTIMIZE, (t, e) => {
                                if (e.range) {
                                    const { startNode: t, startOffset: n, endNode: r, endOffset: s } = e.range;
                                    (this.setNativeRange(t, n, r, s), this.update(cs.sources.SILENT));
                                }
                            }),
                    ...
                    format(t, e) {
                        ...
                        if (null != n && n.native.collapsed && !this.scroll.query(t, ze.BLOCK)) {
                    ...
                    getBounds(t) {
                        ...
                        if (e > 0)
                            return (
                                ...
                                null == s ? null : (([r, i] = s.position(i, !0)), o.setEnd(r, i), o.getBoundingClientRect())
                            );
                        let l,
                            a = 'left';
                    ...
                    hasFocus() {
                        return (
                            ...
                            (null != document.activeElement && ds(this.root, document.activeElement))
                        );
                    }
                    normalizedToRange(t) {
                        ...
                        const n = e.map((t) => {
                                ...
                                return 0 === n ? s : r instanceof tn ? s + r.index(e, n) : s + r.length();
                            }),
                    ...
                    normalizeNative(t) {
                        if (!ds(this.root, t.startContainer) || (!t.collapsed && !ds(this.root, t.endContainer))) return null;
                        const e = {
                    ...
                    setRange(t) {
                        let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : cs.sources.API;
                        if (('string' == typeof e && ((n = e), (e = !1)), us.info('setRange', t), null != t)) {
                    ...
                    update() {
                        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : cs.sources.USER;
                        ...
                        if (
                            ...
                            const n = [cs.events.SELECTION_CHANGE, xr(this.lastRange), xr(e), t];
                            (this.emitter.emit(cs.events.EDITOR_CHANGE, ...n), t !== cs.sources.SILENT && this.emitter.emit(...n));
                        }
                    }
                };
                const ps = /^[ -~]*$/;
                function gs(t, e, n) {
                    ...
                    const [{ child: r, offset: s, length: i, indent: o, type: l }, ...a] = t,
                        [c, u] = vs(l);
                    if (o > e)
                        return (n.push(l), o === e + 1 ? `<${c}><li${u}>${ms(r, s, i)}${gs(a, o, n)}` : `<${c}><li>${gs(t, e + 1, n)}`);
                    const h = n[n.length - 1];
                    if (o === e && l === h) return `</li><li${u}>${ms(r, s, i)}${gs(a, o, n)}`;
                    const [d] = vs(n.pop());
                ...
                function ms(t, e, n) {
                    ...
                    if (t instanceof sn) {
                        if ('list-container' === t.statics.blotName) {
                            ...
                            return (
                                t.children.forEachAt(e, n, (t, e, n) => {
                                    const s = 'formats' in t && 'function' == typeof t.formats ? t.formats() : {};
                                    r.push({ child: t, offset: e, length: n, indent: s.indent || 0, type: s.list });
                                }),
                                gs(r, -1, [])
                            );
                        }
                        ...
                        const { outerHTML: i, innerHTML: o } = t.domNode,
                            [l, a] = i.split(`>${o}<`);
                        return '<table' === l ? `<table style="border: 1px solid #000;">${s.join('')}<${a}` : `${l}>${s.join('')}<${a}`;
                    }
                ...
                var Ns = class {
                    ...
                    applyDelta(t) {
                        ...
                        return (
                            (function (t) {
                                ...
                                if (null != n.insert) {
                                    if ((r.retain(s), 'string' == typeof n.insert)) {
                                        ...
                                        if (s) (e <= t || this.scroll.descendant(Xr, t)[0]) && (l = !0);
                                        else if (t > 0) {
                                            const [e, n] = this.scroll.descendant(tn, t - 1);
                                            if (e instanceof $r) {
                                                '\n' !== e.value()[n] && (o = !0);
                                            } else e instanceof dn && e.statics.scope === ze.INLINE_BLOT && (o = !0);
                                        }
                                    ...
                                    e += s;
                                } else if ((r.push(n), null !== n.retain && 'object' == typeof n.retain)) {
                            ...
                            r.reduce(
                                (t, e) => ('number' == typeof e.delete ? (this.scroll.deleteAt(t, e.delete), t) : t + vn.Op.length(e)),
                                0
                            ),
                    ...
                    deleteText(t, e) {
                        return (this.scroll.deleteAt(t, e), this.update(new vn().retain(t).delete(e)));
                    }
                    formatLine(t, e) {
                    ...
                    getDelta() {
                        return this.scroll.lines().reduce((t, e) => t.concat(e.delta()), new vn());
                    }
                    getFormat(t) {
                        let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                            n = [],
                        ...
                        0 === e
                            ...
                            : ((n = this.scroll.lines(t, e)), (r = this.scroll.descendants(tn, t, e)));
                        const [s, i] = [n, r].map((t) => {
                            const e = t.shift();
                            if (null == e) return {};
                            let n = Qr(e);
                    ...
                    getHTML(t, e) {
                        ...
                        if (n) {
                            const s = n.length();
                            return !(n.length() >= r + e) || (0 === r && e === s) ? ms(this.scroll, t, e, !0) : ms(n, r, e, !0);
                        }
                        return '';
                    }
                    getText(t, e) {
                    ...
                    insertEmbed(t, e, n) {
                        return (this.scroll.insertAt(t, e, n), this.update(new vn().retain(t).insert({ [e]: n })));
                    }
                    insertText(t, e) {
                        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                        return (
                    ...
                    removeFormat(t, e) {
                        ...
                        null != r &&
                            ...
                            (o = r
                                ...
                                .slice(s, s + i - 1)
                                .insert('\n')));
                        const l = this.getContents(t, e + i).diff(new vn().insert(n).concat(o)),
                    ...
                    update(t) {
                        ...
                        if (
                            ...
                            const s = this.scroll.find(e[0].target),
                                ...
                                u = n && { oldRange: xs(n.oldRange, -o), newRange: xs(n.newRange, -o) };
                            ((t = new vn()
                                .retain(o)
                                .concat(a.diff(c, u))
                                .reduce((t, e) => (e.insert ? t.insert(e.insert, i) : t.push(e)), new vn())),
                                (this.delta = r.compose(t)));
                        } else ((this.delta = this.getDelta()), (t && zr(r.compose(t), this.delta)) || (t = r.diff(this.delta, n)));
                        return t;
                    }
                };
                var Es = class {
                ...
                const Ls = (t) => {
                    ...
                    Ss = (t, e, n, r, s, i) =>
                        t < n && e > r ? 0 : t < n ? -(n - t + s) : e > r ? (e - t > r - n ? t + s - n : e - r + i) : 0;
                var Ts = (t, e) => {
                    ...
                    for (; s; ) {
                        const t = s === n.body,
                            ...
                            l = Ss(r.left, r.right, e.left, e.right, Os(o.scrollPaddingLeft), Os(o.scrollPaddingRight)),
                            a = Ss(r.top, r.bottom, e.top, e.bottom, Os(o.scrollPaddingTop), Os(o.scrollPaddingBottom));
                        if (l || a)
                            if (t) n.defaultView?.scrollBy(l, a);
                                ...
                                const n = s.scrollLeft - t,
                                    i = s.scrollTop - e;
                                r = { left: r.left - n, top: r.top - i, right: r.right - n, bottom: r.bottom - i };
                            }
                        s = t || 'fixed' === o.position ? null : (i = s).parentElement || i.getRootNode().host || null;
                    }
                    var i;
                };
                ...
                var Cs = (t, e, n) => {
                    ...
                    return (
                        ...
                        t.forEach((t) => {
                            let s = e.query(t);
                            s || n.error(`Cannot register "${t}" specified in "formats" config. Are you sure it was registered?`);
                            let i = 0;
                            for (; s; )
                                if ((r.register(s), (s = 'blotName' in s ? (s.requiredContainer ?? null) : null), (i += 1), i > 100)) {
                ...
                class Ms {
                    ...
                    static imports = { delta: vn, parchment: t, 'core/module': Es, 'core/theme': _s };
                    static debug(t) {
                    ...
                    static import(t) {
                        return (
                            null == this.imports[t] && Rs.error(`Cannot import ${t}. Are you sure it was registered?`),
                            this.imports[t]
                        );
                    }
                    static register() {
                        if ('string' != typeof (arguments.length <= 0 ? void 0 : arguments[0])) {
                            ...
                            (null == this.imports[t] || n || Rs.warn(`Overwriting ${t} with`, e),
                                (this.imports[t] = e),
                    ...
                    constructor(t) {
                        ...
                        if (
                            ((this.options = (function (t, e) {
                                ...
                                let d = e.registry;
                                d
                                    ? e.formats && Rs.warn('Ignoring "formats" option because "registry" is specified')
                                    : (d = e.formats ? Cs(e.formats, h.registry, Rs) : h.registry);
                                return {
                                    ...h,
                                    registry: d,
                                    container: n,
                                    ...
                                    modules: Object.entries(u).reduce((t, e) => {
                                        ...
                                        return null == s
                                            ? (Rs.error(`Cannot load ${n} module. Are you sure you registered it?`), t)
                                            : { ...t, [n]: Pe({}, s.DEFAULTS || {}, r) };
                                    }, {}),
                                    bounds: Bs(h.bounds),
                                };
                        ...
                        if (!s || !('blotName' in s)) throw new Error(`Cannot initialize Quill without "${r}" blot`);
                        if (
                            ((this.scroll = new s(this.options.registry, this.root, { emitter: this.emitter })),
                            ...
                            this.emitter.on(cs.events.EDITOR_CHANGE, (t) => {
                                t === cs.events.TEXT_CHANGE && this.root.classList.toggle('ql-blank', this.editor.isBlank());
                            }),
                            ...
                            this.emitter.on(cs.events.SCROLL_EMBED_UPDATE, (t, e) => {
                                ...
                                Ps.call(
                                    this,
                                    () => {
                                        const n = new vn().retain(t.offset(this)).retain({ [t.statics.blotName]: e });
                    ...
                    deleteText(t, e, n) {
                        return (([t, e, , n] = zs(t, e, n)), Ps.call(this, () => this.editor.deleteText(t, e), n, t, -1 * e));
                    }
                    disable() {
                        this.enable(!1);
                    }
                    ...
                    format(t, e) {
                        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : cs.sources.API;
                        return Ps.call(
                            this,
                            () => {
                                ...
                                let r = new vn();
                                if (null == n) return r;
                                if (this.scroll.query(t, ze.BLOCK)) r = this.editor.formatLine(n.index, n.length, { [t]: e });
                                else {
                    ...
                    formatLine(t, e, n, r, s) {
                        let i;
                        return (([t, e, i, s] = zs(t, e, n, r, s)), Ps.call(this, () => this.editor.formatLine(t, e, i), s, t, 0));
                    }
                    formatText(t, e, n, r, s) {
                        let i;
                        return (([t, e, i, s] = zs(t, e, n, r, s)), Ps.call(this, () => this.editor.formatText(t, e, i), s, t, 0));
                    }
                    getBounds(t) {
                        let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                            n = null;
                        if (((n = 'number' == typeof t ? this.selection.getBounds(t, e) : this.selection.getBounds(t.index, t.length)), !n))
                            return null;
                    ...
                    getSemanticHTML() {
                        ...
                        return ('number' == typeof t && (e = e ?? this.getLength() - t), ([t, e] = zs(t, e)), this.editor.getHTML(t, e));
                    }
                    getText() {
                        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                            e = arguments.length > 1 ? arguments[1] : void 0;
                        return ('number' == typeof t && (e = e ?? this.getLength() - t), ([t, e] = zs(t, e)), this.editor.getText(t, e));
                    }
                    hasFocus() {
                        return this.selection.hasFocus();
                    }
                    insertEmbed(t, e, n) {
                        let r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : Ms.sources.API;
                        return Ps.call(this, () => this.editor.insertEmbed(t, e, n), r, t);
                    }
                    insertText(t, e, n, r, s) {
                        let i;
                        return (([t, , i, s] = zs(t, 0, n, r, s)), Ps.call(this, () => this.editor.insertText(t, e, i), s, t, e.length));
                    }
                    isEnabled() {
                    ...
                    removeFormat(t, e, n) {
                        return (([t, e, , n] = zs(t, e, n)), Ps.call(this, () => this.editor.removeFormat(t, e), n, t));
                    }
                    ...
                    setContents(t) {
                        let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : cs.sources.API;
                        return Ps.call(
                            this,
                            () => {
                                t = new vn(t);
                    ...
                    updateContents(t) {
                        let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : cs.sources.API;
                        return Ps.call(this, () => ((t = new vn(t)), this.editor.applyDelta(t)), e, !0);
                    }
                }
                function Bs(t) {
                ...
                function Ps(t, e, n, r) {
                    if (!this.isEnabled() && e === cs.sources.USER && !this.allowReadOnlyEdits) return new vn();
                    ...
                    if (
                        ...
                        (this.emitter.emit(cs.events.EDITOR_CHANGE, ...t), e !== cs.sources.SILENT && this.emitter.emit(...t));
                    }
                    return o;
                }
                function zs(t, e, n, r, s) {
                    ...
                    return (
                        ...
                        'object' == typeof n ? ((i = n), (s = r)) : 'string' == typeof n && (null != r ? (i[n] = r) : (s = n)),
                ...
                function Fs(t, e, n, r) {
                    ...
                    return (
                        e && 'function' == typeof e.transformPosition
                            ? ([i, o] = [t.index, t.index + t.length].map((t) => e.transformPosition(t, r !== cs.sources.USER)))
                            : ([i, o] = [t.index, t.index + t.length].map((t) =>
                                  t < e || (t === e && r === cs.sources.USER) ? t : s >= 0 ? t + s : Math.max(e, t + s)
                              )),
                        new hs(i, o - i)
                    );
                }
                ...
                var Ws = class extends gn {
                    ...
                    deleteAt(t, e) {
                        ...
                        if ((super.deleteAt(t, e), null != s && n !== s && r > 0)) {
                            if (n instanceof Xr || s instanceof Xr) return void this.optimize();
                    ...
                    insertContents(t, e) {
                        ...
                        const s = n.shift();
                        if (s) {
                            const e = 'block' === s.type && (0 === s.delta.length() || (!this.descendant(Xr, t)[0] && t < this.length())),
                                n = 'block' === s.type ? s.delta : new vn().insert({ [s.key]: s.value });
                            Ks(this, t, n);
                        ...
                        const n = (t, e, r) => {
                            ...
                            return (
                                t.children.forEachAt(e, r, (t, e, r) => {
                                    ($s(t) ? s.push(t) : t instanceof hn && (s = s.concat(n(t, e, i))), (i -= r));
                                }),
                                s
                            );
                        };
                    ...
                    optimize() {
                        ...
                        this.batch || (super.optimize(t, e), t.length > 0 && this.emitter.emit(cs.events.SCROLL_OPTIMIZE, t, e));
                    }
                    path(t) {
                    ...
                    update(t) {
                        ...
                        ('string' == typeof t && (e = t),
                            ...
                            (t = t.filter((t) => {
                                ...
                                return n && !Vs(n);
                            })).length > 0 && this.emitter.emit(cs.events.SCROLL_BEFORE_UPDATE, e, t),
                                    ...
                                    if ('string' == typeof r) {
                                        ...
                                        this.query(s, ze.INLINE)
                                            ...
                                            : (n.length() && e.push({ type: 'block', delta: n, attributes: {} }),
                                              (n = new vn()),
                                              e.push({ type: 'blockEmbed', key: s, value: r[s], attributes: t.attributes ?? {} }));
                                    }
                            }),
                            n.length() && e.push({ type: 'block', delta: n, attributes: {} }),
                            e
                ...
                const Zs = { scope: ze.BLOCK, whitelist: ['right', 'center', 'justify'] },
                ...
                const di = new (class extends Ge {
                    ...
                    fi = new We('size', 'ql-size', { scope: ze.INLINE, whitelist: ['small', 'large', 'huge'] }),
                    pi = new Ge('size', 'font-size', { scope: ze.INLINE, whitelist: ['10px', '18px', '32px'] }),
                ...
                class bi extends Es {
                    ...
                    constructor(t, e) {
                        (super(t, e),
                            ...
                            /Firefox/i.test(navigator.userAgent)
                                ...
                                : (this.addBinding({ key: 'Backspace' }, { collapsed: !0, prefix: /^.?$/ }, this.handleBackspace),
                                  this.addBinding({ key: 'Delete' }, { collapsed: !0, suffix: /^.?$/ }, this.handleDelete)),
                    ...
                    addBinding(t) {
                        ...
                        if (null == r) return void gi.warn('Attempted to add invalid keyboard binding', r);
                        ('function' == typeof e && (e = { handler: e }), 'function' == typeof n && (n = { handler: n }));
                        (Array.isArray(r.key) ? r.key : [r.key]).forEach((t) => {
                            const s = { ...r, key: t, ...e, ...n };
                            ((this.bindings[s.key] = this.bindings[s.key] || []), this.bindings[s.key].push(s));
                        });
                    }
                    listen() {
                        this.quill.root.addEventListener('keydown', (t) => {
                            ...
                            const e = (this.bindings[t.key] || []).concat(this.bindings[t.which] || []).filter((e) => bi.match(t, e));
                            if (0 === e.length) return;
                            ...
                            e.some((t) => {
                                if (null != t.collapsed && t.collapsed !== d.collapsed) return !1;
                        ...
                        if (0 === e.offset) {
                            ...
                            if (e) {
                                if (!('block' === e.statics.blotName && e.length() <= 1)) {
                                    ...
                                    if (((r = vn.AttributeMap.diff(e, n) || {}), Object.keys(r).length > 0)) {
                                        const e = new vn().retain(t.index + s.length() - 2).retain(1, r);
                                        i = i.compose(e);
                                    }
                                }
                            }
                        ...
                        if (e.offset >= s.length() - 1) {
                            ...
                            if (e) {
                                ...
                                ((r = vn.AttributeMap.diff(n, o) || {}),
                                    Object.keys(r).length > 0 && (i = i.retain(e.length() - 1).retain(1, r)));
                            }
                        }
                        (this.quill.updateContents(i, Ms.sources.USER), this.quill.focus());
                    }
                    ...
                    handleEnter(t, e) {
                        const n = Object.keys(e.format).reduce(
                                (t, n) => (this.quill.scroll.query(n, ze.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]), t),
                                {}
                            ),
                ...
                const vi = {
                    bindings: {
                        ...
                        indent: {
                            ...
                            handler(t, e) {
                                return !(!e.collapsed || 0 === e.offset) || (this.quill.format('indent', '+1', Ms.sources.USER), !1);
                            },
                        },
                        outdent: {
                            key: 'Tab',
                        ...
                        'outdent backspace': {
                            ...
                            handler(t, e) {
                                null != e.format.indent
                                    ...
                                    : null != e.format.list && this.quill.format('list', !1, Ms.sources.USER);
                            },
                        },
                        ...
                        tab: {
                            ...
                            handler(t, e) {
                                ...
                                const n = new vn().retain(t.index).delete(t.length).insert('\t');
                                return (
                        ...
                        'list empty enter': {
                            ...
                            handler(t, e) {
                                const n = { list: !1 };
                                (e.format.indent && (n.indent = !1), this.quill.formatLine(t.index, t.length, n, Ms.sources.USER));
                            },
                        },
                        'checklist enter': {
                            key: 'Enter',
                                ...
                                if (e) {
                                    const [n, r, s, i] = e.getTable(t),
                                        o = (function (t, e, n, r) {
                                            if (null == e.prev && null == e.next)
                                                return null == n.prev && null == n.next ? (0 === r ? -1 : 1) : null == n.prev ? -1 : 1;
                                    ...
                                    if (o < 0) {
                                        ...
                                        (this.quill.updateContents(e, Ms.sources.USER),
                                            this.quill.setSelection(t.index + 1, t.length, Ms.sources.SILENT));
                                    } else if (o > 0) {
                                        l += n.length();
                                        const t = new vn().retain(l).insert('\n');
                                        (this.quill.updateContents(t, Ms.sources.USER), this.quill.setSelection(l, Ms.sources.USER));
                                    }
                                }
                            },
                        },
                        ...
                        'list autofill': {
                            ...
                            handler(t, e) {
                                ...
                                (this.quill.insertText(t.index, ' ', Ms.sources.USER), this.quill.history.cutoff());
                                const o = new vn()
                                    .retain(t.index - s)
                                    .delete(n + 1)
                                    .retain(r.length() - 2 - s)
                        ...
                        'code exit': {
                            ...
                            handler(t) {
                                ...
                                let r = 2,
                                    s = e;
                                for (; null != s && s.length() <= 1 && s.formats()['code-block']; )
                                    if (((s = s.prev), (r -= 1), r <= 0)) {
                                        const r = new vn()
                        ...
                        handler(e, n) {
                            ...
                            if (0 === e.length && !r.shiftKey)
                                return (
                                    ...
                                    void this.quill.setSelection(e.index + i.length, Ms.sources.SILENT)
                                );
                            const o = 0 === e.length ? this.quill.getLines(e.index, 1) : this.quill.getLines(e);
                            let { index: l, length: a } = e;
                            (o.forEach((e, n) => {
                                t
                                    ? (e.insertAt(0, i), 0 === n ? (l += i.length) : (a += i.length))
                                    : e.domNode.textContent.startsWith(i) &&
                                      (e.deleteAt(0, i.length), 0 === n ? (l -= i.length) : (a -= i.length));
                            }),
                    ...
                    return {
                        ...
                        handler(n) {
                            ...
                            return (
                                ...
                                ('ArrowLeft' === t
                                    ? e
                                        ? this.quill.setSelection(n.index - 1, n.length + 1, Ms.sources.USER)
                                        : this.quill.setSelection(n.index - 1, Ms.sources.USER)
                                    : e
                                      ? this.quill.setSelection(n.index, n.length + 1, Ms.sources.USER)
                                      : this.quill.setSelection(n.index + n.length + 1, Ms.sources.USER),
                                !1)
                            );
                        },
                    ...
                    return {
                        ...
                        handler(e, n) {
                            ...
                            if (null != i) {
                                ...
                                null != e &&
                                    (t
                                        ? this.quill.setSelection(e.offset(this.quill.scroll) + e.length() - 1, 0, Ms.sources.USER)
                                        : this.quill.setSelection(e.offset(this.quill.scroll), 0, Ms.sources.USER));
                            }
                            return !1;
                        },
                    };
                ...
                function wi(t) {
                    ...
                    (e.deleteText(n, Ms.sources.USER),
                        Object.keys(s).length > 0 && e.formatLine(n.index, 1, s, Ms.sources.USER),
                                ...
                                .map((t) =>
                                    ((t, e) => {
                                        ...
                                        const s = Number(r[1]),
                                            i = n?.match(Oi),
                                            o = i ? Number(i[1]) : 1,
                                            l = new RegExp(`@list l${s}:level${o}\\s*\\{[^\\}]*mso-level-number-format:\\s*([\\w-]+)`, 'i'),
                                            a = e.match(l);
                                        return { id: s, indent: o, type: a && 'bullet' === a[1] ? 'bullet' : 'ordered', element: t };
                                    })(t, s)
                                )
                                .filter((t) => t);
                        for (; i.length; ) {
                            ...
                            for (; e; )
                                (t.push(e),
                                    (e =
                                        i.length && i[0]?.element === e.element.nextElementSibling && i[0].id === e.id ? i.shift() : null));
                ...
                const Ti = [
                    function (t) {
                        'urn:schemas-microsoft-com:office:word' === t.documentElement.getAttribute('xmlns:w') && Si(t);
                    },
                    function (t) {
                        t.querySelector('[id^="docs-internal-guid-"]') &&
                            ...
                            ((t) => {
                                Array.from(t.querySelectorAll('br'))
                                    .filter((t) => ki(t.previousElementSibling) && ki(t.nextElementSibling))
                                    .forEach((t) => {
                ...
                const Ci = ls('quill:clipboard'),
                    Ri = [
                        [
                            ...
                            function (t, e, n) {
                                ...
                                if (!zi(t)) {
                                    ...
                                    ((r = r.replace(/[^\S\u00a0]/g, ' ')),
                                        (r = r.replace(/ {2,}/g, ' ')),
                                        ((null == t.previousSibling && null != t.parentElement && Ui(t.parentElement, n)) ||
                                            (t.previousSibling instanceof Element && Ui(t.previousSibling, n))) &&
                                            (r = r.replace(/^ /, '')),
                                        ((null == t.nextSibling && null != t.parentElement && Ui(t.parentElement, n)) ||
                                            (t.nextSibling instanceof Element && Ui(t.nextSibling, n))) &&
                                            (r = r.replace(/ $/, '')),
                                        (r = r.replaceAll(' ', ' ')));
                                }
                                return e.insert(r);
                        ...
                        [
                            ...
                            function (t, e, n) {
                                ...
                                if (r.prototype instanceof dn) {
                                    const e = {},
                                        s = r.value(t);
                                    if (null != s) return ((e[r.blotName] = s), new vn().insert(e, r.formats(t, n)));
                                } else if (
                                ...
                                return (
                                    r
                                        ...
                                        .forEach((e) => {
                                            ...
                                            (null != r && ((o[r.attrName] = r.value(t)), o[r.attrName])) ||
                                                ((r = Ii[e]),
                                                null == r ||
                                                ...
                                                null == r ||
                                                    (r.attrName !== e && r.keyName !== e) ||
                                                    ((r = Mi[e]), (o[r.attrName] = r.value(t) || void 0)));
                                        }),
                        ...
                        [
                            ...
                            function (t, e, n) {
                                ...
                                (s.fontWeight?.startsWith('bold') || parseInt(s.fontWeight, 10) >= 700) && (r.bold = !0);
                                if (
                        ...
                        [
                            ...
                            function (t, e, n) {
                                ...
                                let s = -1,
                                    i = t.parentNode;
                                for (; null != i; ) (['OL', 'UL'].includes(i.tagName) && (s += 1), (i = i.parentNode));
                                return s <= 0
                                    ? e
                                    : e.reduce(
                                          (t, e) =>
                                              e.insert
                                                  ? e.attributes && 'number' == typeof e.attributes.indent
                                                      ? t.push(e)
                                                      : t.insert(e.insert, { indent: s, ...(e.attributes || {}) })
                                                  : t,
                                          new vn()
                                      );
                            },
                        ...
                        [
                            ...
                            function (t, e, n) {
                                const r = n.query('code-block'),
                                    s = !r || !('formats' in r) || 'function' != typeof r.formats || r.formats(t, n);
                        ...
                        [
                            ...
                            function (t, e, n) {
                                ...
                                if (null != r) {
                                    return Bi(e, 'table', Array.from(r.querySelectorAll('tr')).indexOf(t) + 1, n);
                                }
                                return e;
                            },
                        ],
                    ...
                    Mi = [Ys, ni, ti, ci, di, pi].reduce((t, e) => ((t[e.keyName] = e), t), {});
                function Bi(t, e, n, r) {
                    return r.query(e)
                        ? t.reduce((t, r) => {
                ...
                function zi(t) {
                    return null != t && (Pi.has(t) || ('PRE' === t.tagName ? Pi.set(t, !0) : Pi.set(t, zi(t.parentNode))), Pi.get(t));
                }
                          ...
                          ? Array.from(e.childNodes || []).reduce((i, o) => {
                                ...
                                return (
                                    o.nodeType === e.ELEMENT_NODE &&
                                        ((l = n.reduce((e, n) => n(o, e, t), l)), (l = (s.get(o) || []).reduce((e, n) => n(o, e, t), l))),
                                    i.concat(l)
                                );
                            }, new vn())
                          : new vn();
                ...
                function Vi(t, e) {
                    ...
                    for (let e = t.length - 1; e >= 0; e -= 1) {
                        const r = t[e];
                        ((t[e] = { delta: n.transform(r.delta, !0), range: r.range && Ki(r.range, n) }),
                ...
                Wi.DEFAULTS = {
                    ...
                    handler(t, e) {
                        ...
                        Promise.all(n).then((e) => {
                            const n = e.reduce((t, e) => t.insert({ image: e }), new vn().retain(t.index).delete(t.length));
                            (this.quill.updateContents(n, cs.sources.USER), this.quill.setSelection(t.index + e.length, cs.sources.SILENT));
                        });
                    },
                };
                var Zi = Wi;
                ...
                var Xi = class extends Es {
                    ...
                    replaceText(t) {
                        ...
                        if (e) {
                            ...
                            (this.deleteRange(t), this.quill.updateContents(new vn().retain(t.index).insert(e, n), Ms.sources.USER));
                        } else this.deleteRange(t);
                        return (this.quill.setSelection(t.index + e.length, 0, Ms.sources.SILENT), !0);
                    }
                    handleBeforeInput(t) {
                        if (this.quill.composition.isComposing || t.defaultPrevented || !Gi.includes(t.inputType)) return;
                        const e = t.getTargetRanges ? t.getTargetRanges()[0] : null;
                        if (!e || !0 === e.collapsed) return;
                        const n = (function (t) {
                            if ('string' == typeof t.data) return t.data;
                            if (t.dataTransfer?.types.includes('text/plain')) return t.dataTransfer.getData('text/plain');
                            return null;
                        })(t);
                        if (null == n) return;
                    ...
                    handleArrowKeys() {
                        this.quill.keyboard.addBinding({
                            ...
                            handler(t, e) {
                                ...
                                return (
                                    !!((s && 'ArrowRight' !== r.key) || (!s && 'ArrowLeft' !== r.key)) ||
                                    (this.quill.setSelection(t.index - 1, t.length + (r.shiftKey ? 1 : 0), Ms.sources.USER), !1)
                                );
                            },
                        });
                    }
                ...
                Ms.register({
                    ...
                    'modules/clipboard': class extends Es {
                        ...
                        convert(t) {
                            ...
                            if (r[si.blotName]) return new vn().insert(n || '', { [si.blotName]: r[si.blotName] });
                        ...
                        dangerouslyPasteHTML(t, e) {
                            let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ms.sources.API;
                            if ('string' == typeof t) {
                                const n = this.convert({ html: t, text: '' });
                                (this.quill.setContents(n, e), this.quill.setSelection(0, Ms.sources.SILENT));
                            } else {
                        ...
                        onPaste(t, e) {
                            ...
                            (this.quill.updateContents(o, Ms.sources.USER),
                                this.quill.setSelection(o.length() - t.length, Ms.sources.SILENT),
                                this.quill.scrollSelectionIntoView());
                        }
                        prepareMatching(t, e) {
                            const n = [],
                    ...
                    'modules/history': class extends Es {
                                ...
                                this.quill.on(Ms.events.EDITOR_CHANGE, (t, e, n, r) => {
                                    t === Ms.events.SELECTION_CHANGE
                                        ...
                                        : t === Ms.events.TEXT_CHANGE &&
                                          (this.ignoreChange ||
                                              (this.options.userOnly && r !== Ms.sources.USER ? this.transform(e) : this.record(e, n)),
                        ...
                        record(t, e) {
                            ...
                            let n = t.invert(e),
                                r = this.currentRange;
                            const s = Date.now();
                            if (this.lastRecorded + this.options.delay > s && this.stack.undo.length > 0) {
                            ...
                            if (t.range) this.quill.setSelection(t.range, Ms.sources.USER);
                                ...
                                const e = (function (t, e) {
                                    ...
                                    (function (t, e) {
                                        ...
                                        if (null == n) return !1;
                                        if (null != n.insert) return 'string' == typeof n.insert && n.insert.endsWith('\n');
                                        if (null != n.attributes)
                                            return Object.keys(n.attributes).some((e) => null != t.query(e, ze.BLOCK));
                                        return !1;
                                    })(t, e) && (r -= 1);
                                    return r;
                ...
                })('indent', 'ql-indent', { scope: ze.BLOCK, whitelist: [1, 2, 3, 4, 5, 6, 7, 8] });
                var eo = to;
                ...
                ((io.blotName = 'list'), (io.tagName = 'LI'), (so.allowedChildren = [io]), (io.requiredContainer = so));
                ...
                var po = class extends As {
                    ...
                    static create(t) {
                        ...
                        return (
                            'string' == typeof t &&
                                (window.katex.render(t, e, { throwOnError: !1, errorColor: '#f00' }), e.setAttribute('data-value', t)),
                            e
                        );
                    }
                    static value(t) {
                ...
                var mo = class extends dn {
                    ...
                    static formats(t) {
                        return go.reduce((e, n) => (t.hasAttribute(n) && (e[n] = t.getAttribute(n)), e), {});
                    }
                    static match(t) {
                    ...
                    format(t, e) {
                        go.indexOf(t) > -1 ? (e ? this.domNode.setAttribute(t, e) : this.domNode.removeAttribute(t)) : super.format(t, e);
                    }
                };
                ...
                var vo = class extends Xr {
                    ...
                    static formats(t) {
                        return bo.reduce((e, n) => (t.hasAttribute(n) && (e[n] = t.getAttribute(n)), e), {});
                    }
                    static sanitize(t) {
                    ...
                    format(t, e) {
                        bo.indexOf(t) > -1 ? (e ? this.domNode.setAttribute(t, e) : this.domNode.removeAttribute(t)) : super.format(t, e);
                    }
                    html() {
                ...
                class xo extends Zr {
                    static formats(t, e) {
                        for (; null != t && t !== e.domNode; ) {
                            if (t.classList && t.classList.contains(si.className)) return super.formats(t, e);
                            t = t.parentNode;
                        }
                    }
                    constructor(t, e, n) {
                    ...
                    format(t, e) {
                        t !== xo.blotName
                            ...
                            : e
                              ...
                              : (yo.remove(this.domNode), this.domNode.classList.remove(this.statics.className));
                    }
                    optimize() {
                        (super.optimize(...arguments), yo.value(this.domNode) || this.unwrap());
                    }
                }
                ...
                class No extends si {
                    ...
                    replaceWith(t, e) {
                        return (this.formatAt(0, this.length(), xo.blotName, !1), super.replaceWith(t, e));
                    }
                }
                class Eo extends ri {
                    attach() {
                    ...
                    formatAt(t, e, n, r) {
                        (n === No.blotName && (this.forceNext = !0), super.formatAt(t, e, n, r));
                    }
                    highlight(t) {
                        let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                        ...
                        if (e || this.forceNext || this.cachedText !== n) {
                            if (n.trim().length > 0 || null == this.cachedText) {
                                const e = this.children.reduce((t, e) => t.concat(Yr(e, !1)), new vn()),
                                    s = t(n, r);
                                e.diff(s).reduce((t, e) => {
                                    ...
                                    return n
                                        ? (r &&
                                              Object.keys(r).forEach((e) => {
                                                  [No.blotName, xo.blotName].includes(e) && this.formatAt(t, n, e, r[e]);
                                              }),
                                          t + n)
                                        : t;
                                }, 0);
                    ...
                    html(t, e) {
                        ...
                        return `<pre data-language="${n ? No.formats(n.domNode) : 'plain'}">\n${Kr(this.code(t, e))}\n</pre>`;
                    }
                    optimize(t) {
                ...
                ((Eo.allowedChildren = [No]), (No.requiredContainer = Eo), (No.allowedChildren = [xo, ts, $r, Hr]));
                class wo extends Es {
                    static register() {
                    ...
                    initListener() {
                        this.quill.on(Ms.events.SCROLL_BLOT_MOUNT, (t) => {
                            ...
                            (this.options.languages.forEach((t) => {
                                ...
                                ((s.textContent = r), s.setAttribute('value', n), e.appendChild(s));
                            }),
                                e.addEventListener('change', () => {
                                    (t.format(No.blotName, e.value), this.quill.root.focus(), this.highlight(t, !0));
                                }),
                                null == t.uiNode && (t.attachUI(e), t.children.head && (e.value = No.formats(t.children.head.domNode))));
                        });
                    }
                    initTimer() {
                        let t = null;
                    ...
                    highlight() {
                        ...
                        ((null == t ? this.quill.scroll.descendants(Eo) : [t]).forEach((t) => {
                    ...
                    highlightBlot(t) {
                        ...
                        if (((e = this.languages[e] ? e : 'plain'), 'plain' === e))
                            return Kr(t)
                                .split('\n')
                                .reduce((t, n, r) => (0 !== r && t.insert('\n', { [si.blotName]: e }), t.insert(n)), new vn());
                        ...
                        return (
                            ...
                            Fi(
                                ...
                                [
                                    (t, e) => {
                                        const n = yo.value(t);
                                        return n ? e.compose(new vn().retain(e.length(), { [xo.blotName]: n })) : e;
                                    },
                                ],
                                [
                                    (t, n) =>
                ...
                class Ao extends Gr {
                    ...
                    static create(t) {
                        const e = super.create();
                        return (t ? e.setAttribute('data-row', t) : e.setAttribute('data-row', Lo()), e);
                    }
                    static formats(t) {
                    ...
                    format(t, e) {
                        t === Ao.blotName && e ? this.domNode.setAttribute('data-row', e) : super.format(t, e);
                    }
                    row() {
                        return this.parent;
                    }
                    ...
                    balanceCells() {
                        ...
                        t.forEach((t) => {
                            new Array(e - t.children.length).fill(0).forEach(() => {
                                let e;
                                null != t.children.head && (e = Ao.formats(t.children.head.domNode));
                ...
                var Oo = class extends Es {
                    ...
                    deleteColumn() {
                        ...
                        null != e && (t.deleteColumn(e.cellOffset()), this.quill.update(Ms.sources.USER));
                    }
                    deleteRow() {
                    ...
                    deleteTable() {
                        ...
                        if (null == t) return;
                        const e = t.offset();
                        (t.remove(), this.quill.update(Ms.sources.USER), this.quill.setSelection(e, Ms.sources.SILENT));
                    }
                    getTable() {
                        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.quill.getSelection();
                        if (null == t) return [null, null, null, -1];
                        const [e, n] = this.quill.getLine(t.index);
                        if (null == e || e.statics.blotName !== Ao.blotName) return [null, null, null, -1];
                        const r = e.parent;
                    ...
                    insertColumn(t) {
                        ...
                        let o = r.rowOffset();
                        (0 === t && (o += 1), this.quill.setSelection(e.index + o, e.length, Ms.sources.SILENT));
                    }
                    insertColumnLeft() {
                        this.insertColumn(0);
                    }
                    ...
                    insertRow(t) {
                        ...
                        (n.insertRow(i + t),
                            ...
                            t > 0
                                ...
                                : this.quill.setSelection(e.index + r.children.length, e.length, Ms.sources.SILENT));
                    }
                    insertRowAbove() {
                        this.insertRow(0);
                    }
                ...
                class To extends Es {
                    ...
                    attach(t) {
                        ...
                        if (
                            ...
                            return void So.warn('ignoring attaching to nonexistent format', e, t);
                        ...
                        this.controls.forEach((n) => {
                            ...
                            if ('SELECT' === s.tagName) {
                                ...
                                if (null == t) n = null;
                                    ...
                                    let t = e[r];
                                    ('string' == typeof t && (t = t.replace(/"/g, '\\"')), (n = s.querySelector(`option[value="${t}"]`)));
                                }
                                null == n ? ((s.value = ''), (s.selectedIndex = -1)) : (n.selected = !0);
                            } else if (null == t) (s.classList.remove('ql-active'), s.setAttribute('aria-pressed', 'false'));
                                ...
                                (s.classList.toggle('ql-active', n), s.setAttribute('aria-pressed', n.toString()));
                            } else {
                                const t = null != e[r];
                                (s.classList.toggle('ql-active', t), s.setAttribute('aria-pressed', t.toString()));
                            }
                        });
                    }
                }
                    ...
                    (To.DEFAULTS = {
                        ...
                        handlers: {
                                ...
                                if (null != t)
                                    if (0 === t.length) {
                                        ...
                                        Object.keys(t).forEach((t) => {
                                            null != this.quill.scroll.query(t, ze.INLINE) && this.quill.format(t, !1, Ms.sources.USER);
                                        });
                                    } else this.quill.removeFormat(t.index, t.length, Ms.sources.USER);
                            },
                            direction(t) {
                                const { align: e } = this.quill.getFormat();
                                ('rtl' === t && null == e
                                    ? this.quill.format('align', 'right', Ms.sources.USER)
                                    : t || 'right' !== e || this.quill.format('align', !1, Ms.sources.USER),
                            ...
                            indent(t) {
                                ...
                                if ('+1' === t || '-1' === t) {
                                    let e = '+1' === t ? 1 : -1;
                                    ('rtl' === n.direction && (e *= -1), this.quill.format('indent', r + e, Ms.sources.USER));
                                }
                            },
                            link(t) {
                                (!0 === t && (t = prompt('Enter link URL:')), this.quill.format('link', t, Ms.sources.USER));
                            },
                            list(t) {
                                const e = this.quill.getSelection(),
                                    n = this.quill.getFormat(e);
                ...
                var Po = class {
                    ...
                    position(t) {
                        ...
                        let i = 0;
                        if (
                            (s.right > r.right && ((i = r.right - s.right), (this.root.style.left = `${e + i}px`)),
                            s.left < r.left && ((i = r.left - s.left), (this.root.style.left = `${e + i}px`)),
                            s.bottom > r.bottom)
                        ) {
                    ...
                    buildPickers(t, e) {
                        this.pickers = Array.from(t).map((t) => {
                            if (
                                ...
                                (null == t.querySelector('option') && Zo(t, zo), 'object' == typeof e.align)
                            )
                            ...
                            if (t.classList.contains('ql-background') || t.classList.contains('ql-color')) {
                                ...
                                return (
                                    null == t.querySelector('option') && Zo(t, Fo, 'background' === n ? '#ffffff' : '#000000'),
                                    new Do(t, e[n])
                                );
                            }
                            return (
                    ...
                    save() {
                        ...
                        switch (this.root.getAttribute('data-mode')) {
                            case 'link': {
                                ...
                                (this.linkRange
                                    ? (this.quill.formatText(this.linkRange, 'link', t, cs.sources.USER), delete this.linkRange)
                                    : (this.restoreFocus(), this.quill.format('link', t, cs.sources.USER)),
                            ...
                            case 'formula': {
                                ...
                                if (null != e) {
                                    ...
                                    (this.quill.insertEmbed(n, this.root.getAttribute('data-mode'), t, cs.sources.USER),
                ...
                class Yo extends Ko {
                    constructor(t, e) {
                        (null != e.modules.toolbar && null == e.modules.toolbar.container && (e.modules.toolbar.container = Go),
                            super(t, e),
                ...
                Yo.DEFAULTS = Pe({}, Ko.DEFAULTS, {
                    modules: {
                        toolbar: {
                            handlers: {
                                link(t) {
                                    t ? this.quill.theme.tooltip.edit() : this.quill.format('link', !1, Ms.sources.USER);
                                },
                            },
                        },
                    },
                        ...
                        (super.listen(),
                            ...
                            this.root.querySelector('a.ql-remove').addEventListener('click', (t) => {
                                if (null != this.linkRange) {
                                    ...
                                    (this.restoreFocus(), this.quill.formatText(t, 'link', !1, cs.sources.USER), delete this.linkRange);
                                }
                ...
                class tl extends Ko {
                    constructor(t, e) {
                        (null != e.modules.toolbar && null == e.modules.toolbar.container && (e.modules.toolbar.container = Qo),
                            super(t, e),
