 ...
 * @version 0.9.9-beta-rc.3 in file headers to match the version specified in package.json.
 ...
 * - Updates the @version 0.9.9-beta-rc.3 in file headers to the latest version.
...
jsFiles.forEach((file) => {
    try {
        ...
        if (originalContent !== newContent) {
            ...
            console.log(`✅ Version updated in: ${path.relative(process.cwd(), file)}`);
        }
    } catch (err) {
